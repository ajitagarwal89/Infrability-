...
/// <summary>
/// Summary description for LogExceptionForSyncService
/// </summary>
namespace Infra.SecuritySystem
{
    public class SystemSecurityLogException
    {
        public SystemSecurityLogException()
        {
            //
        ...
        /// <summary>
        /// Save Exceptions in Database
        /// </summary>
        public void SaveExceptionToDB(SystemSecurityLogExceptionUI LEobj)
        {
