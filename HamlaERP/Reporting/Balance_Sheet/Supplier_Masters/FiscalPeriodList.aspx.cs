...
public partial class Reporting_Balance_Sheet_Supplier_Masters_FiscalPeriodList : PageBase
{
    #region Data Members
    ...
    {
        Response.Redirect("FiscalPeriodForm.aspx");
    }

    protected void gvColLnkBtn_Click(object sender, EventArgs e)
    {
        string fiscalPeriodId = (sender as LinkButton).CommandArgument;
        Response.Redirect("FiscalPeriodForm.aspx?FiscalPeriodId=" + fiscalPeriodId);
    }
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            for (int i = 0; i < gvData.Items.Count; i++)
            {
                ...
                if (ch.Checked == true)
                {
                    ...
                    fiscalPeriodListUI.Tbl_FiscalPeriodId = gvData.Items[i].Cells[1].Text;

                    if (fiscalPeriodListBAL.DeleteFiscalPeriod(fiscalPeriodListUI) == 1)
                    {
        ...
        catch (Exception exp)
        {
            ...
            log.Error("[Reporting_Balance_Sheet_Supplier_Masters_FiscalPeriodList : btnDelete_Click] An error occured in the processing of Record Id : " + fiscalPeriodListUI.Tbl_FiscalPeriodId + ". Details : [" + exp.ToString() + "]");
        }
    ...
    protected void btnMainSearch_Click(object sender, EventArgs e)
    {
        ...
        fiscalPeriodListUI.Search = txtSearch.Text;
        BindListBySearchParameters(fiscalPeriodListUI);
    }
    ...
    protected void lnkExportToExcel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            dtb = fiscalPeriodListBAL.GetFiscalPeriodListForExportToExcel();
