...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    <script src="../../../infra_ui/js/Reporting_JS/Balance_Sheet_JS/Supplier_Masters_JS/FiscalPeriodDetailsForm.js"></script>
</asp:Content>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-12" style="background-color: #f6f6f6">
                            <h5>
                                <asp:Literal runat="server" ID="ltrFiscalPeriodInformation" Text="<%$ Resources:GlobalResource, FiscalPeriodDetails_Information%>"></asp:Literal></h5>
                        </div>
