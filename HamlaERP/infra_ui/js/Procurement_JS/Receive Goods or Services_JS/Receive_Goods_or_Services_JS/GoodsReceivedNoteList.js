...
function SetDetails(receivedType,goodsReceivedNoteNumber,supplierName,supplierDocumentNumber,date,currencyName,batchName,subTotal,tradeDiscount,freight,miscellaneous,total, lblGvRowId) {
    document.getElementById("lblReceivedType").innerHTML = receivedType;
    document.getElementById("lblGoodsReceivedNoteNumber").innerHTML = goodsReceivedNoteNumber;
