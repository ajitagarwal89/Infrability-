...
function setDetails(tableName,optionSetName,optionSetId, optionSetLable, optionSetValue, gvRowId) {

    document.getElementById("lblTableName").innerHTML = tableName;
    document.getElementById("lblOptionSetName").innerHTML = optionSetName;
    document.getElementById("lblOptionSetId").innerHTML = optionSetId;
