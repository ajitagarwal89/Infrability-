...
function setDetails(tableName, optionSetName, tbl_OptionSetLable, tbl_OptionSetValue, tbl_OptionSet_L1Lable, tbl_OptionSet_L1Value, tbl_OptionSet_L2Lable, tbl_OptionSet_L2Value, optionSetLable, optionSetValue, gvRowId) {

    document.getElementById("lblTableName").innerHTML = tableName;
    document.getElementById("lblOptionSetName").innerHTML = optionSetName;
    document.getElementById("lbltbl_OptionSetLable").innerHTML = tbl_OptionSetLable;
    ...
    document.getElementById("lbltbl_OptionSet_L2Lable").innerHTML = tbl_OptionSet_L2Lable;
    document.getElementById("lbltbl_OptionSet_L2Value").innerHTML = tbl_OptionSet_L2Value;
