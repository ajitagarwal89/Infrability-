...
$("#menu-toggle").click(function (e) {
    ...
    document.getElementById('show-menu-toggle').style.display = 'block';
});
$("#show-menu-toggle").click(function (e) {
    document.getElementById('wrapper').style.display = 'block';
    document.getElementById('menu-toggle').style.display = 'block';
    document.getElementById('show-menu-toggle').style.display = 'none';
});
...
$(window).scroll(function () {
    ...
    if (scroll >= 10) {
        $("#ButtonBar").addClass("shadow");
    } else {
        $("#ButtonBar").removeClass("shadow");
    }
});
