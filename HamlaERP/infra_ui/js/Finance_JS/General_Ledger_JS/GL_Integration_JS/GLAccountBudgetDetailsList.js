...
function SetDetails(gLAccountNumer, fiscalperiod, period, periodName, periodDate, amount, lblGvRowId) {
    document.getElementById("lblGLAccountNumber").innerHTML = gLAccountNumer;
