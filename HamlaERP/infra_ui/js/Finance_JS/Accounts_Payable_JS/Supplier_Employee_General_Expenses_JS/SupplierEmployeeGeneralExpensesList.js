...
function setDetails(voucherNumber, batchName, documentType, supplierName, currencyName, expenses, bankTransferAmount, Cash, cheque, creditCard, onAccount, lblGvRowId) {
    ...
    document.getElementById("lblSupplierId").innerHTML = supplierName;
