...
function setDetails(supplierGroupId, accountType, cash, accountPayable, purchase, tradeDiscount, freight, accruedPurchase, lblGvRowId) {
    document.getElementById("lblSupplierGroupId").innerHTML = supplierGroupId;
