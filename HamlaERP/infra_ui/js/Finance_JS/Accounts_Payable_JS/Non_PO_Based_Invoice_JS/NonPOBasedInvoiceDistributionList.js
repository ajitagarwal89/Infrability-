...
function setDetails(pOInvoiceId, gLAccount, gLAccountType, description, distributionRefernce, debit, credit, originatingDebit, originatingCredit, exchangeRate, lblGvRowId) {
    document.getElementById("lblInvoiceId").innerHTML = pOInvoiceId;
