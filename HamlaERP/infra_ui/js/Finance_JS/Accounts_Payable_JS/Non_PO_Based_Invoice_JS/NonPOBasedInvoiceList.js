...
function SetDetails(voucherNumber,interCompany,batchName,documentType,invoiceDate,documentDate,currencyName,lblGvRowId)
{
   document.getElementById("lblVoucherNumber").innerHTML = voucherNumber;
   document.getElementById("lblInterCompany").innerHTML = interCompany;
