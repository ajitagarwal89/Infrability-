...
function SetDetails(supplierEmployeeGroupId, accountType, cash, accountPayable, purchase, tradeDiscount, freight, accruedPurchase, lblGvRowId) {
    
    document.getElementById("lblSupplierEmployeeGroupId").innerHTML = supplierEmployeeGroupId;
