...
function SetDetails(paymentToSupplierEmployee, applyToDocument, dueDate, remainingAmount, applyAmount, type, orignalDocumentAmount, discountDate, lblGvRowId) {
    document.getElementById("lblPaymentToSupplierEmployee").innerHTML = paymentToSupplierEmployee;
