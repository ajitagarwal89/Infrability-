...
function setDetails(supplierEmployeeName, gLAccount, type, debit, originatingDebit, credit, originatingCredit, distributionReference, lblGvRowId) {
    document.getElementById("lblSupplierEmployee").innerHTML = supplierEmployeeName;
