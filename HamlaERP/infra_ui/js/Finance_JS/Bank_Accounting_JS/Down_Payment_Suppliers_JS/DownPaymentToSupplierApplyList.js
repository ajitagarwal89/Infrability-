...
function SetDetails(downPaymentToSupplier, applytoDocument, dueDate, remainingAmount, applyAmount, opt_Type, orignalDocumentAmount, discountDate, lblGvRowId)
{
    
    document.getElementById("lblDownPaymentToSupplier").innerHTML = downPaymentToSupplier;
    //document.getElementById("ApplyToDocument").innerHTML = applytoDocument;
