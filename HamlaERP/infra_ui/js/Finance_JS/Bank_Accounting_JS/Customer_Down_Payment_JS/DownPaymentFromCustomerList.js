...
function setDetails(receiptNumber, batchId, customerId, currencyId, payablesCash, cashAmount, payablesCheque, chequeAmount, payablesCreditCard, creditCardAmount, documentNumber, comments, lblGvRowId) {

    document.getElementById("lblReceiptNumber").innerHTML = receiptNumber;
    document.getElementById("lblBatchId").innerHTML = batchId;
    document.getElementById("lblCustomerId").innerHTML = customerId;
