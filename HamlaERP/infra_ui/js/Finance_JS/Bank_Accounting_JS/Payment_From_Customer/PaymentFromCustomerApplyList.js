...
function SetDetails(paymentFromCustomer, dueDate, remainingAmount, applyAmount, opt_Type, orignalDocumentAmount, discountDate, currencyName, lblGvRowId)
{
    document.getElementById("lblPaymentFromCustomer").innerHTML = paymentFromCustomer;
