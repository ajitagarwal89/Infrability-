<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AuditSettingList.aspx.cs" Inherits="System_Settings_AuditSettingList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContent" Runat="Server">
        ...
        <div class="ui-content-body">
            <div class="ui-container">
                <div class="row">
                    <h3 class="hepad">
                        <asp:Literal runat="server" ID="ltrSearch" Text="<%$ Resources:GlobalResource, AuditSetting_ltrSearch %>"></asp:Literal></h3>
                    <div class="col-md-12 col-sm-12 colformstyle3">
                        ...
                        <asp:UpdatePanel runat="server" ID="updPanelData">
                            <ContentTemplate>
                                ...
                                <asp:DataGrid runat="server" ClientIDMode="Static" Font-Size="10pt" ID="gvData" AutoGenerateColumns="false" Width="100%" GridLines="None" BorderStyle="None" CssClass="table table-hover" AllowPaging="true" PagerStyle-Mode="NumericPages" OnPageIndexChanged="gvData_PageIndexChanged" PageSize="10" >
                                    <Columns>
                                        <asp:BoundColumn DataField="tbl_Audit_SettingId" Visible="false"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, AuditSetting_htObjectName%>" DataField="ObjectName"></asp:BoundColumn>                                       
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, AuditSetting_htEnableAudit%>" DataField="EnableAudit"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, AuditSetting_htOrganizationName%>" DataField="OrganizationName"></asp:BoundColumn>
                                          
                                             <asp:TemplateColumn HeaderImageUrl="~/images/edit.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="gvColLnkBtn" class="btn btn-default btn-sm btn-block" OnClick="gvColLnkBtn_Click" CommandArgument='<%#Eval("tbl_Audit_SettingId") %>'>
