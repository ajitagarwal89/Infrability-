...
public partial class System_Settings_Audit_IUDList : System.Web.UI.Page
{
    #region Data Members
    ...
    private void BindList()
    {
        try
        {
            DataTable dtb = audit_IUDListBAL.GetAudit_IUDList();
        ...
        catch (Exception exp)
        {
            ...
            log.Error("[System_Settings_Audit_IUDList : BindList] An error occured in the processing of Record. Details : [" + exp.ToString() + "]");
        }
    }
    #endregion Methods
}