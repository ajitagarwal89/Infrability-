...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server"> 
    <script src="../../infra_ui/js/System_Settings_JS/BankSetup_JS/BankAccountForm.js"></script>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox ID="txtBankAccountId" runat="server" ClientIDMode="Static" class="form-control" placeholder="" required="required" onkeypress="return isNumberKey(this);"  MaxLength="26" autofocus="autofocus"></asp:TextBox>
                        </div>

                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label ID="lblDescription" runat="server" Text="<%$ Resources:GlobalResource, BankAccount_lblDescription%>"></asp:Label>
                            <asp:TextBox ID="txtDescription" TextMode="MultiLine" runat="server" ClientIDMode="Static" class="form-control" placeholder="" onkeypress="return isAddress(this);"  required="required" ></asp:TextBox>
                        </div>
                         ...
                         <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox ID="txtIban"  runat="server" ClientIDMode="Static" class="form-control" onkeypress="return isAlphaNumberKey(this);" MaxLength="34" placeholder="" required="required"  ></asp:TextBox>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox ID="txtChequebookBal"  runat="server" ClientIDMode="Static" class="form-control" placeholder="" onkeypress="return isNumberKeyPoint(this);" MaxLength="20" required="required" ></asp:TextBox>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox ID="txtCashAccountBal"  runat="server" ClientIDMode="Static" class="form-control" onkeypress="return isNumberKeyPoint(this);" MaxLength="20" placeholder="" required="required" ></asp:TextBox>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox  ID="txtNextChckNmbr" runat="server" ClientIDMode="Static" class="form-control" placeholder="" onkeypress="return isNumberKey(this);" MaxLength="11" required="required" ></asp:TextBox>
                        </div>

                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label ID="lblNextDepositNumber" runat="server" Text="<%$ Resources:GlobalResource, BankAccount_lblNextDepositNumber%>"></asp:Label>
                            <asp:TextBox ID="txtNextDepositNumber" runat="server" ClientIDMode="Static" class="form-control" placeholder="" onkeypress="return isNumberKey(this);" MaxLength="11" required="required" ></asp:TextBox>
                        </div>

                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label ID="lblLastRecouncileBal" runat="server" Text="<%$ Resources:GlobalResource, BankAccount_lblLastRecouncileBal%>"></asp:Label>
                            <asp:TextBox ID="txtlastRecounciledBal"  runat="server" ClientIDMode="Static" class="form-control" placeholder="" onkeypress="return isNumberKeyPoint(this);" MaxLength="20" required="required" ></asp:TextBox>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox ID="txtLastRecounciledDate"  runat="server" TextMode="Date" ClientIDMode="Static" class="form-control"  placeholder="" required="required" ></asp:TextBox>
                        </div>

                         <div class="form-group col-md-4 col-sm-4">
                            <asp:Label ID="lblAccountNumber" runat="server" Text="<%$ Resources:GlobalResource, BankAccount_lblAccountNumber%>"></asp:Label>
                            <asp:TextBox ID="txtAccountNumber"  runat="server" ClientIDMode="Static" class="form-control" placeholder="" onkeypress="return isNumberKeyPoint(this);" MaxLength="26" required="required" ></asp:TextBox>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox ID="txtDuplicateChequeNumber"  runat="server" ClientIDMode="Static" class="form-control" placeholder=""  onkeypress="return isNumberKey(this);" MaxLength="11" required="required" ></asp:TextBox>
                        </div>
                         ...
                         <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox ID="txtOverrideChequeNmbr"  runat="server" ClientIDMode="Static" class="form-control" placeholder="" onkeypress="return isNumberKey(this);" MaxLength="11" required="required" ></asp:TextBox>
                        </div>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="hdrModalCurrencyTitle"><span>
                        <asp:Literal runat="server" ID="ltrCurrencyTitle" Text="<%$ Resources:GlobalResource, BankAccount_ltrCurrencyTitle%>"></asp:Literal>
                    </span>
                    </h4>
                </div>
                            ...
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvCurrencySearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,BankAccount_htCurrencyName%>">
                                            <ItemTemplate>
                            ...
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvBankSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,BankAccount_htBankName%>">
                                            <ItemTemplate>
