...
public partial class System_Settings_BankAccount : PageBase
{
    ...
    protected override void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            if (Request.QueryString["BankAccountId"] != null || Request.QueryString["recordId"] != null)
            {
                bankAccountFormUI.Tbl_BankAccountId = (Request.QueryString["BankAccountId"] != null ? Request.QueryString["BankAccountId"] : Request.QueryString["recordId"]);                         
    ...
    {
        string Form = "~/System_Settings/BankAccountForm.aspx";
        string recordId = Request.QueryString["BankAccountId"];
