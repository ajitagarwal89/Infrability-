                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-xs-12">
                            ...
                            <asp:TextBox ID="txtCountryCode" runat="server"  ClientIDMode="Static" onkeypress="return isAlphaNumberKey(this);" MaxLength="20" class="form-control" placeholder="" autofocus="autofocus" required="required"></asp:TextBox>
                        </div>
                        <div class="form-group col-xs-12">
                            <asp:Label runat="server" ID="lblCountryName" Text="<%$ Resources:GlobalResource, Country_lblName %>"></asp:Label>
                            <asp:TextBox runat="server" ID="txtCountryName" ClientIDMode="Static" onkeypress="return isAlphaKey(this);" MaxLength="50" class="form-control" placeholder="" required="required"></asp:TextBox>
                        </div>
                    </div>
                </div>
            </div>
