...
public partial class System_Settings_BudgetForm : PageBase
{
    ...
    protected override void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (Request.QueryString["BudgetId"] != null || Request.QueryString["recordId"] != null)
            {
                budgetFormUI.Tbl_BudgetId = (Request.QueryString["BudgetId"] != null ? Request.QueryString["BudgetId"] : Request.QueryString["recordId"]);
    ...
    {
        string Form = "~/System_Settings/BudgetForm.aspx";
        string recordId = Request.QueryString["BudgetId"];
