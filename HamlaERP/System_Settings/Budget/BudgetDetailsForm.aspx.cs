...
public partial class System_Settings_BudgetDetailsForm : PageBase
{
    ...
    protected override void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            if (Request.QueryString["BudgetDetailsId"] != null || Request.QueryString["recordId"] != null)
            {
                budgetDetailsFormUI.Tbl_BudgetDetailsId = (Request.QueryString["BudgetDetailsId"] != null ? Request.QueryString["BudgetDetailsId"] : Request.QueryString["recordId"]);
    ...
    {
        string Form = "~/System_Settings/BudgetDetailsForm.aspx";
        string recordId = Request.QueryString["BudgetDetailsId"];
