<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="OptionSetList.aspx.cs" Inherits="System_Settings_OptionSetList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    <script src="../infra_ui/js/System_Settings_JS/OptionSetList.js"></script>
</asp:Content>
                            ...
                            <ContentTemplate>
                                ...
                                <asp:DataGrid runat="server" ClientIDMode="Static" Font-Size="10pt" ID="gvData" AutoGenerateColumns="false" Width="100%" GridLines="None" BorderStyle="None" CssClass="table table-hover">
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="tbl_OptionSetId" Visible="false"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, OptionSet_htTableName%>" DataField="TableName"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, OptionSet_htParentOptionSetValue%>" DataField="ParentOptionSetValue"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, OptionSet_htOptionSetName%>" DataField="OptionSetName"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, OptionSet_htOptionSetValue%>" DataField="OptionSetValue"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, OptionSet_htOptionSetLable%>" DataField="OptionSetLable"></asp:BoundColumn>

                                        <asp:TemplateColumn HeaderImageUrl="~/images/eye.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <button id="lnkView_<%# Container.DataSetIndex + 1 %>" type="button" data-toggle="modal" data-target="#basicModalOptionSet" data-keyboard="false" data-backdrop="static" class="btn btn-default btn-sm btn-block" onclick="setDetails('<%#Eval("TableName")%>','<%#Eval("ParentOptionSetValue")%>','<%#Eval("OptionSetName")%>','<%#Eval("OptionSetLable")%>','<%#Eval("OptionSetValue")%>','lnkview_<%# Container.DataSetIndex + 1 %>');">
                                                    <asp:Literal runat="server" ID="ltrView" Text="<%$ Resources:GlobalResource, ltrView%>"></asp:Literal></button>
                                                <button id="lnkViewNextPrev_<%# Container.DataSetIndex + 1 %>" style="display: none;" type="button" class="btn btn-default btn-sm" onclick="setDetails('<%#Eval("TableName")%>','<%#Eval("ParentOptionSetValue")%>','<%#Eval("OptionSetName")%>','<%#Eval("OptionSetLable")%>','<%#Eval("OptionSetValue")%>','lnkview_<%# Container.DataSetIndex + 1 %>');"></button>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>

                                        <asp:TemplateColumn HeaderImageUrl="~/images/edit.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="gvColLnkBtn" class="btn btn-default btn-sm btn-block" OnClick="gvColLnkBtn_Click" CommandArgument='<%#Eval("tbl_OptionSetId") %>'>
                    ...
                    <table class="table table-striped" style="width: 100%; font-size: 9.5pt;">
                        <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrTableName" Text="<%$ Resources:GlobalResource, OptionSet_ltrTableName%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrParenOptionSetValue" Text="<%$ Resources:GlobalResource, OptionSet_ltrParenOptionSetValue%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrOptionSetName" Text="<%$ Resources:GlobalResource, OptionSet_ltrOptionSetName%>"></asp:Literal></td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="lblTableName" runat="server" ClientIDMode="Static"></asp:Label></td>
                            <td>
                                <asp:Label ID="lblParentOptionSetValue" runat="server" ClientIDMode="Static"></asp:Label></td>
                            <td>
                                <asp:Label ID="lblOptionSetName" runat="server" ClientIDMode="Static"></asp:Label></td>
                        </tr>
                         <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrOptionSetLable" Text="<%$ Resources:GlobalResource, OptionSet_ltrOptionSetLable%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrOptionSetValue" Text="<%$ Resources:GlobalResource, OptionSet_ltrOptionSetValue%>"></asp:Literal></td>
                        </tr>
                        <tr>
                            <td>
