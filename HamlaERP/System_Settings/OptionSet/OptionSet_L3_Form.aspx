<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="OptionSet_L3_Form.aspx.cs" Inherits="System_Settings_OptionSet_OptionSet_L3_Form" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    <script src="../../infra_ui/js/System_Settings_JS/OptionSet_JS/OptionSet_L3_Form.js"></script>
</asp:Content>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-12" style="background-color: #f6f6f6">
                            <h5>
                                <asp:Literal runat="server" ID="ltrOptionSet_L3_Information" Text="<%$ Resources:GlobalResource, OptionSet_L3_Information%>"></asp:Literal></h5>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblOptionSetId" Text="<%$ Resources:GlobalResource, OptionSet_L3_lblOptionSetId%>"></asp:Label>
                            <asp:DropDownList ID="ddlOptionSetId" runat="server" ClientIDMode="Static" class="form-control " placeholder=""
                                required="required">
                            </asp:DropDownList>
                        </div>

                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblOptionSet_L1Id" Text="<%$ Resources:GlobalResource, OptionSet_L3_lblOptionSet_L1Id%>"></asp:Label>
                            <asp:DropDownList ID="ddlOptionSet_L1Id" runat="server" ClientIDMode="Static" class="form-control " placeholder=""
                                required="required">
                            </asp:DropDownList>
                        </div>

                         <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblOptionSet_L2Id" Text="<%$ Resources:GlobalResource, OptionSet_L3_lblOptionSet_L2Id%>"></asp:Label>
                            <asp:DropDownList ID="ddlOptionSet_L2Id" runat="server" ClientIDMode="Static" class="form-control " placeholder=""
                                required="required">
                            </asp:DropDownList>
                        </div>

                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblOptionSetLable" Text="<%$ Resources:GlobalResource, OptionSet_L3_lblOptionSetLable %>"></asp:Label>
                            <asp:TextBox runat="server" ID="txtOptionSetLable"  ClientIDMode="Static" class="form-control "></asp:TextBox>
                        </div>

                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblOptionSetValue" Text="<%$ Resources:GlobalResource, OptionSet_L3_lblOptionSetValue %>"></asp:Label>
