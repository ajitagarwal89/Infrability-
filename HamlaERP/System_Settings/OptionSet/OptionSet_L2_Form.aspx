<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="OptionSet_L2_Form.aspx.cs" Inherits="System_Settings_OptionSet_OptionSet_L2_Form" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    <script src="../../infra_ui/js/System_Settings_JS/OptionSet_JS/OptionSet_L2_Form.js"></script>
</asp:Content>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-12" style="background-color: #f6f6f6">
                            <h5>
                                <asp:Literal runat="server" ID="ltrOptionSet_L2_Information" Text="<%$ Resources:GlobalResource, OptionSet_L2_Information%>"></asp:Literal></h5>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblOptionSetId" Text="<%$ Resources:GlobalResource, OptionSet_L2_lblOptionSetId%>"></asp:Label>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblOptionSet_L1Id" Text="<%$ Resources:GlobalResource, OptionSet_L2_lblOptionSet_L1Id%>"></asp:Label>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblOptionSetLable" Text="<%$ Resources:GlobalResource, OptionSet_L2_lblOptionSetLable %>"></asp:Label>
                            <asp:TextBox runat="server" ID="txtOptionSetLable"  ClientIDMode="Static" class="form-control "></asp:TextBox>
                        </div>

                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblOptionSetValue" Text="<%$ Resources:GlobalResource, OptionSet_L2_lblOptionSetValue %>"></asp:Label>
