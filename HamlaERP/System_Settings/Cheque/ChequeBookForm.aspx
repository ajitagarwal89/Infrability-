...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    <script src="../../infra_ui/js/System_Settings_JS/Cheque_JS/ChequeBookForm.js"></script>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox runat="server" ID="txtChequeBookNumber" ClientIDMode="Static" onkeypress="return isNumberKey(this);" MaxLength="24" class="form-control" placeholder="" required="required"></asp:TextBox>
                        </div>

                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblChequeBookName" Text="<%$ Resources:GlobalResource, ChequeBook_lblName%>"></asp:Label>
                            <asp:TextBox runat="server" ID="txtChequeBookName" ClientIDMode="Static" onkeypress="return isAlphaKey(this);" MaxLength="50" class="form-control" placeholder="" required="required"></asp:TextBox>
                        </div>
                    </div>
                </div>
            </div>
