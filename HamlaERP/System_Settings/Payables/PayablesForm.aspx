                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox runat="server" ID="txtDocumentNumber" ClientIDMode="Static" class="form-control " onkeypress="return isNumberKey(this);" MaxLength="15" placeholder="" ></asp:TextBox>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-sm-4" id="divChequeNumber" runat="server">
                            ...
                            <asp:TextBox runat="server" ID="txtChequeNumber" ClientIDMode="Static" class="form-control " onkeypress="return isNumberKey(this);" MaxLength="15" placeholder="" ></asp:TextBox>
                        ...
                        <div class="form-group col-md-4 col-sm-4" id="divReceipt" runat="server">
                            ...
                            <asp:Label runat="server" ID="lblReceiptNumber" Text="<%$ Resources:GlobalResource, Payables_lblReceiptNumber%>"></asp:Label>
                               <asp:TextBox runat="server" ID="txtReceiptNumber" ClientIDMode="Static" class="form-control " onkeypress="return isAlphaNumberKey(this);" MaxLength="15" placeholder="" ></asp:TextBox>
                        ...
                        <div class="form-group col-md-4 col-sm-4" id="divPayment" runat="server">
                            ...
                            <asp:TextBox runat="server" ID="txtPaymentNumber" ClientIDMode="Static" class="form-control " onkeypress="return isNumberKey(this);" MaxLength="15" placeholder="" ></asp:TextBox>

                        </div>
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblPayablesDate" Text="<%$ Resources:GlobalResource, Payables_lblPayablesDate%>"></asp:Label>
                            <asp:TextBox TextMode="Date" runat="server" ID="txtPayablesDate" ClientIDMode="Static" class="form-control " placeholder="" required="required"></asp:TextBox>
