...
public partial class System_Settings_CardForm : PageBase
{
    ...
    protected override void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            if (Request.QueryString["CardId"] != null || Request.QueryString["recordId"] != null)
            {
                cardFormUI.Tbl_CardId = (Request.QueryString["CardId"] != null ? Request.QueryString["CardId"] : Request.QueryString["recordId"]);
                FillForm(cardFormUI);
    ...
    {
        string Form = "~/System_Settings/CardForm.aspx";
        string recordId = Request.QueryString["CardId"];
