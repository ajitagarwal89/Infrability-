<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Segment07Form.aspx.cs" Inherits="System_Settings_Segment07Form" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    <script src="../../infra_ui/js/System_Settings_JS/Segments_JS/Segment07Form.js"></script>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-12" style="background-color: #f6f6f6">
                            <h5>
                                <asp:Literal runat="server" ID="ltrSegment07Information" Text="<%$ Resources:GlobalResource, Segment07_ltrInformation%>"></asp:Literal></h5>
                        </div>
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblNumber" Text="<%$ Resources:GlobalResource, Segment07_lblNumber%>"></asp:Label>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblDescription" Text="<%$ Resources:GlobalResource, Segment07_lblDescription%>"></asp:Label>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblSegment01" Text="<%$ Resources:GlobalResource, Segment07_lblSegment01%>"></asp:Label>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblSegment02" Text="<%$ Resources:GlobalResource, Segment07_lblSegment02%>"></asp:Label>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblSegment03" Text="<%$ Resources:GlobalResource, Segment07_lblSegment03%>"></asp:Label>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblSegment04" Text="<%$ Resources:GlobalResource, Segment07_lblSegment04%>"></asp:Label>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblSegment05" Text="<%$ Resources:GlobalResource, Segment07_lblSegment05%>"></asp:Label>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblSegment06" Text="<%$ Resources:GlobalResource, Segment07_lblSegment06%>"></asp:Label>
                            <asp:DropDownList ID="ddlSegment06" runat="server" ClientIDMode="Static" class="form-control " placeholder="" required="required">
                            </asp:DropDownList>
                        </div>
                    </div>
                </div>
