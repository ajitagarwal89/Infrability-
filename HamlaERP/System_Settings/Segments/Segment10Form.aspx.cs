...
public partial class System_Settings_Segment10Form : PageBase
{
    ...
    protected override void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            BindDDLSegment01();
            if (Request.QueryString["Segment10Id"] != null || Request.QueryString["recordId"] != null)
            {
                segment10FormUI.Tbl_Segment10Id = (Request.QueryString["Segment10Id"] != null ? Request.QueryString["Segment10Id"] : Request.QueryString["recordId"]);
    ...
    {
        string Form = "~/System_Settings/Segments/Segment10Form.aspx";
        string recordId = Request.QueryString["Segment10Id"];
