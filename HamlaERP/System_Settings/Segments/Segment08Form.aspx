...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    <script src="../../infra_ui/js/System_Settings_JS/Segments_JS/Segment08Form.js"></script>
            ...
            <div class="ui-container">
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblSegment01" Text="<%$ Resources:GlobalResource, Segment08_lblSegment01%>"></asp:Label>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblSegment02" Text="<%$ Resources:GlobalResource, Segment08_lblSegment02%>"></asp:Label>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblSegment03" Text="<%$ Resources:GlobalResource, Segment08_lblSegment03%>"></asp:Label>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblSegment04" Text="<%$ Resources:GlobalResource, Segment08_lblSegment04%>"></asp:Label>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblSegment05" Text="<%$ Resources:GlobalResource, Segment08_lblSegment05%>"></asp:Label>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblSegment06" Text="<%$ Resources:GlobalResource, Segment08_lblSegment06%>"></asp:Label>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblSegment07" Text="<%$ Resources:GlobalResource, Segment08_lblSegment07%>"></asp:Label>
