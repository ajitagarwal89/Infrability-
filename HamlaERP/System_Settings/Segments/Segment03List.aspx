<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Segment03List.aspx.cs" Inherits="System_Settings_Segment03List" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    <script src="../../infra_ui/js/System_Settings_JS/Segments_JS/Segment03List.js"></script>
</asp:Content>
   ...
   <div id="content" class="ui-content ui-content-aside-overlay">
       ...
       <div class="page-head-wrap">
            ...
            <div class="ui-container">
                <div class="row">
                    <h3 class="hepad">
                        <asp:Literal runat="server" ID="ltrSegment" Text="<%$ Resources:GlobalResource, Segment03_ltrSegment  %>">
                                ...
                                <asp:DataGrid runat="server" ClientIDMode="Static" Font-Size="10pt" ID="gvData" AutoGenerateColumns="false" 
                                    ...
                                    <Columns>
                                     ...
                                     <asp:CheckBox ID="chkAll" runat="server"  onclick = "checkAll(this);"   />
                                        ...
                                        <asp:BoundColumn DataField="tbl_Segment03Id" Visible="false"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, Segment03_htNumber%>" DataField="Number"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, Segment03_htDescription%>" DataField="Description"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, Segment03_htSegment01%>" DataField="tbl_Segment01"></asp:BoundColumn>
                                         <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, Segment03_htSegment02%>" DataField="tbl_Segment02"></asp:BoundColumn>
                                  
                                        
                                              <asp:TemplateColumn HeaderImageUrl="~/images/eye.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <button id="lnkView_<%# Container.DataSetIndex + 1 %>" type="button" data-toggle="modal" data-target="#basicModalSeg" data-keyboard="false" data-backdrop="static" class="btn btn-default btn-sm btn-block" onclick="SetDetails('<%#Eval("Number")%>','<%#Eval("Description")%>','<%#Eval("tbl_Segment01")%>','<%#Eval("tbl_Segment02")%>','lnkview_<%# Container.DataSetIndex + 1 %>');">
                                                    <asp:Literal runat="server" ID="ltrView" Text="<%$ Resources:GlobalResource, ltrView%>"></asp:Literal></button>
                                                <button id="lnkViewNextPrev_<%# Container.DataSetIndex + 1 %>" style="display: none;" type="button" class="btn btn-default btn-sm" onclick="SetDetails('<%#Eval("Number")%>','<%#Eval("Description")%>','<%#Eval("tbl_Segment01")%>','<%#Eval("tbl_Segment02")%>','lnkview_<%# Container.DataSetIndex + 1 %>');"></button>

                                            </ItemTemplate>
                                        </asp:TemplateColumn>
                                           <asp:TemplateColumn HeaderImageUrl="~/images/edit.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="gvColLnkBtn" class="btn btn-default btn-sm btn-block" OnClick="gvColLnkBtn_Click" CommandArgument='<%#Eval("tbl_Segment03Id") %>'>
     ...
     <div class="modal fade" id="basicModalSeg" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
      ...
      <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><span>
                        <asp:Literal runat="server" ID="ltr_Segment03_Details" Text="<%$ Resources:GlobalResource, Segment03_ltrDetails %>"></asp:Literal></span></h4>
                </div>
      <div class="modal-body">
                    <table class="table table-striped" style="width: 100%; font-size: 9.5pt;">
                        <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrNumber" Text="<%$ Resources:GlobalResource, Segment03_ltrNumber%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrDescription" Text="<%$ Resources:GlobalResource, Segment03_ltrDescription%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrSegment01Name" Text="<%$ Resources:GlobalResource, Segment03_ltrSegmentName01%>"></asp:Literal></td>
                             <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrSegment02Name" Text="<%$ Resources:GlobalResource, Segment03_ltrSegmentName02%>"></asp:Literal></td>
