...
public partial class System_Settings_Segment08Form : PageBase
{
    ...
    protected override void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (Request.QueryString["Segment08Id"] != null || Request.QueryString["recordId"] != null)
            {
                segment08FormUI.Tbl_Segment08Id = (Request.QueryString["Segment08Id"] != null ? Request.QueryString["Segment08Id"] : Request.QueryString["recordId"]);
    ...
    {
        string Form = "~/System_Settings/Segments/Segment08Form.aspx";
        string recordId = Request.QueryString["Segment08Id"];
