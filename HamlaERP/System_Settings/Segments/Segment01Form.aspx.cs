...
public partial class System_Settings_Segment01Form : PageBase
{
    ...
    protected override void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            if (Request.QueryString["Segment01Id"] != null || Request.QueryString["recordId"] != null)
            {
                segment01FormUI.Tbl_Segment01Id = (Request.QueryString["Segment01Id"] != null ? Request.QueryString["Segment01Id"] : Request.QueryString["recordId"]);
    ...
    {
        string Form = "~/System_Settings/Segments/Segment01Form.aspx";
        string recordId = Request.QueryString["Segment01Id"];
