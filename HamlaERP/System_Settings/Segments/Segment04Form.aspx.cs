...
public partial class System_Settings_Segment04Form : PageBase
{
    ...
    protected override void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            BindDDLSegment01();
            if (Request.QueryString["Segment04Id"] != null || Request.QueryString["recordId"] != null)
            {
                segment04FormUI.Tbl_Segment04Id = (Request.QueryString["Segment04Id"] != null ? Request.QueryString["Segment04Id"] : Request.QueryString["recordId"]);
    ...
    {
        string Form = "~/System_Settings/Segments/Segment04Form.aspx";
        string recordId = Request.QueryString["Segment04Id"];
