...
public partial class InvoiceAndOrderTypeForm : PageBase
{
    ...
    protected override void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (Request.QueryString["InvoiceAndOrderTypeId"] != null || Request.QueryString["recordId"] != null)
            {
                invoiceAndOrderTypeFormUI.Tbl_InvoiceAndOrderTypeId = (Request.QueryString["InvoiceAndOrderTypeId"] != null ? Request.QueryString["InvoiceAndOrderTypeId"] : Request.QueryString["recordId"]);
    ...
    {
        string Form = "~/System_Settings/InvoiceAndOrderTypeForm.aspx";
        string recordId = Request.QueryString["InvoiceAndOrderTypeId"];
