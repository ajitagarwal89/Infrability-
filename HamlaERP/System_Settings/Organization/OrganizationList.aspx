...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">    
    <script src="../../infra_ui/js/System_Settings_JS/Organization_JS/OrganizationList.js"></script>
</asp:Content>
    ...
    <div id="content" class="ui-content ui-content-aside-overlay">
        ...
        <div class="ui-content-body">
            <div class="ui-container">
                <div class="row">
                    <h3 class="hepad">
                        <asp:Literal runat="server" ID="ltrSearch" Text="<%$ Resources:GlobalResource,Organization_ltrOrganizations %>"></asp:Literal></h3>
                            ...
                            <ContentTemplate>
                                <asp:DataGrid runat="server" ClientIDMode="Static" Font-Size="10pt" ID="gvData" AutoGenerateColumns="false" Width="100%" GridLines="None" BorderStyle="None" CssClass="table table-hover">
                                    <Columns>
                                        ...
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource,Organization_htCode%>" DataField="OrganizationCode"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource,Organization_htName%>" DataField="Name"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource,Organization_htLocation%>" DataField="City"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource,Organization_htPhone%>" DataField="PhoneNo"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, Organization_htWebsite%>" DataField="Website"></asp:BoundColumn>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><span>
                        <asp:Literal runat="server" ID="ltrRecordDetails" Text="<%$ Resources:GlobalResource,Organization_ltrDetails %>"></asp:Literal></span></h4>
                </div>
                <div class="modal-body">
                    <table class="table table-striped" style="width: 100%; font-size: 9.5pt;">
                        <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrCode" Text="<%$ Resources:GlobalResource, Organization_ltrCode%>"></asp:Literal>
                            </td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrName" Text="<%$ Resources:GlobalResource,Organization_ltrName%>"></asp:Literal>
                                    </td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrWebsite" Text="<%$ Resources:GlobalResource,Organization_ltrWebsite%>"></asp:Literal>
                                    </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Literal runat="server" ID="ltrLocation" Text="<%$ Resources:GlobalResource,Organization_ltrLocation%>"></asp:Literal>
                                    </td>
                            <td>
                                <asp:Literal runat="server" ID="ltrState" Text="<%$ Resources:GlobalResource,Organization_ltrState%>"></asp:Literal>
                                    </td>
                            <td>
                                <asp:Literal runat="server" ID="ltrAddress" Text="<%$ Resources:GlobalResource,Organization_ltrAddress%>"></asp:Literal>
                                    </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Literal runat="server" ID="ltrPostalCode" Text="<%$ Resources:GlobalResource,Organization_ltrPostalCode%>"></asp:Literal>
                                    </td>
                            <td>
                                <asp:Literal runat="server" ID="ltrPhone" Text="<%$ Resources:GlobalResource,Organization_ltrPhone%>"></asp:Literal>
                                    </td>
                            <td>
                                <asp:Literal runat="server" ID="ltrMobile" Text="<%$ Resources:GlobalResource,Organization_ltrMobile%>"></asp:Literal>
                                    </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Literal runat="server" ID="ltrFax" Text="<%$ Resources:GlobalResource,Organization_ltrFax%>"></asp:Literal></td>
                            <td>
                                <asp:Literal runat="server" ID="ltrEmail" Text="<%$ Resources:GlobalResource,Organization_ltrEmail%>"></asp:Literal></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>
