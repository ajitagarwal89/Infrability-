...
public partial class System_Settings_OrganizationForm : PageBase
{
    ...
    protected override void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            if (Request.QueryString["OrganizationId"] != null || Request.QueryString["recordId"] != null)
            {
                organizationFormUI.Tbl_OrganizationId = (Request.QueryString["OrganizationId"] != null ? Request.QueryString["OrganizationId"] : Request.QueryString["recordId"]);
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (txtCountryGuid.Text == "")
                organizationFormUI.Tbl_CountryId = null;
            else
                organizationFormUI.Tbl_CountryId = txtCountryGuid.Text;

            if (txtCurrencyGuid.Text == "")
                organizationFormUI.Tbl_CurrencyId = null;
            else
                organizationFormUI.Tbl_CurrencyId = txtCurrencyGuid.Text;
    ...
    {
        string Form = "~/System_Settings/OrganizationForm.aspx";
        string recordId = Request.QueryString["OrganizationId"];
