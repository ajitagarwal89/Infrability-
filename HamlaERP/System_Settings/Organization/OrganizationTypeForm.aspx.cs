...
public partial class System_Settings_OrganizationTypeForm : PageBase
{
    ...
    protected override void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            if (Request.QueryString["OrganizationTypeId"] != null || Request.QueryString["recordId"] != null)
            {
                organizationTypeFormUI.Tbl_OrganizationTypeId = (Request.QueryString["OrganizationTypeId"] != null ? Request.QueryString["OrganizationTypeId"] : Request.QueryString["recordId"]);
    ...
    {
        string Form = "~/System_Settings/OrganizationTypeForm.aspx";
        string recordId = Request.QueryString["OrganizationTypeId"];
