...
public partial class System_Settings_CurrencyForm : PageBase
{
    ...
    protected override void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            if (Request.QueryString["CurrencyId"] != null || Request.QueryString["recordId"] != null)
            {
                currencyFormUI.Tbl_CurrencyId = (Request.QueryString["CurrencyId"] != null ? Request.QueryString["CurrencyId"] : Request.QueryString["recordId"]);
    ...
    {
        string Form = "~/System_Settings/CurrencyForm.aspx";
        string recordId = Request.QueryString["CurrencyId"];
