...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    <script src="../infra_ui/js/System_Settings_JS/CommentsForm.js"></script>
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblDescription" Text="<%$ Resources:GlobalResource, Comments_lblDescription %>"></asp:Label>
                             <asp:TextBox  type="text" TextMode="MultiLine" runat="server" ID="txtDescription" onkeypress="return isAddress(this);" MaxLength="50" ClientIDMode="Static" class="form-control " placeholder="" required="required"></asp:TextBox>
                        </div>
