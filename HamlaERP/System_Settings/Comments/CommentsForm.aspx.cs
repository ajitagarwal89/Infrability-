...
public partial class Comments_CommentsForm : PageBase
{
    #region Data Members
    ...
    protected override void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            if (Request.QueryString["CommentsId"] != null || Request.QueryString["recordId"] != null)
            {
                commentsFormUI.Tbl_CommentsId = (Request.QueryString["CommentsId"] != null ? Request.QueryString["CommentsId"] : Request.QueryString["recordId"]);
    ...
    {
        string Form = "~/System_Settings/CommentsForm.aspx";
        string recordId = Request.QueryString["CommentsId"];
