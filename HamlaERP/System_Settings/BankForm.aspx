...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">    
    <script src="../infra_ui/js/System_Settings_JS/BankForm.js"></script>
</asp:Content>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-12" style="background-color: #f6f6f6">
                            <h5>
                                <asp:Literal runat="server" ID="ltrBatchInformation" Text="<%$ Resources:GlobalResource, Bank_ltrBank_Information%>"></asp:Literal></h5>
                        </div>
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label ID="lblBankCode" runat="server" Text="<%$ Resources:GlobalResource, Bank_lblCode %>"></asp:Label>
                            <asp:TextBox type="text" ID="txtBankCode" runat="server" ClientIDMode="Static" class="form-control" placeholder="" required="required" autofocus="autofocus"></asp:TextBox>
                        </div>

                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblBankName" Text="<%$ Resources:GlobalResource, Bank_lblBankName %>"></asp:Label>
                            <asp:TextBox type="text" runat="server" ID="txtBankName" ClientIDMode="Static" class="form-control" placeholder="" required="required"></asp:TextBox>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox type="text" runat="server" ID="txtState" ClientIDMode="Static" class="form-control" placeholder="" required="required"></asp:TextBox>
                        </div>
                    ...
                    <div class="form-group col-md-4 col-sm-4">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox type="text" runat="server" ID="txtPhone" TextMode="Phone" ClientIDMode="Static" class="form-control" placeholder="" required="required"></asp:TextBox>
                        </div>

                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblMobile" Text="<%$ Resources:GlobalResource, Bank_lblMobile%>"></asp:Label>
                            <asp:TextBox type="text" runat="server" ID="txtMobile" TextMode="Phone" ClientIDMode="Static" class="form-control" placeholder="" required="required"></asp:TextBox>
                        </div>

                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblFax" Text="<%$ Resources:GlobalResource, Bank_lblFax%>"></asp:Label>
                            <asp:TextBox type="text" runat="server" ID="txtFax" ClientIDMode="Static" class="form-control" placeholder="" required="required"></asp:TextBox>
                        </div>

                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblBranch" Text="<%$ Resources:GlobalResource, Bank_lblBranch%>"></asp:Label>
                            <asp:TextBox type="text" runat="server" ID="txtBranch" ClientIDMode="Static" class="form-control" placeholder="" required="required"></asp:TextBox>
                        </div>

                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblIban" Text="<%$ Resources:GlobalResource, Bank_lblIban%>"></asp:Label>
                            <asp:TextBox type="text" runat="server" ID="txtIban" ClientIDMode="Static" class="form-control" placeholder="" required="required"></asp:TextBox>
                        </div>
                    </div>
                </div>
            </div>
