...
public partial class System_Settings_SitesForm : PageBase
{
    ...
    protected override void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            if (Request.QueryString["SitesId"] != null || Request.QueryString["recordId"] != null)
            {
                sitesFormUI.Tbl_SitesId = (Request.QueryString["SitesId"] != null ? Request.QueryString["SitesId"] : Request.QueryString["recordId"]);
    ...
    {
        string Form = "~/System_Settings/SitesForm.aspx";
        string recordId = Request.QueryString["SitesId"];
