        ...
        <div id="ButtonBar" class="page-head-wrap">
            <div class="row">
                <div class="btn-group col-md-12 col-xs-12 pull-left" role="group">
                    ...
                    <asp:Button runat="server" ID="btnBack" CssClass="btn btn-success" OnClick="btnBack_Click" Text="<%$ Resources:GlobalResource, btnBack%>" formnovalidate />
                    <asp:Button runat="server" ID="btnClear" CssClass="btn btn-success" OnClientClick="return ClearForm();" Text="<%$ Resources:GlobalResource, btnClear%>" formnovalidate></asp:Button>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-12" style="background-color: #f6f6f6">
                            <h5>
                                <asp:Literal runat="server" ID="ltr_BudgetDetails_BudgetInformations" Text="<%$ Resources:GlobalResource, BudgetDetails_ltr_BudgetInformations%>"></asp:Literal></h5>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox TextMode="Date" runat="server" ID="txtPeriodDate" class="form-control" ClientIDMode="Static" Placeholder="" required></asp:TextBox>

                        </div>
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblPeriod" Text="<%$ Resources:GlobalResource, BudgetDetails_lblPeriod%>"> ></asp:Label>

                            <asp:TextBox runat="server" ID="txtPeriod" ClientIDMode="Static" class="form-control" Placeholder="" required></asp:TextBox>
                        </div>
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblPeriodName" Text="<%$ Resources:GlobalResource, BudgetDetails_lblPeriodName%>"></asp:Label>
                            <asp:TextBox runat="server" ID="txtPeriodName" class="form-control" ClientIDMode="Static" Placeholder="" required></asp:TextBox>
                        </div>
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblAmount" Text="<%$ Resources:GlobalResource, BudgetDetails_Amount%>"></asp:Label>
                            <asp:TextBox runat="server" ID="txtAmount" class="form-control" ClientIDMode="Static" Placeholder="" required></asp:TextBox>
                                ...
                                <ContentTemplate>
                                    ...
                                    <asp:GridView ID="gvBudgetSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Budget Guid" Visible="false">
                                                <ItemTemplate>
                            ...
                            <asp:UpdatePanel runat="server" ID="updpnlgvFiscalPeriodSearch">
                                <ContentTemplate>
                                    ...
                                    <asp:GridView ID="gvFiscalPeriodSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                        EmptyDataText="<%$ Resources:GlobalResource,msgNoRecordFound%>" AllowPaging="True" PageSize="10" ClientIDMode="Static">
                                        <Columns>
                                            <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, BudgetDetails_htPeriodName%>">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="FiscalPeriod Guid" Visible="false">
                                                <ItemTemplate>
