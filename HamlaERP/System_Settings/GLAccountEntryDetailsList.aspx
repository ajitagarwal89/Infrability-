<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="GLAccountEntryDetailsList.aspx.cs" Inherits="System_Settings_GLAccountEntryDetailsList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    <script src="../infra_ui/js/System_Settings_JS/GLAccountEntryDetailsList.js"></script>
</asp:Content>
    ...
    <div id="content" class="ui-content ui-content-aside-overlay">
        ...
        <div class="ui-content-body">
            <div class="ui-container">
                <div class="row">
                    <h3 class="hepad">
                        <asp:Literal runat="server" ID="ltrSearch" Text="<%$ Resources:GlobalResource, GLAccountEntryDetailsTitle_ltrGLAccountEntry %>"></asp:Literal></h3>
                            ...
                            <ContentTemplate>
                                ...
                                <asp:DataGrid runat="server" ClientIDMode="Static" Font-Size="10pt" ID="gvData" AutoGenerateColumns="false" Width="100%" GridLines="None" BorderStyle="None" CssClass="table table-hover">
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="tbl_GLAccountEntryDetailsId" Visible="false"></asp:BoundColumn>
                                           <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, GLAccountEntryDetails_htGLAccountEntry%>" DataField="tbl_GLAccountEntry"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, GLAccountEntryDetails_htAccountNumber %>" DataField="AccountNumber"></asp:BoundColumn>
                                          <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, GLAccountEntryDetails_htDebit%>" DataField="Debit"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, GLAccountEntryDetails_htCredit %>" DataField="Credit"></asp:BoundColumn>


                                        <asp:TemplateColumn HeaderImageUrl="~/images/eye.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                               <button id="lnkView_<%# Container.DataSetIndex + 1 %>" type="button" data-toggle="modal" data-target="#divBasicModal" data-keyboard="false" data-backdrop="static" class="btn btn-default btn-sm btn-block" onclick="SetDetails('<%#Eval("tbl_GLAccountEntry")%>','<%#Eval("AccountNumber")%>','<%#Eval("Debit")%>','<%#Eval("Credit")%>','lnkview_<%# Container.DataSetIndex + 1 %>');">
                                            <asp:Literal runat="server" ID="ltrView" Text="<%$ Resources:GlobalResource, ltrView%>"></asp:Literal></button>
                                        <button id="lnkViewNextPrev_<%# Container.DataSetIndex + 1 %>" style="display: none;" type="button" class="btn btn-default btn-sm" onclick="SetDetails('<%#Eval("tbl_GLAccountEntry")%>','<%#Eval("AccountNumber")%>','<%#Eval("Debit")%>','<%#Eval("Credit")%>','lnkview_<%# Container.DataSetIndex + 1 %>');"></button>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>

                                        <asp:TemplateColumn HeaderImageUrl="~/images/edit.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="gvColLnkBtn" class="btn btn-default btn-sm btn-block" OnClick="gvColLnkBtn_Click" CommandArgument='<%#Eval("tbl_GLAccountEntryDetailsId") %>'>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><span>
                        <asp:Literal runat="server" ID="ltrRecordDetails" Text="<%$ Resources:GlobalResource, GLAccountEntryDetailsTitle_ltrGLAccountEntry %>"></asp:Literal></span></h4>
                </div>
                <div class="modal-body">
                    <table class="table table-striped" style="width: 100%; font-size: 9.5pt;">
                        <tr>
                             <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrGLAccountEntry" Text="<%$ Resources:GlobalResource, GLAccountEntryDetail_ltrGLAccountEntry%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrAccountNumber" Text="<%$ Resources:GlobalResource, GLAccountEntryDetail_ltrGLAccount%>"></asp:Literal></td>
                     <td><asp:Literal runat="server" ID="ltrDebit" Text="<%$ Resources:GlobalResource, GLAccountEntryDetails_ltrDebit%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrCredit" Text="<%$ Resources:GlobalResource, GLAccountEntryDetails_ltrCredit%>"></asp:Literal></td>
                        </tr>
                        <tr>
                              <td>
                                <asp:Label ID="lblGLAccountEntry" runat="server" ClientIDMode="Static"></asp:Label></td>
                            <td>
