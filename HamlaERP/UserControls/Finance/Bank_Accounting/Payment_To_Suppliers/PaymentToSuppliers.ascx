...
<div class="row" style="margin-top: 100px;">
    ...
    <div class="col-md-5">
        <div class="jumbotron slideUp">
            ...
            <p>
                <a class="btn btn-success btn-md" href="../../../../Finance/Bank_Accounting/Payment_To_Suppliers/PaymentToSupplierForm.aspx" role="button">
                    <asp:Literal runat="server" ID="ltrNew" Text="<%$ Resources:GlobalResource, btnNew%>"></asp:Literal>
                </a>
                <a class="btn btn-success btn-md" href="../../../../Finance/Bank_Accounting/Payment_To_Suppliers/PaymentToSupplierList.aspx" role="button">
