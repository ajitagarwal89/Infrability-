...
<div class="row" style="margin-top: 100px;">
    ...
    <div class="col-md-5">
        <div class="jumbotron slideUp">
            ...
            <p>
                <a class="btn btn-success btn-md" href="../../../../Finance/Accounts_Payable/Supplier_Master_Creation/PaymentTermsForm.aspx" role="button">
                    <asp:Literal runat="server" ID="ltrNew" Text="<%$ Resources:GlobalResource, ascxSupplierMasterCreation_btnPaymentTerms%>"></asp:Literal>
                </a>
                <a class="btn btn-success btn-md" href="../../../../Finance/Accounts_Payable/Supplier_Master_Creation/SupplierAndGroupAccountForm.aspx" role="button">
                ...
                <a class="btn btn-success btn-md" href="../../../../Finance/Accounts_Payable/Supplier_Master_Creation/SupplierForm.aspx" role="button">
                    <asp:Literal runat="server" ID="Literal1" Text="<%$ Resources:GlobalResource, ascxSupplierMasterCreation_btnSupplier%>"></asp:Literal>
                </a>

                <a class="btn btn-success btn-md" href="../../../../Finance/Accounts_Payable/Supplier_Master_Creation/SupplierGroupForm.aspx" role="button">
