...
<div class="row" style="margin-top: 100px;">
    ...
    <div class="col-md-5">
        <div class="jumbotron slideUp">
            ...
            <p>
                <a class="btn btn-success btn-md" href="../../../Finance/Accounts_Payable/Employee_Supplier_Master_Creation/EmployeeAndGroupAccountForm.aspx" role="button">
                ...
                <a class="btn btn-success btn-md" href="../../../Finance/Accounts_Payable/Employee_Supplier_Master_Creation/EmployeeForm.aspx" role="button">

                    <asp:Literal runat="server" ID="ltrView" Text="<%$ Resources:GlobalResource, EmployeeSupplierMasterCreation_btnEmployee%>"></asp:Literal>
                </a>

                 <a class="btn btn-success btn-md" href="../../../Finance/Accounts_Payable/Employee_Supplier_Master_Creation/EmployeeGroupForm.aspx" role="button">
