    ...
    <div class="col-md-5">
        <div class="jumbotron slideUp">
            ...
            <div class="row">
                ...
                <p>
                <a class="btn btn-success btn-md"  style="width:250px"  href="Finance/Accounts_Payable/PO/POForm.aspx" role="button">
                    <asp:Literal runat="server" ID="ltrNew" Text="<%$ Resources:GlobalResource, btnNew%>"></asp:Literal>
                </a>
                <a class="btn btn-success btn-md"  style="width:250px" href="Finance/Accounts_Payable/PO/POList.aspx" role="button">
