...
public partial class Finance_Asset__Accounting_Disposal_of_Assets_AssetDisposalDetailsForm : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            if (Request.QueryString["AssetDisposalDetailsId"] != null || Request.QueryString["recordId"] != null)
            {
                assetDisposalDetailsFormUI.Tbl_AssetDisposalDetailsId =  (Request.QueryString["AssetDisposalDetailsId"] != null ? Request.QueryString["AssetDisposalDetailsId"] : Request.QueryString["recordId"]) ;
    ...
    protected void btnAuditHistory_Click(object sender, EventArgs e)
    {
        ...
        string recordId = Request.QueryString["AssetDisposalDetailsId"];
