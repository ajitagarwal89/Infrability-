...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    <script src="../../../infra_ui/js/Finance_JS/Asset%20_Accounting_JS/Depreciation_of_Assets_JS/AssetBookSetupForm.js"></script>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox runat="server" ID="txtAssetBookSetupCode" ClientIDMode="Static" class="form-control "  onkeypress="return isAlphaNumberKey(this);" maxlength="50" placeholder="" required="required"></asp:TextBox>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
						  ...
						  <div class="form-group col-md-12 col-sm-12">
                            ...
                            <asp:TextBox runat="server" ID="txtDescription" ClientIDMode="Static" class="form-control " TextMode="MultiLine"  onkeypress="return isAddress(this);" maxlength="100" placeholder="" required="required"></asp:TextBox>
                        </div>
                    </div>
                </div>
            </div>
