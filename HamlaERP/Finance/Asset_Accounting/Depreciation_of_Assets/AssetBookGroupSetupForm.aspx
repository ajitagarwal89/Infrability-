...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    <script src="../../../infra_ui/js/Finance_JS/Asset%20_Accounting_JS/Depreciation_of_Assets_JS/AssetBookGroupSetupForm.js"></script>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-12" style="background-color: #f6f6f6">
                            <h5>
                                <asp:Literal runat="server" ID="ltrAssetBookGroupSetup" Text="<%$ Resources:GlobalResource, AssetBookGroupSetup_ltrAssetBookGroupSetupInformation%>"></asp:Literal>
                            </h5>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox runat="server" ID="txtAssetBookGroupSetupCode" ClientIDMode="Static" class="form-control " onkeypress="return isAlphaNumberKey(this);" MaxLength="50" placeholder="" required="required"></asp:TextBox>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox runat="server" ID="txtOriginalLifeYear" ClientIDMode="Static" class="form-control " onkeypress="return isNumberKey(this);" MaxLength="1" placeholder="" required="required"></asp:TextBox>
                        </div>

                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblOriginalLifeDay" Text="<%$ Resources:GlobalResource, AssetBookGroupSetup_OriginalLifeDay%>"></asp:Label>
                            <asp:TextBox runat="server" ID="txtOriginalLifeDay" ClientIDMode="Static" class="form-control " onkeypress="return isNumberKey(this);" MaxLength="1" placeholder="" required="required"></asp:TextBox>
                        </div>

                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblScrapValue" Text="<%$ Resources:GlobalResource, AssetBookGroupSetup_lblScrapValue%>"></asp:Label>
                            <asp:TextBox runat="server" ID="txtScrapValue" ClientIDMode="Static" class="form-control " onkeypress="return isNumberKeyPoint(this);" MaxLength="9" placeholder="" required="required"></asp:TextBox>
                        </div>
