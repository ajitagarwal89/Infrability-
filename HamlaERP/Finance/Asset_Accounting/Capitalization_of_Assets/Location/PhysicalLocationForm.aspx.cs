...
public partial class Physical_Location_PhysicalLocationForm : PageBase
{
    #region Data Members
    ...
    protected override void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            if (Request.QueryString["PhysicalLocationId"] != null || Request.QueryString["recordId"] != null)
            {
                physicalLocationFormUI.Tbl_PhysicalLocationId = (Request.QueryString["PhysicalLocationId"] != null ? Request.QueryString["PhysicalLocationId"] : Request.QueryString["recordId"]);
    ...
    {
        string Form = "~/Finance/Asset_Accounting/Capitalization_of_Assets/Location/PhysicalLocationForm.aspx";
        string recordId = Request.QueryString["PhysicalLocationId"];
