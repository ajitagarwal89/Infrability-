...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    <script src="../../../../infra_ui/js/Finance_JS/Asset%20_Accounting_JS/Capitalization_of_Assets_JS/Location/LocationForm.js"></script>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox runat="server" ID="txtLocationCode" ClientIDMode="Static" onkeypress="return isAlphaNumberKey(this);" MaxLength="20" class="form-control" placeholder="" required="required" autofocus="autofocus"></asp:TextBox>
                        </div>
