...
public partial class Assets_AssetAndGroupAccount_AssetAndGroupAccountForm : PageBase
{
    #region Data Members
    ...
    protected override void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            if (Request.QueryString["AssetAndGroupAccountId"] != null || Request.QueryString["recordId"] != null)
            {
                assetAndGroupAccountFormUI.Tbl_AssetAndGroupAccountId = (Request.QueryString["AssetAndGroupAccountId"] != null ? Request.QueryString["AssetAndGroupAccountId"] : Request.QueryString["recordId"]);
    ...
    {
        string Form = "~/Finance/Asset_Accounting/Capitalization_of_Assets/AssetAndGroupAccountList.aspx";
        string recordId = Request.QueryString["AssetAndGroupAccountId"];
