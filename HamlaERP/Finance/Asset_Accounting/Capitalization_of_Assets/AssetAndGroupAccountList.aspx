<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AssetAndGroupAccountList.aspx.cs" Inherits="Assets_AssetAndGroupAccount_AssetAndGroupAccountList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    <script src="../../../infra_ui/js/Finance_JS/Asset%20_Accounting_JS/Capitalization_of_Assets_JS/AssetAndGroupAccountList.js"></script>
</asp:Content>
     ...
     <div id="content" class="ui-content ui-content-aside-overlay">
        ...
        <div class="ui-content-body">
            <div class="ui-container">
                <div class="row">
                    <h3 class="hepad">
                        <asp:Literal runat="server" ID="ltrSearch" Text="<%$ Resources:GlobalResource, AssetAndGroupAccount_ltrAssetAndGroupAccount %>"></asp:Literal></h3>
                            ...
                            <ContentTemplate>
                                ...
                                <asp:DataGrid runat="server" ClientIDMode="Static" Font-Size="10pt" ID="gvData" AutoGenerateColumns="false" Width="100%" GridLines="None" BorderStyle="None" CssClass="table table-hover">
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="tbl_AssetAndGroupAccountId" Visible="false"></asp:BoundColumn>
                                          <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, AssetAndGroupAccount_htAccountCode%>" DataField="AccountCode"></asp:BoundColumn>
                                          <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, AssetAndGroupAccount_htAccountType%>" DataField="AccountType"></asp:BoundColumn>
                                         <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, AssetAndGroupAccount_htDepreciationExpense%>" DataField="DepreciationExpense"></asp:BoundColumn>                                        
                                       
                                         <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, AssetAndGroupAccount_htAssetCost%>" DataField="AssetCost"></asp:BoundColumn>
                                        

                                        <asp:TemplateColumn HeaderImageUrl="~/images/eye.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <button id="lnkView_<%# Container.DataSetIndex + 1 %>" type="button" data-toggle="modal" data-target="#divBasicModal" data-keyboard="false" data-backdrop="static" class="btn btn-default btn-sm btn-block" onclick="setDetails('<%#Eval("AccountCode")%>','<%#Eval("AccountType")%>','<%#Eval("DepreciationExpense")%>','<%#Eval("AccumulatedDepreciation")%>','<%#Eval("PriorYearDepreciation")%>','<%#Eval("AssetCost")%>','<%#Eval("Clearing")%>','lnkview_<%# Container.DataSetIndex + 1 %>');">
                                                    <asp:Literal runat="server" ID="ltrView" Text="<%$ Resources:GlobalResource, ltrView%>"></asp:Literal></button>
                                                <button id="lnkViewNextPrev_<%# Container.DataSetIndex + 1 %>" style="display: none;" type="button" class="btn btn-default btn-sm" onclick="setDetails('<%#Eval("AccountCode")%>','<%#Eval("AccountType")%>','<%#Eval("DepreciationExpense")%>','<%#Eval("AccumulatedDepreciation")%>','<%#Eval("PriorYearDepreciation")%>','<%#Eval("AssetCost")%>','<%#Eval("Clearing")%>','lnkview_<%# Container.DataSetIndex + 1 %>');"></button>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>

                                        <asp:TemplateColumn HeaderImageUrl="~/images/edit.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="gvColLnkBtn" class="btn btn-default btn-sm btn-block" OnClick="gvColLnkBtn_Click" CommandArgument='<%#Eval("tbl_AssetAndGroupAccountId") %>'>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><span>
                        <asp:Literal runat="server" ID="ltrRecordDetails" Text="<%$ Resources:GlobalResource, AssetAndGroupAccount_ltrDetails %>"></asp:Literal></span></h4>
                </div>
                <div class="modal-body">
                    <table class="table table-striped" style="width: 100%; font-size: 9.5pt;">
                        <tr>
                            <td class="auto-style1">
                                  <asp:Literal runat="server" ID="ltrAccountCode" Text="<%$ Resources:GlobalResource, AssetAndGroupAccount_ltrAccountCode%>"></asp:Literal></td>
                                <td><asp:Literal runat="server" ID="ltrAccountType" Text="<%$ Resources:GlobalResource, AssetAndGroupAccount_ltrAccountType%>"></asp:Literal></td>
                                <td class="auto-style1">
                               <asp:Literal runat="server" ID="ltrDepreciationExpense" Text="<%$ Resources:GlobalResource, AssetAndGroupAccount_ltrDepreciationExpense%>"></asp:Literal></td>
                            
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="lblAccountCode" runat="server" ClientIDMode="Static"></asp:Label></td>
                            <td>
                        ...
                        <tr>
                             <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrAccumulatedDepreciation" Text="<%$ Resources:GlobalResource, AssetAndGroupAccount_ltrAccumulatedDepreciation%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrPriorYearDepreciation" Text="<%$ Resources:GlobalResource, AssetAndGroupAccount_ltrPriorYear%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrAssetCost" Text="<%$ Resources:GlobalResource, AssetAndGroupAccount_ltrAssetCost%>"></asp:Literal></td>
                        ...
                        <tr>
                          ...
                          <tr>
                            ...
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrClearing" Text="<%$ Resources:GlobalResource, AssetAndGroupAccount_ltrClearing%>"></asp:Literal></td>
                        </tr>
                        <tr>
