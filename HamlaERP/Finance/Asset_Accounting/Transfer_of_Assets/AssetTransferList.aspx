<%@ Page  Title="" Language="C#" MasterPageFile="~/Site.master"  AutoEventWireup="true" CodeFile="AssetTransferList.aspx.cs" Inherits="Finance_Asset__Accounting_Transfer_of_Assets_AssetTransferList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    <script src="../../../infra_ui/js/Finance_JS/Asset%20_Accounting_JS/Transfer_of_Assets_JS/AssetTransferList.js"></script>
</asp:Content>
    ...
    <div id="content" class="ui-content ui-content-aside-overlay">
        ...
        <div class="ui-content-body">
            <div class="ui-container">
                <div class="row">
                    <h3 class="hepad">
                        <asp:Literal runat="server" ID="ltrSearch" Text="<%$ Resources:GlobalResource, AssetTransfer_ltrAssetTransfer%>"></asp:Literal></h3>
                            ...
                            <ContentTemplate>
                                ...
                                <asp:DataGrid runat="server" ClientIDMode="Static" Font-Size="10pt" ID="gvData" AutoGenerateColumns="false" Width="100%" GridLines="None" BorderStyle="None" CssClass="table table-hover">
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="tbl_AssetTransferId" Visible="false"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, AssetTransfer_htType%>" DataField="DocumentType"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, AssetTransfer_htNumber%>" DataField="Number"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, AssetTransfer_htBatchId%>" DataField="tbl_Batch"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, AssetTransfer_htLocationFrom%>" DataField="tbl_Location_From"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, AssetTransfer_htDate%>" DataField="Date"></asp:BoundColumn>

                                        <asp:TemplateColumn HeaderImageUrl="~/images/eye.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <button id="lnkView_<%# Container.DataSetIndex + 1 %>" type="button" data-toggle="modal" data-target="#basicModalAssetTransferSearch" data-keyboard="false" data-backdrop="static" class="btn btn-default btn-sm btn-block" onclick="setDetails('<%#Eval("DocumentType")%>','<%#Eval("Number")%>','<%#Eval("tbl_Batch")%>','<%#Eval("Date")%>','<%#Eval("tbl_Location_From")%>','<%#Eval("tbl_Location_To")%>','lnkview_<%# Container.DataSetIndex + 1 %>');">
                                                    <asp:Literal runat="server" ID="ltrView" Text="<%$ Resources:GlobalResource, ltrView%>"></asp:Literal></button>
                                                <button id="lnkViewNextPrev_<%# Container.DataSetIndex + 1 %>" style="display: none;" type="button" class="btn btn-default btn-sm" onclick="setDetails('<%#Eval("DocumentType")%>','<%#Eval("Number")%>','<%#Eval("tbl_Batch")%>','<%#Eval("Date")%>','<%#Eval("tbl_Location_From")%>','<%#Eval("tbl_Location_To")%>','lnkview_<%# Container.DataSetIndex + 1 %>');">
                                            </ItemTemplate>
                                        </asp:TemplateColumn>

                                        <asp:TemplateColumn HeaderImageUrl="~/images/edit.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="gvColLnkBtn" class="btn btn-default btn-sm btn-block" OnClick="gvColLnkBtn_Click" CommandArgument='<%#Eval("tbl_AssetTransferId") %>'>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><span>
                        <asp:Literal runat="server" ID="ltrRecordDetails" Text="<%$ Resources:GlobalResource, AssetTransfer_ltrAssetTransferDetails %>"></asp:Literal></span></h4>
                </div>
                <div class="modal-body">
                    <table class="table table-striped" style="width: 100%; font-size: 9.5pt;">
                        <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrDocumentType" Text="<%$ Resources:GlobalResource, AssetTransfer_ltrDocumentType%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrNumber" Text="<%$ Resources:GlobalResource, AssetTransfer_ltrNumber%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrBatchId" Text="<%$ Resources:GlobalResource, AssetTransfer_ltrBatchId%>"></asp:Literal></td>
                        </tr>
                        <tr>
                            <td>
                       ...
                       <tr>   
                            ...
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrDate" Text="<%$ Resources:GlobalResource, AssetTransfer_ltrDate%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrLocationFrom" Text="<%$ Resources:GlobalResource, AssetTransfer_ltrLocationIdFrom%>"></asp:Literal></td>
                           <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrLocationIdTo" Text="<%$ Resources:GlobalResource, AssetTransfer_ltrLocationIdTo%>"></asp:Literal></td>
                        </tr>
                        <tr>
