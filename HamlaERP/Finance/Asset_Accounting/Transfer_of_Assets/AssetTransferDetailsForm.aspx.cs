...
public partial class Finance_Asset__Accounting_Transfer_of_Assets_AssetTransferDetailsForm : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            if (Request.QueryString["AssetTransferDetailsId"] != null || Request.QueryString["recordId"] != null)
            {
                assetTransferDetailsFormUI.Tbl_AssetTransferDetailsId = (Request.QueryString["AssetTransferDetailsId"] != null ? Request.QueryString["AssetTransferDetailsId"] : Request.QueryString["recordId"]);
    ...
    {
        string Form = "~/Finance/Asset_Accounting/Transfer_of_Assets/AssetTransferDetailsForm.aspx";
        string recordId = Request.QueryString["AssetTransferDetailsId"];
