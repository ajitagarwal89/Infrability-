                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblUOM" Text="<%$ Resources:GlobalResource, AssetTransferDetails_lblUOM %>"></asp:Label>
                             <asp:TextBox runat="server" ID="txtUOM" ClientIDMode="Static" class="form-control " placeholder="" onkeypress="return isAlphaKey(this);" maxlength="30"  required="required"></asp:TextBox>
                        </div>
                         ...
                         <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblQuantityAvailable" Text="<%$ Resources:GlobalResource, AssetTransferDetails_lblQuantityAvailable %>"></asp:Label>
                             <asp:TextBox runat="server" ID="txtQuantityAvailable" ClientIDMode="Static" class="form-control "  onkeypress="return isNumberKey(this);" maxlength="4"  placeholder="" required="required"></asp:TextBox>
                        </div>

                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblQuantity" Text="<%$ Resources:GlobalResource, AssetTransferDetails_lblQuantity %>"></asp:Label>
                             <asp:TextBox runat="server" ID="txtQuantity" ClientIDMode="Static" class="form-control "  oonkeypress="return isNumberKey(this);" maxlength="4"  placeholder="" required="required"></asp:TextBox>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox  TextMode="MultiLine" runat="server" ID="txtDescription" ClientIDMode="Static" class="form-control " onkeypress="return isAddress(this);" maxlength="100" placeholder="" required="required"></asp:TextBox>
                        </div>
