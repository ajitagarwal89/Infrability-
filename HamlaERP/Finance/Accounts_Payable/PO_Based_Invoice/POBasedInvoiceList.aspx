<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="POBasedInvoiceList.aspx.cs" Inherits="Finance_Accounts_Payable_PO_Based_Invoice_POBasedInvoiceList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    <script src="../../../infra_ui/js/Finance_JS/Accounts_Payable_JS/PO_Based_Invoice_JS/POBasedInvoiceList.js"></script>
</asp:Content>
  ...
  <div id="content" class="ui-content ui-content-aside-overlay">
        ...
        <div class="ui-content-body">
            <div class="ui-container">
                <div class="row">
                    <h3 class="hepad">
                        <asp:Literal runat="server" ID="ltrSearch" Text="<%$ Resources:GlobalResource, POBasedInvoice_ltrPOBasedInvoices %>"></asp:Literal></h3>
                            ...
                            <ContentTemplate>
                                ...
                                <asp:DataGrid runat="server" ClientIDMode="Static" Font-Size="10pt" ID="gvData" AutoGenerateColumns="false" Width="100%" GridLines="None" BorderStyle="None" CssClass="table table-hover">
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="tbl_POBasedInvoiceId" Visible="false"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, POBasedInvoice_htSupplier%>" DataField="SupplierName"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, POBasedInvoice_htCurrency%>" DataField="CurrencyName"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, POBasedInvoice_htReceiptNumber%>" DataField="ReceiptNumber"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, POBasedInvoice_htPaymentTermsName%>" DataField="PaymentTermsName"></asp:BoundColumn>
                                        ...
                                        <asp:BoundColumn DataField="SubTotalAmount" Visible="false"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="TradeDiscountAmount" Visible="false"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="FreightAmount" Visible="false"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="TotalAmount" Visible="false"></asp:BoundColumn>
                                         <asp:TemplateColumn HeaderImageUrl="~/images/eye.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <button id="lnkView_<%# Container.DataSetIndex + 1 %>" type="button" data-toggle="modal" data-target="#divBasicModal" data-keyboard="false" data-backdrop="static" class="btn btn-default btn-sm btn-block" onclick="SetDetails('<%#Eval("SupplierName")%>','<%#Eval("CurrencyName")%>','<%#Eval("ReceiptNumber")%>','<%#Eval("PaymentTermsName")%>','<%#Eval("PostingDate")%>','<%#Eval("BatchName")%>','<%#Eval("InvoiceDate")%>','<%#Eval("SubTotalAmount")%>','<%#Eval("TradeDiscountAmount")%>','<%#Eval("FreightAmount")%>','<%#Eval("TotalAmount")%>','lnkview_<%# Container.DataSetIndex + 1 %>');">
                                                    <asp:Literal runat="server" ID="ltrView" Text="<%$ Resources:GlobalResource, ltrView%>"></asp:Literal></button>
                                                <button id="lnkViewNextPrev_<%# Container.DataSetIndex + 1 %>" style="display: none;" type="button" class="btn btn-default btn-sm" onclick="SetDetails('<%#Eval("SupplierName")%>','<%#Eval("CurrencyName")%>','<%#Eval("ReceiptNumber")%>','<%#Eval("PaymentTermsName")%>','<%#Eval("PostingDate")%>','<%#Eval("BatchName")%>','<%#Eval("InvoiceDate")%>','<%#Eval("SubTotalAmount")%>','<%#Eval("TradeDiscountAmount")%>','<%#Eval("FreightAmount")%>','<%#Eval("TotalAmount")%>','lnkview_<%# Container.DataSetIndex + 1 %>');"></button>
                                                </ItemTemplate>
                                        ...
                                        <asp:TemplateColumn HeaderImageUrl="~/images/edit.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="gvColLnkBtn" class="btn btn-default btn-sm btn-block" OnClick="gvColLnkBtn_Click" CommandArgument='<%#Eval("tbl_POBasedInvoiceId") %>'>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><span>
                        <asp:Literal runat="server" ID="ltrDetails" Text="<%$ Resources:GlobalResource, POBasedInvoice_ltrDetails %>"></asp:Literal></span></h4>
                </div>
                <div class="modal-body">
                    <table class="table table-striped" style="width: 100%; font-size: 9.5pt;">
                        <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrSupplierName" Text="<%$ Resources:GlobalResource, POBasedInvoice_ltrSupplierName%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrCurrencyName" Text="<%$ Resources:GlobalResource, POBasedInvoice_ltrCurrencyName%>"></asp:Literal></td>

                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrReceiptNumber" Text="<%$ Resources:GlobalResource, POBasedInvoice_ltrReceiptNumber%>"></asp:Literal></td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrPaymentTermsName" Text="<%$ Resources:GlobalResource, POBasedInvoice_ltrPaymentTermsName%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrPostingDate" Text="<%$ Resources:GlobalResource, POBasedInvoice_ltrPostingDate%>"></asp:Literal></td>
                          
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrInvoiceDate" Text="<%$ Resources:GlobalResource, POBasedInvoice_ltrInvoiceDate%>"></asp:Literal></td>
                        </tr>
                        <tr>
                            <td>
                          ...
                          <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrBatchName" Text="<%$ Resources:GlobalResource, POBasedInvoice_ltrBatchName%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrSubTotalAmount" Text="<%$ Resources:GlobalResource, POBasedInvoice_ltrSubTotalAmount%>"></asp:Literal></td>
                          
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrTradeDiscountAmount" Text="<%$ Resources:GlobalResource, POBasedInvoice_ltrTradeDiscountAmount%>"></asp:Literal></td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrFreightAmount" Text="<%$ Resources:GlobalResource, POBasedInvoice_ltrFreightAmount%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrTotalAmount" Text="<%$ Resources:GlobalResource, POBasedInvoice_ltrTotalAmount%>"></asp:Literal></td>
