...
public partial class Finance_Accounts_Payable_PO_Based_Invoice_POBasedInvoiceForm : PageBase
{
    ...
    protected override void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            if (Request.QueryString["POBasedInvoiceId"] != null || Request.QueryString["recordId"] != null)
            {
                pOBasedInvoiceFormUI.Tbl_POBasedInvoiceId = (Request.QueryString["POBasedInvoiceId"] != null ? Request.QueryString["POBasedInvoiceId"] : Request.QueryString["recordId"]);
            ...
            {
                pOBasedInvoiceFormUI.InvoiceType = invoiceTypeInvoice;
                GetSerialNumber(pOBasedInvoiceFormUI);
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            pOBasedInvoiceFormUI.Tbl_POId = txtPOGuid.Text;
            pOBasedInvoiceFormUI.Tbl_GoodsReceivedNoteId = txtGoodsReceivedNoteGuid.Text;
            ...
            pOBasedInvoiceFormUI.SupplierDocumentNumber = txtSupplierDocumentNumber.Text;
            ...
            pOBasedInvoiceFormUI.Miscellaneous = Convert.ToDecimal(txtMiscellaneous.Text);
    ...
    protected void btnPost_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            pOBasedInvoiceFormUI.Tbl_OrganizationId = SessionContext.OrganizationId;
            pOBasedInvoiceFormUI.Tbl_POBasedInvoiceId = Request.QueryString["POBasedInvoiceId"];
            pOBasedInvoiceFormUI.IsPosted = isPosted;

            if (pOBasedInvoiceFormBAL.UpdatePostingPOBasedInvoice(pOBasedInvoiceFormUI) == 1)
            {
                divSuccess.Visible = true;
        ...
        catch (Exception exp)
        {
            ...
            log.Error("[Finance_Accounts_Payable_PO_Based_Invoice_POBasedInvoiceForm : btnPost_Click] An error occured in the processing of Record Id : " + pOBasedInvoiceFormUI.Tbl_POBasedInvoiceId + ".  Details : [" + exp.ToString() + "]");
        }
    }
    ...
    {
        string Form = "~/Finance/Accounts_Payable/PO_Based_Invoice/POBasedInvoiceForm.aspx";
        string recordId = Request.QueryString["POBasedInvoiceId"];
    ...
    #region Methods
    private void GetSerialNumber(POBasedInvoiceFormUI pOBasedInvoiceFormUI)
    {
        try
        {
            DataTable dtb = pOBasedInvoiceFormBAL.GetSerialNumber(pOBasedInvoiceFormUI);
            if (dtb.Rows.Count > 0)
            {
                txtReceiptNumber.Text = dtb.Rows[0][0].ToString();
