...
public partial class Finance_Accounts_Payable_PO_Based_Invoice_POBasedInvoiceDistributionForm : PageBase
{
    #region Data Members
    ...
    protected override void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (Request.QueryString["POBasedInvoiceDistributionId"] != null || Request.QueryString["recordId"] != null)
            {
                pOBasedInvoiceDistributionFormUI.Tbl_POBasedInvoiceDistributionId = (Request.QueryString["POBasedInvoiceDistributionId"] != null ? Request.QueryString["POBasedInvoiceDistributionId"] : Request.QueryString["recordId"]);
    ...
    {
        string Form = "~/Finance/Accounts_Payable/PO_Based_Invoice/POBasedInvoiceDistributionForm.aspx";
        string recordId = Request.QueryString["POBasedInvoiceDistributionId"];
