                            ...
                            <ContentTemplate>
                                ...
                                <asp:DataGrid runat="server" ClientIDMode="Static" Font-Size="10pt" ID="gvData" AutoGenerateColumns="false" Width="100%" GridLines="None" BorderStyle="None" CssClass="table table-hover">
                                    <Columns>
                                        ...
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, Employee_lblName%>" DataField="Name"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, Employee_lblEmployeeCode%>" DataField="EmployeeCode"></asp:BoundColumn>

                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, Employee_lblContact%>" DataField="Contact"></asp:BoundColumn>

                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, Employee_lblPhone%>" DataField="Phone"></asp:BoundColumn>

                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, Employee_lblMobile%>" DataField="Mobile"></asp:BoundColumn>

                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, Employee_lblEmail%>" DataField="Email"></asp:BoundColumn>

                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, Employee_lblStatus%>" DataField="Status"></asp:BoundColumn>

                                        <asp:TemplateColumn HeaderImageUrl="~/images/eye.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <button id="lnkView_<%# Container.DataSetIndex + 1 %>" type="button" data-toggle="modal" data-target="#divBasicModal" data-keyboard="false" data-backdrop="static" class="btn btn-default btn-sm btn-block" onclick="SetDetails('<%#Eval("Name")%>','<%#Eval("EmployeeCode")%>','<%#Eval("Contact")%>','<%#Eval("Phone")%>','<%#Eval("Mobile")%>','<%#Eval("Email")%>','<%#Eval("Status")%>','lnkview_<%# Container.DataSetIndex + 1 %>');">
                                                    <asp:Literal runat="server" ID="ltrView" Text="<%$ Resources:GlobalResource, ltrView%>"></asp:Literal></button>
                                                <button id="lnkViewNextPrev_<%# Container.DataSetIndex + 1 %>" style="display: none;" type="button" class="btn btn-default btn-sm" onclick="SetDetails('<%#Eval("Name")%>','<%#Eval("EmployeeCode")%>','<%#Eval("Contact")%>','<%#Eval("Phone")%>','<%#Eval("Mobile")%>','<%#Eval("Email")%>','<%#Eval("Status")%>','lnkview_<%# Container.DataSetIndex + 1 %>');"></button>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><span>
                        <asp:Literal runat="server" ID="ltrRecordDetails" Text="<%$ Resources:GlobalResource, Employee_ltrInformation %>"></asp:Literal></span></h4>
                </div>
                <div class="modal-body">
                    <table class="table table-striped" style="width: 100%; font-size: 9.5pt;">
                        <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrName" Text="<%$ Resources:GlobalResource, Employee_lblName%>"></asp:Literal>
                            </td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrCode" Text="<%$ Resources:GlobalResource, Employee_lblEmployeeCode%>"></asp:Literal>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrContact" Text="<%$ Resources:GlobalResource, Employee_lblContact%>"></asp:Literal>
                            </td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrPhone" Text="<%$ Resources:GlobalResource, Employee_lblPhone%>"></asp:Literal>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrMobile" Text="<%$ Resources:GlobalResource, Employee_lblMobile%>"></asp:Literal>
                            </td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrEmail" Text="<%$ Resources:GlobalResource, Employee_lblEmail%>"></asp:Literal>
                            </td>
                        </tr>
                        <tr>
                            <td>
