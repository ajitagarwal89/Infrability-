<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="SupplierEmployeeGroupForm.aspx.cs" Inherits="Finance_Accounts_Payable_Employee_Supplier_Master_Creation_SupplierEmployeeGroupForm" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">

    <script src="../../../infra_ui/js/Finance_JS/Accounts_Payable_JS/Employee_Supplier_Master_Creation_JS/SupplierEmployeeGroupForm.js"></script>
</asp:Content>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-12" style="background-color: #f6f6f6">
                            <h5>
                                <asp:Literal runat="server" ID="ltrEmployeeInformation" Text="<%$ Resources:GlobalResource, SupplierEmployeeGroup_ltrInformation%>"></asp:Literal></h5>
                        </div>

                        <div class="form-group col-md-4 col-sm-4">
                            <div>
                                <asp:Label runat="server" ID="lblSupplierEmployeeGroupId_Self" Text="<%$ Resources:GlobalResource, SupplierEmployeeGroup_htSupplierEmployeeGroup %>"></asp:Label>
                            </div>
                            <div class="input-group">
                                <asp:TextBox ID="txtSupplierEmployeeGroupId_Self" ReadOnly="true" ClientIDMode="Static" runat="server" CssClass="form-control"></asp:TextBox>

                                <span class="input-group-addon lookup" id="spnSupplierEmployeeGroup_">
                                ...
                                <asp:TextBox ID="txtSupplierEmployeeGroupId_SelfGuid" runat="server" ClientIDMode="Static" Style="display: none;"></asp:TextBox>
                            </div>
                        </div>
                        
                        <div class="form-group col-md-4 col-sm-4">
                            <div>
                                <asp:Label runat="server" ID="lblPaymentTerms" Text="<%$ Resources:GlobalResource, SupplierEmployeeGroup_lblPaymentTerms%>"></asp:Label>
                            </div>
                            <div class="input-group">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <div>
                                <asp:Label runat="server" ID="lblCurrencyId" Text="<%$ Resources:GlobalResource, SupplierEmployeeGroup_lblCurrencyId %>"></asp:Label>
                            </div>
                            <div class="input-group">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblDescription" Text="<%$ Resources:GlobalResource, SupplierEmployeeGroup_lblDescription%>"></asp:Label>
                            <asp:TextBox runat="server" ID="txtDescription"  ClientIDMode="Static" class="form-control" placeholder="" required="required" autofocus="autofocus"></asp:TextBox>
                        </div>

                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblTradeDiscount" Text="<%$ Resources:GlobalResource, SupplierEmployeeGroup_lblTradeDiscount%>"></asp:Label>
                            <asp:TextBox runat="server" ID="txtTradeDiscount" ClientIDMode="Static" class="form-control" placeholder="" required="required"></asp:TextBox>
                        </div>

                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblMinimumPayment" Text="<%$ Resources:GlobalResource, SupplierEmployeeGroup_lblMinimumPayment%>"></asp:Label>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblMaximumInvoiceAmount" Text="<%$ Resources:GlobalResource, SupplierEmployeeGroup_lblMaximumInvoiceAmount%>"></asp:Label>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblCreditLimit" Text="<%$ Resources:GlobalResource, SupplierEmployeeGroup_lblCreditLimit%>"></asp:Label>
                            <asp:DropDownList ID="ddlOpt_CreditLimit" runat="server" ClientIDMode="Static" class="form-control " placeholder="" required="required">
                            </asp:DropDownList>
                        </div>

                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblWriteOff" Text="<%$ Resources:GlobalResource, SupplierEmployeeGroup_lblWriteOff%>"></asp:Label>
                            <asp:DropDownList ID="ddlOpt_WriteOff" runat="server" ClientIDMode="Static" class="form-control " placeholder="" required="required">
                            </asp:DropDownList>
                        </div>

                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblCalendarYear" Text="<%$ Resources:GlobalResource, SupplierEmployeeGroup_lblcalendarYear%>"></asp:Label>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblFiscalYear" Text="<%$ Resources:GlobalResource, SupplierEmployeeGroup_lblFiscalYear%>"></asp:Label>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblTransaction" Text="<%$ Resources:GlobalResource, SupplierEmployeeGroup_lblTransaction%>"></asp:Label>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblDistribution" Text="<%$ Resources:GlobalResource, SupplierEmployeeGroup_lblDistribution%>"></asp:Label>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="hdrModalSupplierEmployeeGroupTitle"><span>
                        <asp:Literal runat="server" ID="ltr_SupplierEmployeeGroupInformation" Text="<%$ Resources:GlobalResource, SupplierEmployeeGroup_ltrinformation %>"></asp:Literal>
                    </span>
                    </h4>
                </div>
                        ...
                        <asp:UpdatePanel runat="server" ID="updpnlgvSupplierEmployeeGroupSearch">
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvSupplierEmployeeGroupSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,SupplierEmployeeGroup_htSupplierEmployeeGroup%>">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,SupplierEmployeeGroup_htSupplierEmployeeGroupGuid%>" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lbltbl_SupplierEmployeeGroupId_Self" runat="server" Text='<%# Bind("tbl_SupplierEmployeeGroupId") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="hdrModalPaymentTermsTitle"><span>
                        <asp:Literal runat="server" ID="ltrPaymentTermsTitle" Text="<%$ Resources:GlobalResource, SupplierEmployeeGroup_lblPaymentTerms%>"></asp:Literal>
                    </span>
                    </h4>
                </div>
                <div class="modal-body">
                        ...
                        <asp:UpdatePanel runat="server" ID="updpnlgvPaymentTermsSearch">
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvPaymentTermsSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    EmptyDataText="<%$ Resources:GlobalResource,msgNoRecordFound%>" AllowPaging="True" PageSize="10" ClientIDMode="Static">
                                    <Columns>
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,SupplierEmployeeGroup_htPaymentTermsName%>">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, SupplierEmployeeGroup_htPaymentTermsGuid%>" Visible="false">
                                            <ItemTemplate>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="hdrModalCurrencyTitle"><span>
                        <asp:Literal runat="server" ID="ltrCurrencyTitle" Text="<%$ Resources:GlobalResource,SupplierEmployeeGroup_ltrCurrencyTitle%>"></asp:Literal>
                    </span>
                    </h4>
                </div>
                <div class="modal-body">
                        ...
                        <asp:UpdatePanel runat="server" ID="updpnlgvCurrencySearch">
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvCurrencySearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    EmptyDataText="<%$ Resources:GlobalResource,msgNoRecordFound%>" AllowPaging="True" PageSize="10" ClientIDMode="Static">
                                    <Columns>
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,SupplierEmployeeGroup_htCurrencyCode%>">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, SupplierEmployeeGroup_htCurrencyName%>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblgvCurrencyName" runat="server" Text='<%# Bind("CurrencyName") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, SupplierEmployeeGroup_htCurrencyGuid%>" Visible="false">
                                            <ItemTemplate>
