<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="EmployeeAndGroupAccountForm.aspx.cs" Inherits="Finance_Accounts_Payable_Employee_Supplier_Master_Creation_EmployeeAndGroupAccountForm" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    <script src="../../../infra_ui/js/Finance_JS/Accounts_Payable_JS/Employee_Supplier_Master_Creation_JS/EmployeeAndGroupAccountForm.js"></script>
</asp:Content>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-12" style="background-color: #f6f6f6">
                            <h5>
                                <asp:Literal runat="server" ID="ltrEmployeeAndGroupAccount" Text="<%$ Resources:GlobalResource, EmployeeAndGroupAccount_ltrInformation%>"></asp:Literal></h5>
                        </div>

                        <div class="form-group col-md-4 col-sm-4">

                            <asp:Label runat="server" ID="lblEmployeeGroup" Text="<%$ Resources:GlobalResource, EmployeeAndGroupAccount_lblEmployeeGroup%>"></asp:Label>

                            <div class="input-group">
                                <asp:TextBox ID="txtEmployeeGroup" ReadOnly="true" ClientIDMode="Static" runat="server" CssClass="form-control"></asp:TextBox>
                                <span class="input-group-addon lookup" id="sizing-addonEmployeeGroup_">
                                ...
                                <asp:TextBox ID="txtEmployeeGroupGuid" runat="server" ClientIDMode="Static" Style="display: none;"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group col-md-4 col-sm-4">


                            <asp:Label runat="server" ID="lblOpt_AccountType" Text="<%$ Resources:GlobalResource, EmployeeAndGroupAccount_lblOpt_AccountType %>"></asp:Label>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:Label runat="server" ID="lblPaymentMode" Text="<%$ Resources:GlobalResource, EmployeeAndGroupAccount_lblPaymentMode %>"></asp:Label>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:Label runat="server" ID="lblAccountPayable" Text="<%$ Resources:GlobalResource, EmployeeAndGroupAccount_lblAccountPayable%>"></asp:Label>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:Label runat="server" ID="lblPurchase" Text="<%$ Resources:GlobalResource, EmployeeAndGroupAccount_lblPurchase%>"></asp:Label>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:Label runat="server" ID="lblTradeDiscount" Text="<%$ Resources:GlobalResource, EmployeeAndGroupAccount_lblTradeDiscount%>"></asp:Label>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:Label runat="server" ID="lblAccruedPurchase" Text="<%$ Resources:GlobalResource, EmployeeAndGroupAccount_lblAccruedPurchase%>"></asp:Label>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="hdrModalEmployeeGroupTitle"><span>
                        <asp:Literal runat="server" ID="ltr_EmployeeAndGroupAccountInfomation" Text="<%$ Resources:GlobalResource, EmployeeAndGroupAccount_ltrInfomationEmployeeGroup %>"></asp:Literal>
                    </span>
                    </h4>
                </div>
                <div class="modal-body">
                    ...
                    <div>                        
                        <asp:UpdateProgress runat="server" ID="updProgData" AssociatedUpdatePanelID="updpnlgvEmployeeGroupSearch">
                            <ProgressTemplate>
                                Loading...
                            </ProgressTemplate>
                        </asp:UpdateProgress>
                        <asp:UpdatePanel runat="server" ID="updpnlgvEmployeeGroupSearch">
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvEmployeeGroupSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, EmployeeAndGroupAccount_ht_tbl_EmployeeGroupId%>">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, EmployeeAndGroupAccount_htEmployeeGroupGuid %>" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lbltbl_EmployeeGroupId" runat="server" Text='<%# Bind("tbl_EmployeeGroupId") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="hdrModalGLAccountId_CashTitle"><span>
                        <asp:Literal runat="server" ID="ltrGLAccountId_CashTitle" Text="<%$ Resources:GlobalResource, EmployeeAndGroupAccount_ltrGLAccountId_Cash%>"></asp:Literal>
                    </span>
                    </h4>
                </div>
                <div class="modal-body">
                        ...
                        <asp:UpdatePanel runat="server" ID="updpnlgvGLAccountId_CashSearch">
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvGLAccountId_CashSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    EmptyDataText="<%$ Resources:GlobalResource,msgNoRecordFound%>" AllowPaging="True" PageSize="10" ClientIDMode="Static">
                                    <Columns>
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,EmployeeAndGroupAccount_htAccountNumber%>">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, EmployeeAndGroupAccount_htGLAccountIdCashGuid %>" Visible="false">
                                            <ItemTemplate>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="hdrModaltAccountPayableTitle"><span>
                        <asp:Literal runat="server" ID="ltrtAccountPayableTitle" Text="<%$ Resources:GlobalResource, EmployeeAndGroupAccount_ltrAccountPayable_Infomation%>"></asp:Literal>
                    </span>
                    </h4>
                </div>
                <div class="modal-body">
                            ...
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvAccountPayableSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, EmployeeAndGroupAccount_htAccountPayableGuid %>" Visible="false">
                                            <ItemTemplate>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="hdrModalPurchaseTitle"><span>
                        <asp:Literal runat="server" ID="ltrPurchaseTitle" Text="<%$ Resources:GlobalResource, EmployeeAndGroupAccount_ltrAccruedPurchase_Infomation%>"></asp:Literal>
                    </span>
                    </h4>
                </div>
                <div class="modal-body">
                            ...
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvPurchaseSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, EmployeeAndGroupAccount_htPurchaseGuid %>" Visible="false">
                                            <ItemTemplate>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="hdrModalTradeDiscountTitle"><span>
                        <asp:Literal runat="server" ID="ltrTradeDiscountTitle" Text="<%$ Resources:GlobalResource, EmployeeAndGroupAccount__ltrTradeDiscount_Infomation%>"></asp:Literal>
                    </span>
                    </h4>
                </div>
                <div class="modal-body">
                            ...
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvTradeDiscountSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, EmployeeAndGroupAccount_htTradeDiscountGuid %>" Visible="false">
                                            <ItemTemplate>
                            ...
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvFreightSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, EmployeeAndGroupAccount_htFreightGuid %>" Visible="false">
                                            <ItemTemplate>
                            ...
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvAccruedPurchaseSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="<%$  Resources:GlobalResource,EmployeeAndGroupAccount_htAccruedPurchaseGuid %>" Visible="false">
                                            <ItemTemplate>
