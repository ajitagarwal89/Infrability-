...
public partial class Finance_Accounts_Payable_PO_POForm : PageBase
{
    #region Data Members
    ...
    protected override void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            if (Request.QueryString["POId"] != null || Request.QueryString["recordId"] != null)
            {
                {
                    pOFormUI.Tbl_POId = (Request.QueryString["POId"] != null ? Request.QueryString["POId"] : Request.QueryString["recordId"]);
                    ...
                    btnGoodsReceivedNote.Visible = true;
            ...
            else
            {
                ...
                btnGoodsReceivedNote.Visible = false;
    ...
    protected void btnGoodsReceivedNote_Click(object sender, EventArgs e)
    {
        string pOID = Request.QueryString["POId"];
        Response.Redirect("~/Finance/Accounts_Payable/Receive_Goods_or_Services/GoodsReceivedNoteForm.aspx?POId=" + pOID);
    }
    protected void btnPODetails_Click(object sender, EventArgs e)
    {

        string pOID = Request.QueryString["POId"];
        Response.Redirect("~/Finance/Accounts_Payable/PO/PODetailsForm.aspx?POId=" + pOID);
    }
    ...
    {
        string Form = "~Finance/Accounts_Payable/PO/POForm.aspx";
        string recordId = Request.QueryString["POId"];
