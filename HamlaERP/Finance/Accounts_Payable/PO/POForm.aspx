        ...
        <div id="ButtonBar" class="page-head-wrap">
            <div class="row">
                <div class="btn-group col-md-12 col-xs-12 pull-left" role="group">
                    ...
                    <asp:Button runat="server" ID="btnGoodsReceivedNote" CssClass="btn btn-success" Width="150px" OnClick="btnGoodsReceivedNote_Click" Text="<%$ Resources:GlobalResource, btnGoodsReceivedNote%>"  formnovalidate="formnovalidate"></asp:Button>
                    <asp:Button runat="server" ID="btnPODetails" CssClass="btn btn-success" Width="150px" OnClick="btnPODetails_Click" Text="<%$ Resources:GlobalResource, btnPODetails%>"  formnovalidate="formnovalidate"></asp:Button>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                          ...
                          <asp:TextBox runat="server" ID="txtPONumber" ClientIDMode="Static" class="form-control "  placeholder="" onkeypress="return isAlphaNumberKey(this);" MaxLength="20"  required="required"></asp:TextBox>
                              </div>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                          ...
                          <asp:TextBox runat="server" ID="txtRequisitionDate" TextMode="Date" ClientIDMode="Static" class="form-control "  placeholder="" required="required"></asp:TextBox>
                              </div>

                        <div class="form-group col-md-4 col-sm-4">
                              <asp:Label runat="server" ID="lblPurchaseOrderDate" Text="<%$ Resources:GlobalResource, PO_lblPurchaseOrderDate%>"></asp:Label>
                          <asp:TextBox runat="server" ID="txtPurchaseOrderDate" TextMode="Date" ClientIDMode="Static" class="form-control "  placeholder="" required="required"></asp:TextBox>
                              </div>

                        <div class="form-group col-md-4 col-sm-4">
                              <asp:Label runat="server" ID="lblLastEditDate" Text="<%$ Resources:GlobalResource, PO_lblLastEditDate%>"></asp:Label>
                          <asp:TextBox runat="server" ID="txtLastEditDate" TextMode="Date" ClientIDMode="Static" class="form-control "  placeholder="" required="required"></asp:TextBox>
                              </div>

                        <div class="form-group col-md-4 col-sm-4">
                              <asp:Label runat="server" ID="lblLastPrintedDate" Text="<%$ Resources:GlobalResource, PO_lblLastPrintedDate%>"></asp:Label>
                          <asp:TextBox runat="server" ID="txtLastPrintedDate" TextMode="Date" ClientIDMode="Static" class="form-control "  placeholder="" required="required"></asp:TextBox>
                              </div>

                        <div class="form-group col-md-4 col-sm-4">
                              <asp:Label runat="server" ID="lblContractExpirationDate" Text="<%$ Resources:GlobalResource, PO_lblContractExpirationDate%>"></asp:Label>
                          <asp:TextBox runat="server" ID="txtContractExpirationDate" TextMode="Date" ClientIDMode="Static" class="form-control "  placeholder="" required="required"></asp:TextBox>
                              </div>

                        <div class="form-group col-md-4 col-sm-4">
                              <asp:Label runat="server" ID="lblDatePlacedOnHold" Text="<%$ Resources:GlobalResource, PO_lblDatePlacedOnHold%>"></asp:Label>
                          <asp:TextBox runat="server" ID="txtDatePlacedOnHold" TextMode="Date" ClientIDMode="Static" class="form-control "  placeholder="" required="required"></asp:TextBox>
                              </div>

                        <div class="form-group col-md-4 col-sm-4">
                              <asp:Label runat="server" ID="lblDateHoldRemoved" Text="<%$ Resources:GlobalResource, PO_lblDateHoldRemoved%>"></asp:Label>
                          <asp:TextBox runat="server" ID="txtDateHoldRemoved" TextMode="Date" ClientIDMode="Static" class="form-control "  placeholder="" required="required"></asp:TextBox>
                              </div>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                          ...
                          <asp:TextBox runat="server" ID="txtRemainingSubTotal" ClientIDMode="Static" class="form-control "  placeholder="" onkeypress="return isNumberKeyPoint(this);"  MaxLength="9" required="required"></asp:TextBox>
                              </div>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                          ...
                          <asp:TextBox runat="server" ID="txtFreight" ClientIDMode="Static" class="form-control " onkeypress="return isNumberKeyPoint(this);"  MaxLength="9"   placeholder="" required="required"></asp:TextBox>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                          ...
                          <asp:TextBox runat="server" ID="txtTotal" ClientIDMode="Static" class="form-control " onkeypress="return isNumberKeyPoint(this);"  MaxLength="9" placeholder="" required="required"></asp:TextBox>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                          ...
                          <asp:TextBox runat="server" ID="txtVersion" ClientIDMode="Static" class="form-control "  placeholder="" onkeypress="return isNumberKey(this);"  MaxLength="4"  required="required"></asp:TextBox>
                              </div>
                                                ...
                                                <asp:GridView ID="gvPlacedOnHoldBySearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,PO_htPlacedOnHoldByCode%>">
                                                            <ItemTemplate>
                                                                <a href="#" data-dismiss="modal" onclick="SetPlacedOnHoldByDetails('<%#Eval("SystemUser")%>','<%#Eval("UserGuid")%>');">
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,PO_htPlacedOnHoldByGuid%>" Visible="false">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblgvPlacedOnHoldByGuid" runat="server" Text='<%# Bind("UserGuid") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                ...
                                                <asp:GridView ID="gvHoldRemovedBySearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,PO_htHoldRemovedByCode%>">
                                                            <ItemTemplate>
                                                                <a href="#" data-dismiss="modal" onclick="SetHoldRemovedByDetails('<%#Eval("SystemUser")%>','<%#Eval("UserGuid")%>');">
                                                                    <asp:Literal runat="server" ID="ltrgvDescription" Text='<%# Bind("FullName") %>'></asp:Literal>
                                                                </a>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,PO_htHoldRemovedByGuid%>" Visible="false">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblgvHoldRemovedByGuid" runat="server" Text='<%# Bind("UserGuid") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                    <HeaderStyle BackColor="#24648f" ForeColor="White" />
                                                ...
                                                <asp:GridView ID="gvUserId_BuyerSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,PO_htUserId_BuyerCode%>">
                                                            <ItemTemplate>
                                                                <a href="#" data-dismiss="modal" onclick="SetUserId_BuyerDetails('<%#Eval("SystemUser")%>','<%#Eval("UserGuid")%>');">
                                                                    <asp:Literal runat="server" ID="ltrgvDescription" Text='<%# Bind("FullName") %>'></asp:Literal>
                                                                </a>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,PO_htUserId_BuyerGuid%>" Visible="false">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblgvUserId_BuyerGuid" runat="server" Text='<%# Bind("UserGuid") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                    <HeaderStyle BackColor="#24648f" ForeColor="White" />
