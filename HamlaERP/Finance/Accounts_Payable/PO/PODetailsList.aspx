<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="PODetailsList.aspx.cs" Inherits="Finance_Accounts_Payable_PO_PODetailsList" %>



<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    <script src="../../../infra_ui/js/Finance_JS/Accounts_Payable_JS/PO_JS/PODetailsList.js"></script>
</asp:Content>
    ...
    <div id="content" class="ui-content ui-content-aside-overlay">
        ...
        <div class="ui-content-body">
            <div class="ui-container">
                <div class="row">
                    <h3 class="hepad">
                        <asp:Literal runat="server" ID="ltrSearch" Text="<%$ Resources:GlobalResource, PODetails_ltrPODetailsInformation%>"></asp:Literal></h3>
                            ...
                            <ContentTemplate>
                                ...
                                <asp:DataGrid runat="server" ClientIDMode="Static" Font-Size="10pt" ID="gvData" AutoGenerateColumns="false" Width="100%" GridLines="None" BorderStyle="None" CssClass="table table-hover">
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="tbl_PODetailsId" Visible="false"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, PODetails_ltrPOId %>" DataField="tbl_PO"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, PODetails_ltrFixedAsset%>" DataField="FixedAsset"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, PODetails_ltrLocaion%>" DataField="tbl_Location"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, PODetails_ltrQuantityOrdered%>" DataField="QuantityOrdered"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, PODetails_ltrQuantityCanceled%>" DataField="QuantityCanceled"></asp:BoundColumn>

                                        <asp:TemplateColumn HeaderImageUrl="~/images/eye.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <button id="lnkView_<%# Container.DataSetIndex + 1 %>" type="button" data-toggle="modal" data-target="#basicModalPODetailsSearch" data-keyboard="false" data-backdrop="static" class="btn btn-default btn-sm btn-block" onclick="setDetails('<%#Eval("tbl_PO")%>','<%#Eval("FixedAsset")%>','<%#Eval("Description")%>','<%#Eval("tbl_Location")%>','<%#Eval("QuantityOrdered")%>','<%#Eval("QuantityCanceled")%>','<%#Eval("UnitCost")%>','<%#Eval("ExtendedCost")%>','lnkview_<%# Container.DataSetIndex + 1 %>');">
                                                    <asp:Literal runat="server" ID="ltrView" Text="<%$ Resources:GlobalResource, ltrView%>"></asp:Literal></button>
                                                <button id="lnkViewNextPrev_<%# Container.DataSetIndex + 1 %>" style="display: none;" type="button" class="btn btn-default btn-sm" onclick="setDetails('<%#Eval("tbl_PO")%>','<%#Eval("FixedAsset")%>','<%#Eval("Description")%>','<%#Eval("tbl_Location")%>','<%#Eval("QuantityOrdered")%>','<%#Eval("QuantityCanceled")%>','<%#Eval("UnitCost")%>','<%#Eval("ExtendedCost")%>','lnkview_<%# Container.DataSetIndex + 1 %>');">
                                            </ItemTemplate>
                                        </asp:TemplateColumn>

                                        <asp:TemplateColumn HeaderImageUrl="~/images/edit.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="gvColLnkBtn" class="btn btn-default btn-sm btn-block" OnClick="gvColLnkBtn_Click" CommandArgument='<%#Eval("tbl_PODetailsId") %>'>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><span>
                        <asp:Literal runat="server" ID="ltrRecordDetails" Text="<%$ Resources:GlobalResource, PODetails_ltrPODetails %>"></asp:Literal></span></h4>
                </div>
                <div class="modal-body">
                    <table class="table table-striped" style="width: 100%; font-size: 9.5pt;">
                        <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrPOId" Text="<%$ Resources:GlobalResource, PODetails_ltrPOId%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrAsset" Text="<%$ Resources:GlobalResource, PODetails_ltrAsset%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrDescription" Text="<%$ Resources:GlobalResource, PODetails_ltrDescription%>"></asp:Literal></td>
                        </tr>
                        <tr>
                            <td>
                       ...
                       <tr>   
                            ...
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrLocation" Text="<%$ Resources:GlobalResource, PODetails_ltrLocation%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrQuantityOrdered" Text="<%$ Resources:GlobalResource, PODetails_ltrQuantityOrdered%>"></asp:Literal></td>
                           <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrQuantityCanceled" Text="<%$ Resources:GlobalResource, PODetails_ltrQuantityCanceled%>"></asp:Literal></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblQuantityCanceled" runat="server" ClientIDMode="Static"></asp:Label></td>
                        </tr>                     
                       
                        <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrUnitCost" Text="<%$ Resources:GlobalResource, PODetails_ltrUnitCost%>"></asp:Literal></td>
                            
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrExtendedCost" Text="<%$ Resources:GlobalResource, PODetails_ltrExtendedCost%>"></asp:Literal></td>
