<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="NonPOBasedInvoiceList.aspx.cs" Inherits="Finance_Accounts_Payable_Non_PO_Based_Invoice_NonPOBasedInvoiceList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    <script src="../../../infra_ui/js/Finance_JS/Accounts_Payable_JS/Non_PO_Based_Invoice_JS/NonPOBasedInvoiceList.js"></script>
</asp:Content>
  ...
  <div id="content" class="ui-content ui-content-aside-overlay">
        ...
        <div class="ui-content-body">
            <div class="ui-container">
                <div class="row">
                    <h3 class="hepad">
                        <asp:Literal runat="server" ID="ltrSearch" Text="<%$ Resources:GlobalResource, NonPOBasedInvoice_ltrNonPOBasedInvoices %>"></asp:Literal></h3>
                            ...
                            <ContentTemplate>
                                ...
                                <asp:DataGrid runat="server" ClientIDMode="Static" Font-Size="10pt" ID="gvData" AutoGenerateColumns="false" Width="100%" GridLines="None" BorderStyle="None" CssClass="table table-hover">
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="tbl_NonPOBasedInvoiceId" Visible="false"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, NonPOBasedInvoice_htVoucherNumber%>" DataField="VoucherNumber"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, NonPOBasedInvoice_htSupplierName%>" DataField="SupplierName"></asp:BoundColumn>
                                         <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, NonPOBasedInvoice_htPayablesType%>" DataField="PayablesType"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, NonPOBasedInvoice_htPaymentTermsName%>" DataField="PaymentTermsName"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, NonPOBasedInvoice_htDocumentType%>" DataField="DocumentType"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="InterCompany" Visible="false"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="BatchName" Visible="false"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="DocumentDate" Visible="false"></asp:BoundColumn>
                                        ...
                                        <asp:BoundColumn DataField="InvoiceDate" Visible="false"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="ReceivedDate" Visible="false"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="CurrencyName" Visible="false"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="DocumentNumber" Visible="false"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="PONumber" Visible="false"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="Purchase" Visible="false"></asp:BoundColumn>
                                       ...
                                       <asp:BoundColumn DataField="tbl_PayablesId_BankTransfer" Visible="false"></asp:BoundColumn>
                                        ...
                                        <asp:BoundColumn DataField="OnAccount" Visible="false"></asp:BoundColumn>

                                        <asp:TemplateColumn HeaderImageUrl="~/images/eye.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <button id="lnkView_<%# Container.DataSetIndex + 1 %>" type="button" data-toggle="modal" data-target="#divBasicModal" data-keyboard="false" data-backdrop="static" class="btn btn-default btn-sm btn-block" onclick="SetDetails('<%#Eval("VoucherNumber")%>','<%#Eval("InterCompany")%>','<%#Eval("BatchName")%>','<%#Eval("Opt_DocumentType")%>','<%#Eval("InvoiceDate")%>','<%#Eval("DocumentDate")%>','<%#Eval("CurrencyName")%>','lnkview_<%# Container.DataSetIndex + 1 %>');">
                                                    <asp:Literal runat="server" ID="ltrView" Text="<%$ Resources:GlobalResource, ltrView%>"></asp:Literal></button>
                                                <button id="lnkViewNextPrev_<%# Container.DataSetIndex + 1 %>" style="display: none;" type="button" class="btn btn-default btn-sm" onclick="SetDetails('<%#Eval("VoucherNumber")%>','<%#Eval("InterCompany")%>','<%#Eval("BatchName")%>','<%#Eval("Opt_DocumentType")%>','<%#Eval("InvoiceDate")%>','<%#Eval("DocumentDate")%>','<%#Eval("CurrencyName")%>','lnkview_<%# Container.DataSetIndex + 1 %>');"></button>
                                                </ItemTemplate>
                                        ...
                                        <asp:TemplateColumn HeaderImageUrl="~/images/edit.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="gvColLnkBtn" class="btn btn-default btn-sm btn-block" OnClick="gvColLnkBtn_Click" CommandArgument='<%#Eval("tbl_NonPOBasedInvoiceId") %>'>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><span>
                        <asp:Literal runat="server" ID="ltrDetails" Text="<%$ Resources:GlobalResource, NonPOBasedInvoice_ltrDetails %>"></asp:Literal></span></h4>
                </div>
                <div class="modal-body">
                    <table class="table table-striped" style="width: 100%; font-size: 9.5pt;">
                        <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrVoucherNumber" Text="<%$ Resources:GlobalResource, NonPOBasedInvoice_ltrVoucherNumber%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrInterCompany" Text="<%$ Resources:GlobalResource, NonPOBasedInvoice_ltrInterCompany%>"></asp:Literal></td>

                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrBatchName" Text="<%$ Resources:GlobalResource, NonPOBasedInvoice_ltrBatchName%>"></asp:Literal></td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="lblVoucherNumber" runat="server" ClientIDMode="Static"></asp:Label></td>
                            <td>
                                <asp:Label ID="lblInterCompany" runat="server" ClientIDMode="Static"></asp:Label></td>
                            <td>
                        ...
                        <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrDocumentType" Text="<%$ Resources:GlobalResource, NonPOBasedInvoice_ltrDocumentType%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrInvoiceDate" Text="<%$ Resources:GlobalResource, NonPOBasedInvoice_ltrInvoiceDate%>"></asp:Literal></td>
                          
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrDocumentDate" Text="<%$ Resources:GlobalResource, NonPOBasedInvoice_ltrDocumentDate%>"></asp:Literal></td>
                        </tr>
                        <tr>
                            <td>
                         ...
                         <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrCurrencyName" Text="<%$ Resources:GlobalResource, NonPOBasedInvoice_ltrCurrencyName%>"></asp:Literal></td>
                            </tr>
                        <tr>
                            <td>
