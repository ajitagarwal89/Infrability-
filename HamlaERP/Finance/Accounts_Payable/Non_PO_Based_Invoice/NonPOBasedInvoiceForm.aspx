                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                       ...
                       <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox runat="server" ID="txtVoucherNumber" ClientIDMode="Static" ReadOnly="true" class="form-control" onkeypress="return isAlphaNumberKey(this);" MaxLength="20" placeholder="" required="required"></asp:TextBox>
                        </div>
					   <div class="form-group col-md-4 col-sm-4">
					   ...
					   <div class="form-group col-md-4 col-sm-4">
						...
						<asp:UpdatePanel ID="uplInvoiceDate" runat="server" >
                            ...
                            <asp:TextBox runat="server" ID="txtInvoiceDate"  ClientIDMode="Static" TextMode="Date" class="form-control"  placeholder="" required="required"></asp:TextBox>
                        </div>
							</ContentTemplate>
						</asp:UpdatePanel>
                       ...
                       <div class="form-group col-md-4 col-sm-4">
                        ...
                        <asp:TextBox runat="server" ID="txtDocumentNumber" ClientIDMode="Static" class="form-control" onkeypress="return isAlphaNumberKey(this);" MaxLength="20" placeholder="" required="required"></asp:TextBox>
                    </div>
                       ...
                       <div class="form-group col-md-4 col-sm-4">
                        ...
                        <asp:TextBox runat="server" ID="txtPONumber" ClientIDMode="Static" class="form-control" onkeypress="return isAlphaNumberKey(this);" MaxLength="20" placeholder="" required="required"></asp:TextBox>
                    </div>
                       ...
                       <div class="form-group col-md-4 col-sm-4">
                        ...
                        <asp:TextBox runat="server" ID="txtPurchase" ClientIDMode="Static" onkeypress="return isNumberKeyPoint(this);" MaxLength="9" class="form-control" placeholder="" required="required"></asp:TextBox>
                    </div>
                       ...
                       <div class="form-group col-md-4 col-sm-4">
                              ...
                              <asp:Label runat="server" ID="lblPayablesType"  Text="<%$ Resources:GlobalResource, NonPOBasedInvoice_lblPayablesType%>"></asp:Label>
                       ...
                       <asp:UpdatePanel ID ="ucCash" runat="server">
                             <ContentTemplate>
                       ...
                       <asp:UpdatePanel ID ="ucCheque" runat="server">
                             <ContentTemplate>
                        ...
                        <asp:TextBox runat="server" ID="txtChequeAmount" ClientIDMode="Static" class="form-control" onkeypress="return isNumberKeyPoint(this);" MaxLength="9"  placeholder="" required="required"></asp:TextBox>
                    </div>
                            </div>
                                 </ContentTemplate>
                            </asp:UpdatePanel>

                       <asp:UpdatePanel ID ="ucCreditCard" runat="server">
                             <ContentTemplate>
                       ...
                       <div class="form-group col-md-4 col-sm-4">
                        ...
                        <asp:TextBox runat="server" ID="txtOnAccount" ClientIDMode="Static" class="form-control" onkeypress="return isNumberKeyPoint(this);" MaxLength="9"  placeholder="" required="required"></asp:TextBox>
                    </div>
					 ...
					 <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox runat="server" ID="txtDescription" TextMode="MultiLine" Rows="3" ClientIDMode="Static" class="form-control" onkeypress="return isAddress(this);" MaxLength="50" placeholder="" required="required"></asp:TextBox>
                        </div>
                </div>
            </div>
        </div>
