...
public partial class Finance_Accounts_Payable_Non_PO_Based_Invoice_NonPOBasedInvoiceForm : PageBase
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            nonPOBasedInvoiceFormUI.InvoiceDate = DateTime.Parse(txtInvoiceDate.Text.ToString());
            ...
            nonPOBasedInvoiceFormUI.DocumentDate = DateTime.Parse(txtDocumentDate.Text.ToString());
            nonPOBasedInvoiceFormUI.Description = txtDescription.Text;
            nonPOBasedInvoiceFormUI.PostingDate = DateTime.Parse(txtPostingDate.Text.ToString());
            nonPOBasedInvoiceFormUI.ReceivedDate = DateTime.Parse(txtReceivedDate.Text.ToString());
