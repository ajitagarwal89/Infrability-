<%@ Page  Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="NonPOBasedInvoiceDistributionList.aspx.cs" Inherits="Finance_Accounts_Payable_Non_PO_Based_Invoice_NonPOBasedInvoiceDistributionList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    <script src="../../../infra_ui/js/Finance_JS/Accounts_Payable_JS/Non_PO_Based_Invoice_JS/NonPOBasedInvoiceDistributionList.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="PageContent" runat="Server">
    <div id="content" class="ui-content ui-content-aside-overlay">
        ...
        <div class="ui-content-body">
            <div class="ui-container">
                <div class="row">
                    <h3 class="hepad">
                        <asp:Literal runat="server" ID="ltrSearch" Text="<%$ Resources:GlobalResource, NonPOBasedInvoiceDistribution_ltrNonPOBasedInvoiceDistribution %>"></asp:Literal></h3>
                                ...
                                <asp:DataGrid runat="server" ClientIDMode="Static" Font-Size="10pt" ID="gvData" AutoGenerateColumns="false" Width="100%" GridLines="None" BorderStyle="None" CssClass="table table-hover">
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderImageUrl="~/images/eye.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <button id="lnkView_<%# Container.DataSetIndex + 1 %>" type="button" data-toggle="modal" data-target="#basicModalNonPOBasedInvoiceDistributionSearch" data-keyboard="false" data-backdrop="static" class="btn btn-default btn-sm btn-block" onclick="setDetails('<%#Eval("tbl_POBasedInvoice")%>','<%#Eval("tbl_GLAccount")%>','<%#Eval("GLAccountType")%>','<%#Eval("Description")%>','<%#Eval("DistributionReference")%>','<%#Eval("Debit")%>','<%#Eval("Credit")%>','<%#Eval("OriginatingDebit")%>','<%#Eval("OriginatingCredit")%>','<%#Eval("ExchangeRate")%>','lnkview_<%# Container.DataSetIndex + 1 %>');">
                                                    <asp:Literal runat="server" ID="ltrView" Text="<%$ Resources:GlobalResource, ltrView%>"></asp:Literal></button>
                                                <button id="lnkViewNextPrev_<%# Container.DataSetIndex + 1 %>" style="display: none;" type="button" class="btn btn-default btn-sm" onclick="setDetails('<%#Eval("tbl_POBasedInvoice")%>','<%#Eval("tbl_GLAccount")%>','<%#Eval("GLAccountType")%>','<%#Eval("Description")%>','<%#Eval("DistributionReference")%>','<%#Eval("Debit")%>','<%#Eval("Credit")%>','<%#Eval("OriginatingDebit")%>','<%#Eval("OriginatingCredit")%>','<%#Eval("ExchangeRate")%>','lnkview_<%# Container.DataSetIndex + 1 %>');">
                                            </ItemTemplate>
                                        </asp:TemplateColumn>

                                        <asp:TemplateColumn HeaderImageUrl="~/images/edit.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="gvColLnkBtn" class="btn btn-default btn-sm btn-block" OnClick="gvColLnkBtn_Click" CommandArgument='<%#Eval("tbl_NonPOBasedInvoiceDistributionId") %>'>
    ...
    <div class="modal fade" id="basicModalNonPOBasedInvoiceDistributionSearch" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title" id="myModalLabel"><span>
                        <asp:Literal runat="server" ID="ltrRecordDetails" Text="<%$ Resources:GlobalResource, NonPOBasedInvoiceDistribution_ltrNonPOBasedInvoiceDistributionDetails%>"></asp:Literal></span></h4>
                </div>
                <div class="modal-body">
                    <table class="table table-striped" style="width: 100%; font-size: 9.5pt;">
                        <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrInvoiceId" Text="<%$ Resources:GlobalResource, NonPOBasedInvoiceDistribution_ltrInvoiceId%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrGLAccount" Text="<%$ Resources:GlobalResource, NonPOBasedInvoiceDistribution_ltrGLAccount%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrGLAccountType" Text="<%$ Resources:GlobalResource, NonPOBasedInvoiceDistribution_ltrGLAccountType%>"></asp:Literal></td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="lblInvoiceId" runat="server" ClientIDMode="Static"></asp:Label></td>
                            <td>
                       ...
                       <tr>   
                            ...
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrDescription" Text="<%$ Resources:GlobalResource, NonPOBasedInvoiceDistribution_ltrDescription%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrDistributionReference" Text="<%$ Resources:GlobalResource, NonPOBasedInvoiceDistribution_ltrDistributionReference%>"></asp:Literal></td>
                           <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrDebit" Text="<%$ Resources:GlobalResource, NonPOBasedInvoiceDistribution_ltrDebit%>"></asp:Literal></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrCredit" Text="<%$ Resources:GlobalResource, NonPOBasedInvoiceDistribution_ltrCredit%>"></asp:Literal></td>
                            
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrOriginatingDebit" Text="<%$ Resources:GlobalResource, NonPOBasedInvoiceDistribution_OriginatingDebit%>"></asp:Literal></td>
                            
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrOriginatingCredit" Text="<%$ Resources:GlobalResource, NonPOBasedInvoiceDistribution_ltrOriginatingCredit%>"></asp:Literal></td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                             <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrExchangeRate" Text="<%$ Resources:GlobalResource, NonPOBasedInvoiceDistribution_ltrExchangeRate%>"></asp:Literal></td>                                                    
                        </tr>
                        <tr>
                            <td>
