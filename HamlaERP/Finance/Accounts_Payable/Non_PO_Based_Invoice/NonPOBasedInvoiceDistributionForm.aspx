                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <div class="input-group">
                                <asp:TextBox ID="txtNonPOBasedInvoiceId" ReadOnly="true" ClientIDMode="Static" runat="server" CssClass="form-control"></asp:TextBox>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox type="text" runat="server" ID="txtExchangeRate" ClientIDMode="Static" class="form-control" placeholder="" required="required"></asp:TextBox>
                        </div>
