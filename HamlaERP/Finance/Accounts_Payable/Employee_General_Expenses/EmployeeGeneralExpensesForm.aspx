                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox  runat="server" ID="txtDocumentDate" TextMode="DateTime" ClientIDMode="Static" class="form-control" placeholder="" required="required" OnTextChanged="txtDocumentDate_TextChanged"></asp:TextBox>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox  runat="server" ID="txtReceivedDate" TextMode="DateTime" ClientIDMode="Static" class="form-control " placeholder="" required="required" OnTextChanged="txtReceivedDate_TextChanged"></asp:TextBox>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
						 ...
						 <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblDescription" Text="<%$ Resources:GlobalResource,EmployeeGeneralExpenses_lblDescription %>"></asp:Label>
                            <asp:TextBox  runat="server" ID="txtDescription"  TextMode="MultiLine" Rows="3" ClientIDMode ="Static" onkeypress="return isAddress(this);" MaxLength="200" class="form-control" placeholder="" required="required" autofocus="autofocus"></asp:TextBox>
                        </div>
                            ...
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvCurrencySearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,EmployeeGeneralExpenses_htCurrencyName%>">
                                            <ItemTemplate>
                                ...
                                <asp:GridView ID="gvEmployeeSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,EmployeeGeneralExpenses_htEmployeeCode%>">
                                            <ItemTemplate>
                                                <a href="#" data-dismiss="modal" onclick="SetEmployeeDetails('<%#Eval("MiddleName")%>','<%#Eval("tbl_EmployeeId")%>');">
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, EmployeeGeneralExpenses_htEmployeeName%>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblgvEmployeeName" runat="server" Text='<%# Bind("MiddleName") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
