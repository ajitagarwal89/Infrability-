...
public partial class Finance_Accounts_Payable_Employee_General_Expenses_EmployeeGeneralExpensesForm : PageBase
{
    ...
    protected override void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (Request.QueryString["EmployeeGeneralExpensesId"] != null || Request.QueryString["recordId"] != null)
            {
                employeeGeneralExpensesFormUI.Tbl_EmployeeGeneralExpensesId = (Request.QueryString["EmployeeGeneralExpensesId"] != null ? Request.QueryString["EmployeeGeneralExpensesId"] : Request.QueryString["recordId"]);
            ...
            {
                employeeGeneralExpensesFormUI.InvoiceType = invoiceTypeInvoice;
                GetSerialNumber(employeeGeneralExpensesFormUI);
                BindDocumentTypeDropDownList();
                BindPayablesTypeDropDownList();
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            employeeGeneralExpensesFormUI.Opt_DocumentType = Convert.ToInt32(ddlOpt_DocumentType.SelectedValue.ToString());
            ...
            employeeGeneralExpensesFormUI.Opt_PayablesType = Convert.ToInt32(ddlOpt_PayablesType.SelectedValue.ToString());
            ...
            {
                employeeGeneralExpensesFormUI.Tbl_Payables_BankTransfer = null;
                employeeGeneralExpensesFormUI.BankTransferAmount = 0;
            }
            ...
            {
                employeeGeneralExpensesFormUI.Tbl_Payables_Cash = null;
                employeeGeneralExpensesFormUI.Cash = 0;
            }
            ...
            {
                employeeGeneralExpensesFormUI.Tbl_Payables_Cheque = null;
                employeeGeneralExpensesFormUI.Cheque = 0;
            }
            ...
            {
                employeeGeneralExpensesFormUI.Tbl_Payables_CreditCard = null;
                employeeGeneralExpensesFormUI.CreditCard = 0;
            }
    ...
    {
        string Form = "~/Finance/Accounts_Payable/Employee_General_Expenses/EmployeeGeneralExpensesForm.aspx";
        string recordId = Request.QueryString["EmployeeGeneralExpensesId"];
    ...
    protected void btnPost_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            employeeGeneralExpensesFormUI.Tbl_OrganizationId = SessionContext.OrganizationId;
            employeeGeneralExpensesFormUI.Tbl_EmployeeGeneralExpensesId = Request.QueryString["EmployeeGeneralExpensesId"];
            employeeGeneralExpensesFormUI.IsPosted = isPosted;

            if (employeeGeneralExpensesFormBAL.UpdatePostingEmployeeGeneralExpenses(employeeGeneralExpensesFormUI) == 1)
            {
                divSuccess.Visible = true;
        ...
        catch (Exception exp)
        {
            ...
            log.Error("[Finance_Accounts_Payable_Employee_General_Expenses_EmployeeGeneralExpensesForm : btnPost_Click] An error occured in the processing of Record Id : " + employeeGeneralExpensesFormUI.Tbl_EmployeeGeneralExpensesId + ".  Details : [" + exp.ToString() + "]");
        }
    ...
    protected void txtDocumentDate_TextChanged(object sender, EventArgs e)
    {
        ...
        {
            DateTime documentDate = Convert.ToDateTime(txtDocumentDate.Text.ToString());

            if (documentDate < fiscalPeriodStartDate && documentDate > fiscalPeriodEndDate)
            {
                txtDocumentDate.Text = "";
                txtDocumentDate.Focus();
                ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(),
                "err_msg", "alert('Document Date can not be greater the Financial closing Date!)');", true);
            }
        }
    }
    ...
    protected void txtReceivedDate_TextChanged(object sender, EventArgs e)
    {
        ...
        {
            DateTime receivedDate = Convert.ToDateTime(txtReceivedDate.Text.ToString());

            if (receivedDate < fiscalPeriodStartDate && receivedDate > fiscalPeriodEndDate)
            {
                txtReceivedDate.Text = "";
                txtReceivedDate.Focus();
                ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(),
                "err_msg", "alert('Received Date can not be greater the Financial closing Date!)');", true);
            }
        }
    }
    ...
    private void GetSerialNumber(EmployeeGeneralExpensesFormUI employeeGeneralExpensesFormUI)
    {
        try
        {
            DataTable dtb = employeeGeneralExpensesFormBAL.GetSerialNumber(employeeGeneralExpensesFormUI);
            if (dtb.Rows.Count > 0)
            {
    ...
    private void BindPayablesTypeDropDownList()
    {
        try
        {
            ...
            optionSetListUI.TableName = "tbl_CustomerInvoiceProcess";
    ...
    private void FillForm(EmployeeGeneralExpensesFormUI employeeGeneralExpensesFormUI)
    {
        try
        {
            ...
            if (dtb.Rows.Count > 0)
            {
                ...
                txtPostingDate.Text = Convert.ToString(commonClasses.DateFormatMMDDYYY(Convert.ToDateTime(dtb.Rows[0]["PostingDate"])));
