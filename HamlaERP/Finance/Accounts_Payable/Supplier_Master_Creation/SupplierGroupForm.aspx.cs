...
public partial class Finance_Accounts_Payable_Supplier_Master_Creation_SupplierGroupForm : PageBase
{
    ...
    protected override void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            if (Request.QueryString["SupplierGroupId"] != null || Request.QueryString["recordId"] != null)
            {
                supplierGroupFormUI.Tbl_SupplierGroupId = (Request.QueryString["SupplierGroupId"] != null ? Request.QueryString["SupplierGroupId"] : Request.QueryString["recordId"]);
    ...
    {
        string Form = "~/Finance/Accounts_Payable/Supplier_Master_Creation/SupplierGroupForm.aspx";
        string recordId = Request.QueryString["SupplierGroupId"];
