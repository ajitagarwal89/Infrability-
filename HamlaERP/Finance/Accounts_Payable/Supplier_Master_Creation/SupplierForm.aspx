                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox runat="server" ID="txtSupplierCode" ClientIDMode="Static" ReadOnly="true" onkeypress="return isAlphaNumberKey(this);" MaxLength="50" class="form-control " placeholder="" required="required"></asp:TextBox>
                        </div>
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblName" Text="<%$ Resources:GlobalResource, Supplier_lblName %>">></asp:Label>
                            <asp:TextBox runat="server" ID="txtName" ClientIDMode="Static" class="form-control" onkeypress="return isAlphaKey(this);" MaxLength="50" placeholder="" required="required"></asp:TextBox>
                        </div>
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblShortName" Text="<%$ Resources:GlobalResource, Supplier_lblShortName %>"></asp:Label>
                            <asp:TextBox runat="server" ID="txtShortName" ClientIDMode="Static" class="form-control" onkeypress="return isAlphaKey(this);" MaxLength="20" placeholder="" required="required"></asp:TextBox>
                        </div>
                        <div class="form-group col-md-4 col-sm-4">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox runat="server" ID="txtContact" ClientIDMode="Static" class="form-control" onkeypress="return isNumberKey(this);" MaxLength="13" placeholder="" required="required"></asp:TextBox>
                        </div>
                        <div class="form-group col-md-4 col-sm-4">
                        ...
                        <div class="form-group col-md-8 col-sm-8">
                            ...
                            <div class="form-group col-md-4 col-sm-4">
                                ...
                                <asp:CheckBox ID="chkOnHold" runat="server"   ClientIDMode="Static" class="form-control" placeholder="" required="required" />
                            </div>
                        </div>
                         <div class="form-group col-md-4 col-sm-4">
                            <div>
                                <asp:Label runat="server" ID="lblGLAccountId_Cash" Text="<%$ Resources:GlobalResource, Supplier_lblGLAccountId_Cash%>"></asp:Label>
                            </div>
                            <div class="input-group">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <div>
                                <asp:Label runat="server" ID="lblGLAccountId_AccountPayable" Text="<%$ Resources:GlobalResource, Supplier_lblGLAccountId_AccountPayable%>"></asp:Label>
                            </div>
                            <div class="input-group">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <div>
                                <asp:Label runat="server" ID="lblGLAccountId_Purchase" Text="<%$ Resources:GlobalResource, Supplier_lblGLAccountId_Purchase%>"></asp:Label>
                            </div>
                            <div class="input-group">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <div>
                                <asp:Label runat="server" ID="lblGLAccountId_TradeDiscount" Text="<%$ Resources:GlobalResource, Supplier_lblGLAccountId_TradeDiscount%>"></asp:Label>
                            </div>
                            <div class=" input-group">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <div>
                                <asp:Label runat="server" ID="lblGLAccountId_Freight" Text="<%$ Resources:GlobalResource, Supplier_lblGLAccountId_Freight%>"></asp:Label>
                            </div>
                            <div class=" input-group">
                                <asp:TextBox ID="txtFreight" ReadOnly="true" ClientIDMode="Static" runat="server" CssClass="form-control"></asp:TextBox>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <div>
                                <asp:Label runat="server" ID="lblGLAccountId_AccruedPurchase" Text="<%$ Resources:GlobalResource, Supplier_lblGLAccountId_AccruedPurchase%>"></asp:Label>
                            </div>
                            <div class="input-group">
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="hdrModalCountryTitle"><span>
                        <asp:Literal runat="server" ID="ltrCountryTitle" Text="<%$ Resources:GlobalResource, Supplier_ltrCountryTitle %>"></asp:Literal>
                    </span>
                    </h4>
                </div>
                        ...
                        <asp:UpdatePanel runat="server" ID="updpnlgvCountrySearch">
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvCountrySearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,Supplier_htCountryCode%>">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,Supplier_htCountryName%>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblgvCountryName" runat="server" Text='<%# Bind("CountryName") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,Supplier_htCountryGuid%>" Visible="false">
                                            <ItemTemplate>
                        ...
                        <asp:UpdatePanel runat="server" ID="updpnlgvSupplierGroupSearch">
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvSupplierGroupSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    EmptyDataText="<%$ Resources:GlobalResource,msgNoRecordFound%>" AllowPaging="True" PageSize="10" ClientIDMode="Static">
                                    <Columns>
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,Supplier_htDescription%>">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,Supplier_htSupplierGroupGuid%>" Visible="false">
                                            <ItemTemplate>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="hdrModalGLAccountId_CashTitle"><span>
                        <asp:Literal runat="server" ID="ltrGLAccountId_CashTitle" Text="<%$ Resources:GlobalResource, Supplier_ltrGLAccountId_Cash%>"></asp:Literal>
                    </span>
                    </h4>
                </div>
                <div class="modal-body">
                        ...
                        <asp:UpdatePanel runat="server" ID="updpnlgvGLAccountId_CashSearch">
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvGLAccountId_CashSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    EmptyDataText="<%$ Resources:GlobalResource,msgNoRecordFound%>" AllowPaging="True" PageSize="10" ClientIDMode="Static">
                                    <Columns>
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,Supplier_htAccountNumber%>">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource ,Supplier_GLAccountId_CashGuid %>" Visible="false">
                                            <ItemTemplate>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="hdrModaltAccountPayableTitle"><span>
                        <asp:Literal runat="server" ID="ltrtAccountPayableTitle" Text="<%$ Resources:GlobalResource, Supplier_ltrAccountPayableInformation%>"></asp:Literal>
                    </span>
                    </h4>
                </div>
                <div class="modal-body">
                            ...
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvAccountPayableSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, Supplier_htAccountPayableGuid %>" Visible="false">
                                            <ItemTemplate>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="hdrModalPurchaseTitle"><span>
                        <asp:Literal runat="server" ID="ltrPurchaseTitle" Text="<%$ Resources:GlobalResource, Supplier_ltrPurchaseInformation%>"></asp:Literal>
                    </span>
                    </h4>
                </div>
                <div class="modal-body">
                            ...
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvPurchaseSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, Supplier_htPurchaseGuid %>" Visible="false">
                                            <ItemTemplate>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="hdrModalTradeDiscountTitle"><span>
                        <asp:Literal runat="server" ID="ltrTradeDiscountTitle" Text="<%$ Resources:GlobalResource, Supplier_ltrTradeDiscountInformation%>"></asp:Literal>
                    </span>
                    </h4>
                </div>
                <div class="modal-body">
                            ...
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvTradeDiscountSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, Supplier_htTradeDiscountGuid  %>" Visible="false">
                                            <ItemTemplate>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="hdrModalFreightTitle"><span>
                        <asp:Literal runat="server" ID="ltrEmployeeGroupTitle" Text="<%$ Resources:GlobalResource, Supplier_ltrGLAccountIdFreightInformation%>"></asp:Literal>
                    </span>
                    </h4>
                </div>
                <div class="modal-body">
                            ...
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvFreightSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, Supplier_htFreightGuid %>" Visible="false">
                                            <ItemTemplate>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="hdrModalAccruedPurchaseTitle"><span>
                        <asp:Literal runat="server" ID="ltrAccruedPurchaseTitlep" Text="<%$ Resources:GlobalResource, Supplier_ltrAccruedPurchaseInformation%>"></asp:Literal>
                    </span>
                    </h4>
                </div>
                <div class="modal-body">
                            ...
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvAccruedPurchaseSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, Supplier_htAccruedPurchaseGuid %>" Visible="false">
                                            <ItemTemplate>
