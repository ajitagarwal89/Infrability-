                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox type="text" runat="server" ID="txtDueInDays" ClientIDMode="Static" class="form-control" placeholder="" required="required"></asp:TextBox>
                        
                        </div>
                        <div class="form-group col-md-4 col-sm-4">
                                 <asp:Label runat="server" ID="lblDiscountInDays" Text="<%$ Resources:GlobalResource, PaymentTerms_lblDiscountInDays%>"></asp:Label>
                            <asp:TextBox type="text" runat="server" ID="txtDiscountInDays" ClientIDMode="Static" class="form-control" placeholder="" required="required"></asp:TextBox>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox type="text" runat="server" ID="txtDiscountTypeValue" ClientIDMode="Static" class="form-control" placeholder="" required="required"></asp:TextBox>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                           ...
                           <asp:CheckBox ID="chkSalesOrPurchase" runat="server" />
                      </div>
                    </div>
                </div>
            </div>
