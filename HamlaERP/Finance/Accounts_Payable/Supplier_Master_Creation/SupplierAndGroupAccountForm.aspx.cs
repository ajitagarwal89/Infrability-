...
public partial class Finance_Accounts_Payable_Supplier_Master_Creation_SupplierAndGroupAccountForm : PageBase
{
    ...
    protected override void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (Request.QueryString["SupplierAndGroupAccountId"] != null || Request.QueryString["recordId"] != null)
            {
                supplierAndGroupAccountFormUI.Tbl_SupplierAndGroupAccountId = (Request.QueryString["SupplierAndGroupAccountId"] != null ? Request.QueryString["SupplierAndGroupAccountId"] : Request.QueryString["recordId"]);
    ...
    {
        string Form = "~/Finance/Accounts_Payable/Supplier_Master_Creation/SupplierAndGroupAccountForm.aspx";
        string recordId = Request.QueryString["SupplierAndGroupAccountId"];
