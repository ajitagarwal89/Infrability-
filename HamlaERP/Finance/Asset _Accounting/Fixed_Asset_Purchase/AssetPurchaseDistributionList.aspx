<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AssetPurchaseDistributionList.aspx.cs" Inherits="Asset_Purchase_AssetPurchaseDistributionList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    <script src="../infra_ui/js/Asset_Purchase/AssetPurchaseDistributionList.js"></script>
      ...
      <div id="content" class="ui-content ui-content-aside-overlay">
        ...
        <div class="ui-content-body">
            <div class="ui-container">
                <div class="row">
                    <h3 class="hepad">
                        <asp:Literal runat="server" ID="ltrSearch" Text="<%$ Resources:GlobalResource, AssetPurchaseDistribution_ltrAssetPurchaseDistributionTitle %>"></asp:Literal></h3>
                            ...
                            <ContentTemplate>
                                <asp:DataGrid runat="server" ClientIDMode="Static" Font-Size="10pt" ID="gvData" AutoGenerateColumns="false" Width="100%" GridLines="None" BorderStyle="None" CssClass="table table-hover">
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="tbl_AssetPurchaseDistributionId" Visible="false"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, AssetPurchaseDistribution_htAssetPurchase%>" DataField="tbl_AssetPurchase"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, AssetPurchaseDistribution_htGlAccount%>" DataField="tbl_GlAccount"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, AssetPurchaseDistribution_htopt_GLAccountType%>" DataField="GLAccountType"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, AssetPurchaseDistribution_htDescription%>" DataField="Description"></asp:BoundColumn>
                                        ...
                                        <asp:TemplateColumn HeaderImageUrl="~/images/eye.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <button id="lnkView_<%# Container.DataSetIndex + 1 %>" type="button" data-toggle="modal" data-target="#divBasicModal" data-keyboard="false" data-backdrop="static" class="btn btn-default btn-sm btn-block" onclick="setDetails('<%#Eval("tbl_AssetPurchase")%>','<%#Eval("tbl_GLAccount")%>','<%#Eval("GLAccountType") %>','<%#Eval("Description") %>','<%#Eval("DistributionReference") %>','<%#Eval("Debit") %>','<%#Eval("Credit") %>','lnkview_<%# Container.DataSetIndex + 1 %>');">
                                                    <asp:Literal runat="server" ID="ltrView" Text="<%$ Resources:GlobalResource, ltrView%>"></asp:Literal></button>
                                                <button id="lnkViewNextPrev_<%# Container.DataSetIndex + 1 %>" style="display: none;" type="button" class="btn btn-default btn-sm" onclick="setDetails('<%#Eval("tbl_AssetPurchase")%>','<%#Eval("tbl_GLAccount")%>','<%#Eval("GLAccountType") %>','<%#Eval("Description") %>','<%#Eval("DistributionReference") %>','<%#Eval("Debit") %>','<%#Eval("Credit") %>','lnkview_<%# Container.DataSetIndex + 1 %>');"></button>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>

                                        <asp:TemplateColumn HeaderImageUrl="~/images/edit.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="gvColLnkBtn" class="btn btn-default btn-sm btn-block" OnClick="gvColLnkBtn_Click" CommandArgument='<%#Eval("tbl_AssetPurchaseDistributionId") %>'>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><span>
                        <asp:Literal runat="server" ID="ltrRecordDetails" Text="<%$ Resources:GlobalResource, AssetPurchaseDistribution_ltrDetails %>"></asp:Literal></span></h4>
                </div>
                <div class="modal-body">
                    <table class="table table-striped" style="width: 100%; font-size: 9.5pt;">
                        <tr>
                             <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrAssetPurchase" Text="<%$ Resources:GlobalResource, AssetPurchaseDistribution_ltrAssetPurchase%>"></asp:Literal></td>
                          
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrGLAccount" Text="<%$ Resources:GlobalResource, AssetPurchaseDistribution_ltrGLAccount%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrGLAccountType" Text="<%$ Resources:GlobalResource, AssetPurchaseDistribution_ltrGLAccountType%>"></asp:Literal></td>
                            
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="lblAssetPurchase" runat="server" ClientIDMode="Static"></asp:Label></td>
                         ...
                         <tr>
                             <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrDescription" Text="<%$ Resources:GlobalResource, AssetPurchaseDistribution_ltrDescription%>"></asp:Literal></td>

                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrDistributionReference" Text="<%$ Resources:GlobalResource, AssetPurchaseDistribution_ltrDistributionReference%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrDebit" Text="<%$ Resources:GlobalResource, AssetPurchaseDistribution_ltrDebit%>"></asp:Literal></td>
                        ...
                        <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrCredit" Text="<%$ Resources:GlobalResource, AssetPurchaseDistribution_ltrCredit%>"></asp:Literal></td>
