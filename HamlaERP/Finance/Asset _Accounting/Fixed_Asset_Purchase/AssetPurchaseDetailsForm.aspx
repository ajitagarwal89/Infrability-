...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
         <script src="../../infra_ui/js/Asset/AssetPurchaseDetails_JS/AssetPurchaseDetailsForm.js"></script>
</asp:Content>
                        ...
                        <div class="form-group col-md-12" style="background-color: #f6f6f6">
                         ...
                         <div>
                          ...
                          <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox type="text" runat="server" ID="txtQuantityShipped" ClientIDMode="Static" class="form-control " placeholder="" required="required"></asp:TextBox>
                        </div>
                          <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox type="text" runat="server" ID="txtQuantityInvoiced" ClientIDMode="Static" class="form-control " placeholder="" required="required"></asp:TextBox>
                        </div>
                          <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox type="text" runat="server" ID="txtPreviouslyShipped" ClientIDMode="Static" class="form-control " placeholder="" required="required"></asp:TextBox>
                        </div>
                          <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox type="text" runat="server" ID="txtPreviouslyInvoiced" ClientIDMode="Static" class="form-control " placeholder="" required="required"></asp:TextBox>
                        </div>
                          <div class="form-group col-md-4 col-sm-4">
                    ...
                    <div class="modal-content">
                        <div class="modal-header" style="text-align: left;">
                            ...
                            <h4 class="modal-title" id="hdrModalAssetPurchaseTitle"><span>
                                <asp:Literal runat="server" ID="ltrAssetPurchaseTitle" Text="<%$ Resources:GlobalResource, AssetPurchasePurchaseDetails_ltrAssetPurchaseTitle %>"></asp:Literal>
                            </span>
                            </h4>
                        </div>
                                ...
                                <asp:UpdatePanel runat="server" ID="updpnlgvAssetPurchaseSearch">
                                    <ContentTemplate>
                                        ...
                                        <asp:GridView ID="gvAssetPurchaseSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, AssetPurchasePurchaseDetails_htAssetPurchaseCode%>">
                                                    <ItemTemplate>
                                             ...
                                             <%--   <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,AssetPurchasePurchaseDetails_htAssetPurchaseName%>">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblgvAssetPurchaseName" runat="server" Text='<%# Bind("Description") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>--%>
                                                <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, AssetPurchasePurchaseDetails_htAssetPurchaseGuid%>" Visible="false">
                                                    <ItemTemplate>
                                        ...
                                        <asp:GridView ID="gvPONumberSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, AssetPurchaseDetails_htPONumberCode%>">
                                                    <ItemTemplate>
                                                        <a href="#" data-dismiss="modal" onclick="SetPONumberDetails('<%#Eval("Description")%>','<%#Eval("tbl_PONumberId")%>');">

                                                            <asp:Literal runat="server" ID="ltrgvPONumberCode" Text='<%# Bind("Description") %>'></asp:Literal>
                                                        </a>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                               <%-- <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,AssetPurchaseDetails_htPONumberName%>">
                                                ...
                                                <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, AssetPurchaseDetails_htPONumberGuid%>" Visible="false">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblgvPONumberGuid" runat="server" Text='<%# Bind("tbl_PONumberId") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                            <HeaderStyle BackColor="#24648f" ForeColor="White" />
