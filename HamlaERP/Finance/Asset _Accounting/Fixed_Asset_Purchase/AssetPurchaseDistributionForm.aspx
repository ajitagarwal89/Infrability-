...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    <script src="../infra_ui/js/Asset_Purchase/AssetPurchaseDistributionForm.js"></script>
</asp:Content>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox MaxLength="500"  type="text" runat="server" ID="txtDistributionReference" ClientIDMode="Static" class="form-control " placeholder="" required="required"></asp:TextBox>
                        </div>
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblDebit" Text="<%$ Resources:GlobalResource, AssetPurchaseDistribution_lblDebit %>"></asp:Label>
                             <asp:TextBox MaxLength="500" type="text" runat="server" ID="txtDebit" ClientIDMode="Static" class="form-control " placeholder="" required="required"></asp:TextBox>
                        </div>
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblCredit" Text="<%$ Resources:GlobalResource, AssetPurchaseDistribution_lblCredit %>"></asp:Label>
                             <asp:TextBox MaxLength="500" type="text" runat="server" ID="txtCredit" ClientIDMode="Static" class="form-control " placeholder="" required="required"></asp:TextBox>
                        </div>
