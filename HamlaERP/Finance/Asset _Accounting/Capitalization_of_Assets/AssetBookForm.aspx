...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    ...
    <script src="../infra_ui/js/Asset_JS/AssetBookForm.js"></script>
</asp:Content>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox   type="text" runat="server" ID="txtAssetBookCode" ClientIDMode="Static" class="form-control " placeholder="" required="required"></asp:TextBox>
                        </div>
                      ...
                      <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox  type="text" runat="server" ID="txtBeginYearCost" ClientIDMode="Static" class="form-control " placeholder="" required="required"></asp:TextBox>
                        </div>
                          <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblCostBasis" Text="<%$ Resources:GlobalResource,AssetBook_lblCostBasis %>"></asp:Label>
                            <asp:TextBox   type="text" runat="server" ID="txtCostBasis" ClientIDMode="Static" class="form-control " placeholder="" required="required"></asp:TextBox>
                        </div>
                         <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblScrapValue" Text="<%$ Resources:GlobalResource,AssetBook_lblScrapValue %>"></asp:Label>
                            <asp:TextBox   type="text" runat="server" ID="txtScrapValue" ClientIDMode="Static" class="form-control " placeholder="" required="required"></asp:TextBox>
                        </div>
                         <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox    type="text" runat="server" ID="txtYearlyDepreciationRate" ClientIDMode="Static" class="form-control " placeholder="" required="required"></asp:TextBox>
                        </div>
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox  type="text" runat="server" ID="txtCurrentDepreciation" ClientIDMode="Static" class="form-control " placeholder="" required="required"></asp:TextBox>
                        </div>
                          <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblNetBookValue" Text="<%$ Resources:GlobalResource,AssetBook_lblNetBookValue %>"></asp:Label>
                            <asp:TextBox   type="text" runat="server" ID="txtNetBookValue" ClientIDMode="Static" class="form-control " placeholder="" required="required"></asp:TextBox>
                         </div>
                         <div class="form-group col-md-4 col-sm-4">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblOriginalLifeYear" Text="<%$ Resources:GlobalResource, AssetBook_lblOriginalLifeYear %>"></asp:Label>
                             <asp:TextBox  type="text" runat="server" ID="txtOriginalLifeYear" ClientIDMode="Static" class="form-control " placeholder="" required="required"></asp:TextBox>
                        </div>
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblOriginalLifeDay" Text="<%$ Resources:GlobalResource, AssetBook_lblOriginalLifeDay %>"></asp:Label>
                             <asp:TextBox  type="text" runat="server" ID="txtOriginalLifeDay" ClientIDMode="Static" class="form-control " placeholder="" required="required"></asp:TextBox>
                        </div>
