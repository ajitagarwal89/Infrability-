<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="LocationList.aspx.cs" Inherits="Location_LocationList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    <script src="../infra_ui/js/Location_JS/LocationList.js"></script>
</asp:Content>
    ...
    <div id="content" class="ui-content ui-content-aside-overlay">
        ...
        <div class="ui-content-body">
            <div class="ui-container">
                <div class="row">
                    <h3 class="hepad">
                        <asp:Literal runat="server" ID="ltrSegment" Text="<%$ Resources:GlobalResource, Location_ltrLocations  %>">
                            ...
                            <ContentTemplate>
                                <asp:DataGrid runat="server" ClientIDMode="Static" Font-Size="10pt" ID="gvData" AutoGenerateColumns="false" Width="100%" GridLines="None" BorderStyle="None" CssClass="table table-hover">
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="tbl_LocationId" Visible="false"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, Location_htLocationCode%>" DataField="LocationCode"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, Location_htDescription%>" DataField="Description"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, Location_htCountryName%>" DataField="CountryName"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, Location_htCity%>" DataField="City"></asp:BoundColumn>
                                        <asp:TemplateColumn HeaderImageUrl="~/images/eye.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <button id="lnkView_<%# Container.DataSetIndex + 1 %>" type="button" data-toggle="modal" data-target="#basicModalSeg" data-keyboard="false" data-backdrop="static" class="btn btn-default btn-sm btn-block" onclick="setDetails('<%#Eval("LocationCode")%>','<%#Eval("Description")%>','<%#Eval("CountryName")%>','<%#Eval("City")%>','lnkview_<%# Container.DataSetIndex + 1 %>');">
                                                    <asp:Literal runat="server" ID="ltrView" Text="<%$ Resources:GlobalResource, ltrView%>"></asp:Literal></button>
                                                <button id="lnkViewNextPrev_<%# Container.DataSetIndex + 1 %>" style="display: none;" type="button" class="btn btn-default btn-sm" onclick="setDetails('<%#Eval("LocationCode")%>','<%#Eval("Description")%>','<%#Eval("CountryName")%>','<%#Eval("City")%>','lnkview_<%# Container.DataSetIndex + 1 %>');"></button>

                                            </ItemTemplate>
                                        </asp:TemplateColumn>
                                        <asp:TemplateColumn HeaderImageUrl="~/images/edit.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="gvColLnkBtn" class="btn btn-default btn-sm btn-block" OnClick="gvColLnkBtn_Click" CommandArgument='<%#Eval("tbl_LocationId") %>'>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><span>
                        <asp:Literal runat="server" ID="ltr_Location_Details" Text="<%$ Resources:GlobalResource, Location_ltrDetails %>"></asp:Literal></span></h4>
                </div>
                <div class="modal-body">
                    <table class="table table-striped" style="width: 100%; font-size: 9.5pt;">
                        <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrLocationCode" Text="<%$ Resources:GlobalResource, Location_ltrLocationCode%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrDescription" Text="<%$ Resources:GlobalResource, Location_ltrDescription%>"></asp:Literal></td>

                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrCountryName" Text="<%$ Resources:GlobalResource, Location_ltrCountryName%>"></asp:Literal></td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="lblLocationCode" runat="server" ClientIDMode="Static"></asp:Label></td>
                            <td>
                        ...
                        <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrCity" Text="<%$ Resources:GlobalResource, Location_ltrCity%>"></asp:Literal></td>
                            </tr>
                        <tr>
                            <td>
