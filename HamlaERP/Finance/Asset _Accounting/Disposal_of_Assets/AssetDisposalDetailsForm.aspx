                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox  type="text" runat="server" ID="txtCost" ClientIDMode="Static" class="form-control " placeholder="" required="required"></asp:TextBox>
                        </div>

                      <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblPercent" Text="<%$ Resources:GlobalResource,AssetDisposalDetails_lblPercent %>"></asp:Label>
                            <asp:TextBox   type="text" runat="server" ID="txtPercent" ClientIDMode="Static" class="form-control " placeholder="" required="required"></asp:TextBox>
                        </div>
                      <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblCashProceeds" Text="<%$ Resources:GlobalResource,AssetDisposalDetails_lblCashProceeds %>"></asp:Label>
                            <asp:TextBox   type="text" runat="server" ID="txtCashProceeds" ClientIDMode="Static" class="form-control " placeholder="" required="required"></asp:TextBox>
                        </div>
                          <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox    type="text" runat="server" ID="txtNonCashProceeds" ClientIDMode="Static" class="form-control " placeholder="" required="required"></asp:TextBox>
                        </div>
                         <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox   type="text" runat="server" ID="txtExpensesOfSales" ClientIDMode="Static" class="form-control " placeholder="" required="required"></asp:TextBox>
                        </div>
                         <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox   type="text" runat="server" ID="txtOriginatingAmount" ClientIDMode="Static" class="form-control " placeholder="" required="required"></asp:TextBox>
                        </div>
                        ...
                        <asp:UpdatePanel runat="server" ID="updpnlgvAssetDisposalSearch">
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvAssetDisposalSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                   ...
                                   <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, AssetDisposalDisposalDetails_htAsset %>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblgvAsset" runat="server" Text='<%# Bind("tbl_Asset") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, AssetDisposalDisposalDetails_htAssetDisposalGuid %>" Visible="false">
                                            <ItemTemplate>
