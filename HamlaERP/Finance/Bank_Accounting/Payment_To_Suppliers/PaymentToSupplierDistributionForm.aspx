            ...
            <div class="ui-container">
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                         ...
                         <div class="form-group col-md-4 col-sm-4" id="divCredit" runat="server" >
                            <asp:Label runat="server" ID="lblCredit" Text="<%$ Resources:GlobalResource,PaymentToSupplierDistribution_lblCredit %>"></asp:Label>
                 ...
                 <div class="form-group col-md-4 col-sm-4" id="divGLAccount" runat="server" >
                            <asp:Label runat="server" ID="lblGLAccount" Text="<%$ Resources:GlobalResource,PaymentToSupplierDistribution_GLAccountId %>"></asp:Label>
                 ...
                 <div class="form-group col-md-4 col-sm-4" id="divPayment" runat="server" >
                            <asp:Label runat="server" ID="lblPaymentNo" Text="<%$ Resources:GlobalResource,PaymentToSupplierDistribution_lblPayment %>"></asp:Label>
                 ...
                 <div class="form-group col-md-4 col-sm-4" id="divDocumenttype" runat="server" >
                            <asp:Label runat="server" ID="lblDocumenttype" Text="<%$ Resources:GlobalResource,PaymentToSupplierDistribution_lblDocumenttype %>"></asp:Label>
                 ...
                 <div class="form-group col-md-4 col-sm-4" id="divCurrencyID" runat="server" >
                            <asp:Label runat="server" ID="lblCurrencyId" Text="<%$ Resources:GlobalResource,PaymentToSupplierDistribution_lblCurrencyID %>"></asp:Label>
                 ...
                 <div class="form-group col-md-4 col-sm-4" id="divfunctionAmt" runat="server" >
                            <asp:Label runat="server" ID="lblfunctionalAmount" Text="<%$ Resources:GlobalResource,PaymentToSupplierDistribution_lblfunctionAmt %>"></asp:Label>
                 ...
                 <div class="form-group col-md-4 col-sm-4" id="divOriginatingAmount" runat="server" >
                            <asp:Label runat="server" ID="lblOriginatingAmount" Text="<%$ Resources:GlobalResource,PaymentToSupplierDistribution_lblOriginatingAmount %>"></asp:Label>
                 ...
                 <asp:DataGrid runat="server" ClientIDMode="Static" Font-Size="10pt" ID="gvData" AutoGenerateColumns="False" Width="100%" GridLines="None" CssClass="table table-hover" CellPadding="4" ForeColor="#333333">
                            ...
                            <Columns>
                                  ...
                                  <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, PaymentToSupplierDistribution_htPaymentNumber %>" DataField="tbl_PaymentToSupplier"></asp:BoundColumn>
                                  ...
                                  <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, PaymentToSupplierDistribution_htDistributionReference%>" DataField="DistributionReference"></asp:BoundColumn>
