...
public partial class Finance_Bank_Accounting_Payment_To_Supplier_PaymentToSupplierDistributionForm : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            else if (Request.QueryString["PaymentToSupplierDistributionId"] != null || Request.QueryString["recordId"] != null)
            {

                PaymentToSupplierDistributionFormUI.Tbl_PaymentToSupplierDistributionId = (Request.QueryString["PaymentToSupplierDistributionId"] != null ? Request.QueryString["PaymentToSupplierDistributionId"] : Request.QueryString["recordId"]);
                BindTypeDropDownList();
    ...
    {
        string Form = "~Finance/Bank_Accounting/Payment_To_Suppliers/PaymentToSupplierDistributionForm.aspx";
        string recordId = Request.QueryString["PaymentToSupplierDistributionId"];
