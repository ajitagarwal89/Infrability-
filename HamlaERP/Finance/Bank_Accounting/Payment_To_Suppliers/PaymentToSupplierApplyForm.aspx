                            ...
                            <div id="divdownPaymentfromCustomer" runat="server" class="form-group col-md-12 col-sm-12">
                                ...
                                <div>
                                    <div class="form-group col-md-4 col-sm-4">
                                        ...
                                        <asp:TextBox type="text" runat="server" ID="txtSupplierId" ReadOnly="true" ClientIDMode="Static" class="form-control" placeholder="" required="required"></asp:TextBox>
                                    </div>

                                    <div class="form-group col-md-4 col-sm-4">
                                        <asp:Label runat="server" ID="lblSupplierName" Text="<%$ Resources:GlobalResource, PaymentToSupplierApply_lblSupplierName%>"></asp:Label>
                                        <asp:TextBox type="text" runat="server" ID="txtSupplierName" ReadOnly="true" ClientIDMode="Static" class="form-control" placeholder="" required="required"></asp:TextBox>
                                    </div>
