                            ...
                            <ContentTemplate>
                                ...
                                <asp:DataGrid runat="server" ClientIDMode="Static" Font-Size="10pt" ID="gvData" AutoGenerateColumns="false" Width="100%" GridLines="None" BorderStyle="None" CssClass="table table-hover">
                                    <Columns>
                                        ...
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, PaymentToSupplier_htSupplier%>" DataField="SupplierName"></asp:BoundColumn>
                                        ...
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, PaymentToSupplier_htDocumentType%>" DataField="DocumentType" ></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, PaymentToSupplier_htTotal%>" DataField="Total"></asp:BoundColumn>
