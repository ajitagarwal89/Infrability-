                    ...
                    <div class="form-group col-md-4 col-sm-4">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                          ...
                          <div class="form-group col-md-4 col-sm-4">
                            ...
                            <div class="form-group col-md-12" style="background-color: #f6f6f6">
                                <h5>
                                    <asp:Literal runat="server" ID="ltrDownPaymentFromCustomer" Text="<%$ Resources:GlobalResource, PaymentFromCustomerApplyForm_lblPaymentFromCustomer%>"></asp:Literal></h5>
                            </div>
                            ...
                            <div id="divdownPaymentfromCustomer" runat="server" class="form-group col-md-12 col-sm-12">
                                ...
                                <div>
                                    <div class="form-group col-md-4 col-sm-4">
                                        <asp:Label runat="server" ID="lblCustomerId" Text="<%$ Resources:GlobalResource, PaymentFromCustomerApplyForm_lblCustomerId%>"></asp:Label>
                                    ...
                                    <div class="form-group col-md-4 col-sm-4">
                                        <asp:Label runat="server" ID="lblCustomerName" Text="<%$ Resources:GlobalResource, PaymentFromCustomerApplyForm_lblCustomerName%>"></asp:Label>
                                    ...
                                    <div class="form-group col-md-4 col-sm-4">
                                        <asp:Label runat="server" ID="lblType1" Text="<%$ Resources:GlobalResource, PaymentFromCustomerApplyForm_lblType%>"></asp:Label>
                                    ...
                                    <div class="form-group col-md-4 col-sm-4">
                                        <asp:Label runat="server" ID="lblCurrency" Text="<%$ Resources:GlobalResource, PaymentFromCustomerApplyForm_lblCurrency%>"></asp:Label>
                                    ...
                                    <div class="form-group col-md-4 col-sm-4">
                                        <asp:Label runat="server" ID="lblDocumentNo" Text="<%$ Resources:GlobalResource, PaymentFromCustomerApplyForm_lblDocumentNo%>"></asp:Label>
                                    ...
                                    <div class="form-group col-md-4 col-sm-4">
                                        <asp:Label runat="server" ID="lblOrignalAmount" Text="<%$ Resources:GlobalResource, PaymentFromCustomerApplyForm_lblOrignalAmount%>"></asp:Label>
                                    ...
                                    <div class="form-group col-md-4 col-sm-4">
                                        <asp:Label runat="server" ID="lblApplyDate" Text="<%$ Resources:GlobalResource, PaymentFromCustomerApplyForm_lblApplyDate%>"></asp:Label>
                                    ...
                                    <div class="form-group col-md-4 col-sm-4">
                                        <asp:Label runat="server" ID="lblUnappliedAmount" Text="<%$ Resources:GlobalResource, PaymentFromCustomerApplyForm_lblUnappliedAmount%>"></asp:Label>
