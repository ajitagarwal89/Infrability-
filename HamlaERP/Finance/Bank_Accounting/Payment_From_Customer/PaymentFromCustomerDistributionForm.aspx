<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="PaymentFromCustomerDistributionForm.aspx.cs" Inherits="Finance_Bank_Accounting_Customer_Receipts_PaymentFromCustomerDistributionForm" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
<script src="../../../infra_ui/js/Finance_JS/Bank_Accounting_JS/Payment_From_Customer/PaymentFromCustomerDistributionForm.js"></script>
</asp:Content>
        ...
        <div class="ui-content-body">
            <div class="ui-container">
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-12" style="background-color: #f6f6f6">
                            <h5>
                                <asp:Literal runat="server" ID="ltrPaymentFromCustomerDistribution" Text="<%$ Resources:GlobalResource, PaymentFromCustomerDistribution_ltrInformation%>"></asp:Literal></h5>
                        </div>
                       
                        <div class="form-group col-md-4 col-sm-4">
                            <div>
                                <asp:Label runat="server" ID="lblCustomerId" Text="<%$ Resources:GlobalResource, PaymentFromCustomerDistribution_lblCustomerId %>"></asp:Label>
                            </div>
                            <div class="input-group">
                                <asp:TextBox ID="txtCustomer" ReadOnly="true" ClientIDMode="Static" runat="server" AutoPostBack="true"  CssClass="form-control " OnTextChanged="txtCustomer_TextChanged"></asp:TextBox>
                                ...
                                <asp:TextBox ID="txtCustomerGuid" runat="server" ClientIDMode="Static" AutoPostBack="true" OnTextChanged="txtCustomer_TextChanged" Style="display: none;"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group col-md-4 col-sm-4">
                            <div>
                                <asp:Label runat="server" ID="lblGLAccountId" Text="<%$ Resources:GlobalResource, PaymentFromCustomerDistribution_lblGLAccountId%>"></asp:Label>
                            </div>
                            <div class="input-group">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblOptionType" Text="<%$ Resources:GlobalResource,PaymentFromCustomerDistribution_lblOptionType  %>"></asp:Label>
                         ...
                         <div class="form-group col-md-4 col-sm-4" id="divDebit" runat="server" >
                            <asp:Label runat="server" ID="lblDebit" Text="<%$ Resources:GlobalResource,PaymentFromCustomerDistribution_lblDebit  %>"></asp:Label>
                          ...
                          <div class="form-group col-md-4 col-sm-4" id="divOriginatingDebit" runat="server" >
                            <asp:Label runat="server" ID="lblOriginatingDebit" Text="<%$ Resources:GlobalResource,PaymentFromCustomerDistribution_lblOriginatingDebit %>"></asp:Label>
                         ...
                         <div class="form-group col-md-4 col-sm-4" id="divCredit" runat="server" >
                            <asp:Label runat="server" ID="lblCredit" Text="<%$ Resources:GlobalResource,PaymentFromCustomerDistribution_lblCredit %>"></asp:Label>
                        ...
                        <div class="form-group col-md-4 col-sm-4" id="divOriginatingCredit" runat="server" >
                            <asp:Label runat="server" ID="lblOriginatingCredit" Text="<%$ Resources:GlobalResource,PaymentFromCustomerDistribution_lblOriginatingCredit %>"></asp:Label>
                           <asp:TextBox ID="txtOriginatingCredit"  runat="server" ClientIDMode="Static" class="form-control" ></asp:TextBox>
                        </div>
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblDescription" Text="<%$ Resources:GlobalResource,PaymentFromCustomerDistribution_lblDescription%>"></asp:Label>
                         ...
                         <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblDistributionReference" Text="<%$ Resources:GlobalResource,PaymentFromCustomerDistribution_lblDistributionReference%>"></asp:Label>
                 ...
                 <div class="form-group col-md-12" style="background-color: #f6f6f6">
                            <h5>
                                <asp:Literal runat="server" ID="ltrCustomerDistribution" Text="<%$ Resources:GlobalResource, PaymentFromCustomerDistribution_ltrPaymentFromCustomerDetails%>"></asp:Literal></h5>
                        </div>
                <div class="form-group col-md-4 col-sm-4" id="divCustomerCode" runat="server" >
                            <asp:Label runat="server" ID="lblCustomerCode" Text="<%$ Resources:GlobalResource,PaymentFromCustomerDistribution_lblCustomerCode%>"></asp:Label>
                ...
                <div class="form-group col-md-4 col-sm-4" id="divCustomerName" runat="server" >
                            <asp:Label runat="server" ID="lblCustomerName" Text="<%$ Resources:GlobalResource,PaymentFromCustomerDistribution_lblCustomerName %>"></asp:Label>
                ...
                <div class="form-group col-md-4 col-sm-4" id="divReceiptnumber" runat="server" >
                            <asp:Label runat="server" ID="lblReceiptnumber" Text="<%$ Resources:GlobalResource, PaymentFromCustomerDistribution_lblReceiptNumber %>"></asp:Label>
                ...
                <div class="form-group col-md-4 col-sm-4" id="divDocumentNumber" runat="server" >
                    <asp:Label runat="server" ID="lblDocumentNumber" Text="<%$ Resources:GlobalResource, PaymentFromCustomerDistribution_lblDocumentNumber %>"></asp:Label>
                ...
                <div class="form-group col-md-4 col-sm-4" id="divDocumentType" runat="server" >
                            <asp:Label runat="server" ID="lblDocumentType" Text="<%$ Resources:GlobalResource, PaymentFromCustomerDistribution_lblDocumentType %>"></asp:Label>
                ...
                <div class="form-group col-md-4 col-sm-4" id="divCurrency" runat="server" >
                    <asp:Label runat="server" ID="lblCurrencyName" Text="<%$ Resources:GlobalResource, PaymentFromCustomerDistribution_lblCurrencyName %>"></asp:Label>
                ...
                <div class="form-group col-md-4 col-sm-4" id="divfunctionalAmount" runat="server" >
                    <asp:Label runat="server" ID="lblFunctionalAmount" Text="<%$ Resources:GlobalResource, PaymentFromCustomerDistribution_lblFunctionalAmount %>"></asp:Label>
                ...
                <div class="form-group col-md-4 col-sm-4" id="divOrginatingAmount" runat="server" >
                    <asp:Label runat="server" ID="lblOrginatingAmount" Text="<%$ Resources:GlobalResource,PaymentFromCustomerDistribution_lblOrginationAmount %>"></asp:Label>
             ...
             <asp:DataGrid runat="server" ClientIDMode="Static" Font-Size="10pt" ID="gvData" AutoGenerateColumns="False" Width="100%" GridLines="None" CssClass="table table-hover" CellPadding="4" ForeColor="#333333">
                            ...
                            <Columns>
                               ...
                               <%--   <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, PaymentFromCustomerDistribution_htReceiptNumber%>" DataField="ReceiptNumber"></asp:BoundColumn>--%>
                                  <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, PaymentFromCustomerDistribution_htAccount %>" DataField="tbl_GLAccount"></asp:BoundColumn>
                                 <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource,  PaymentFromCustomerDistribution_htType%>" DataField="Type"></asp:BoundColumn>
                               <%-- <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource,   PaymentFromCustomerDistribution_htApplyDate %>" DataField="ApplyDate"></asp:BoundColumn>--%>
                                  <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, PaymentFromCustomer_htDebit %>" DataField="Debit"></asp:BoundColumn>
                                  <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, PaymentFromCustomer_htOriginatingDebit %>" DataField="OriginatingDebit"></asp:BoundColumn>
                                  <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, PaymentFromCustomer_htCredit %>" DataField="Credit"></asp:BoundColumn>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="hdrModalCustomerTitle"><span>
                        <asp:Literal runat="server" ID="ltr_CustomerInfomation" Text="<%$ Resources:GlobalResource, PaymentFromCustomerDistribution_ltr_CustomerInfomation %>"></asp:Literal>
                    </span>
                    </h4>
                </div>
                        ...
                        <asp:UpdatePanel runat="server" ID="updpnlgvCustomerSearch">
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvCustomerSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, PaymentFromCustomerDistribution_htCustomerName%>">
                                            <ItemTemplate>
                                                <a href="#" data-dismiss="modal" onclick="SetCustomerDetails('<%#Eval("CustomerName")%>','<%#Eval("tbl_PaymentFromCustomerId")%>');">
                                                    <asp:Literal runat="server" ID="ltrgvCustomerCode" Text='<%# Bind("CustomerName") %>'></asp:Literal>
                                                </a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                                                           <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, PaymentFromCustomerDistribution_htCustomerGuid %>" Visible="false">
                                            <ItemTemplate>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="hdrModalGlAccountTitle"><span>
                        <asp:Literal runat="server" ID="ltrGLAccountTitle" Text="<%$ Resources:GlobalResource, PaymentFromCustomerDistribution_ltrGLAccountId%>"></asp:Literal>
                    </span>
                    </h4>
                </div>
                <div class="modal-body">
                        ...
                        <asp:UpdatePanel runat="server" ID="updpnlgvGLAccountSearch">
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvGLAccountSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    EmptyDataText="<%$ Resources:GlobalResource,msgNoRecordFound%>" AllowPaging="True" PageSize="10" ClientIDMode="Static">
                                    <Columns>
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,PaymentFromCustomerDistribution_htAccountNumber%>">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, PaymentFromCustomerDistribution_htGLAccountGuid %>" Visible="false">
                                            <ItemTemplate>
