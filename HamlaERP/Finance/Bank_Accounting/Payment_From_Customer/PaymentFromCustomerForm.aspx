                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-12" style="background-color: #f6f6f6">
						 ...
						 <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox runat="server" ID="txtReceiptNumber" ClientIDMode="Static" class="form-control" placeholder="" required="required" onkeypress="return isAddress(this);" MaxLength="20"  autofocus="autofocus"></asp:TextBox>
                        </div>
						<asp:UpdatePanel ID="uplReceiptDate" runat="server" >
							<ContentTemplate>
								  <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblReceiptDate" Text="<%$ Resources:GlobalResource, PaymentFromCustomer_lblReceiptDate%>"></asp:Label>
                            <asp:TextBox runat="server" ID="txtReceiptDate"  ClientIDMode="Static" class="form-control" placeholder="" AutoPostBack="true"  required="required" OnTextChanged="txtReceiptDate_TextChanged" ></asp:TextBox>
                        </div>
							</ContentTemplate>
						</asp:UpdatePanel>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                             ...
                             <asp:TextBox runat="server" ID="txtDocumentNumber"  ClientIDMode="Static" class="form-control" placeholder="" onkeypress="return isAddress(this);" MaxLength="20" required="required" ></asp:TextBox>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <div>
                                <asp:Label runat="server" ID="lblPaymentFromCustomerSourceDocument" Text="<%$ Resources:GlobalResource, PaymentFromCustomer_lblSourceDocument%>"></asp:Label>
                            </div>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                             ...
                             <asp:TextBox runat="server" ID="txtPostingDate"  ClientIDMode="Static" TextMode="Date" class="form-control" placeholder="" required="required" ></asp:TextBox>
                        </div>

                        <div class="form-group col-md-4 col-sm-4">
                             <asp:Label runat="server" ID="lblApplyDate"  Text="<%$ Resources:GlobalResource, PaymentFromCustomer_lblApplyDate%>"></asp:Label>
                             <asp:TextBox runat="server" ID="txtApplyDate"  ClientIDMode="Static" TextMode="Date" class="form-control" placeholder="" required="required" ></asp:TextBox>
                        </div>
                        ...
                        <asp:UpdatePanel runat="server" ID="upCash">
                            <ContentTemplate>
						...
						<div class="form-group col-md-4 col-sm-4">
						  ...
						  <div class="form-group col-md-4 col-sm-4">
                             ...
                             <asp:TextBox runat="server" ID="txtComments"  ClientIDMode="Static" TextMode="MultiLine" class="form-control" placeholder="" onkeypress="return isAddress(this);" maxlength="200"  required="required" ></asp:TextBox>
                        </div>
