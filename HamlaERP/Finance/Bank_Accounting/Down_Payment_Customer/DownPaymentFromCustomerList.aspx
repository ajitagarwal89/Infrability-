<%@ Page Title="" Language="C#"MasterPageFile="~/Site.master"   AutoEventWireup="true" CodeFile="DownPaymentFromCustomerList.aspx.cs" Inherits="Finance_Bank_Accounting_Customer_Down_Payment_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    <script src="../../../infra_ui/js/Finance_JS/Bank_Accounting_JS/Customer_Down_Payment_JS/DownPaymentFromCustomerList.js"></script>
</asp:Content>
    ...
    <div id="content" class="ui-content ui-content-aside-overlay">
        ...
        <div class="ui-content-body">
            <div class="ui-container">
                <div class="row">
                    <h3 class="hepad">
                        <asp:Literal runat="server" ID="ltrSearch" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_ltrDownPaymentFromCustomer %>"></asp:Literal></h3>
                            ...
                            <ContentTemplate>
                                ...
                                <asp:DataGrid runat="server" ClientIDMode="Static" Font-Size="10pt" ID="gvData" AutoGenerateColumns="false" Width="100%" GridLines="None" BorderStyle="None" CssClass="table table-hover">
                                    <Columns>
                                        ...
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, DownPaymentFromCustomer_htReceiptNumber%>" DataField="ReceiptNumber"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, DownPaymentFromCustomer_htBatchName%>" DataField="BatchName"></asp:BoundColumn> 
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, DownPaymentFromCustomer_htCustomer%>" DataField="tbl_Customer"></asp:BoundColumn>                         
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, DownPaymentFromCustomer_htCurrency%>" DataField="CurrencyName"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, DownPaymentFromCustomer_htPayableType%>" DataField="PayablesType"></asp:BoundColumn>

                                        <asp:TemplateColumn HeaderImageUrl="~/images/eye.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <button id="lnkView_<%# Container.DataSetIndex + 1 %>" type="button" data-toggle="modal" data-target="#basicModalSearch" data-keyboard="false" data-backdrop="static" class="btn btn-default btn-sm btn-block" onclick="setDetails('<%#Eval("ReceiptNumber")%>','<%#Eval("BatchName")%>','<%#Eval("tbl_Customer")%>','<%#Eval("CurrencyName")%>','<%#Eval("PaymentNumberCash")%>','<%#Eval("CashAmount")%>','<%#Eval("PaymentNumberCheque")%>','<%#Eval("ChequeAmount")%>','<%#Eval("PaymentNumberCard")%>','<%#Eval("CreditCardAmount")%>','<%#Eval("DocumentNumber")%>','<%#Eval("Comments")%>','lnkview_<%# Container.DataSetIndex + 1 %>');">
                                                    <asp:Literal runat="server" ID="ltrView" Text="<%$ Resources:GlobalResource, ltrView%>"></asp:Literal></button>
                                                <button id="lnkViewNextPrev_<%# Container.DataSetIndex + 1 %>" style="display: none;" type="button" class="btn btn-default btn-sm" onclick="setDetails('<%#Eval("ReceiptNumber")%>','<%#Eval("BatchName")%>','<%#Eval("tbl_Customer")%>','<%#Eval("CurrencyName")%>','<%#Eval("PaymentNumberCash")%>','<%#Eval("CashAmount")%>','<%#Eval("PaymentNumberCheque")%>','<%#Eval("ChequeAmount")%>','<%#Eval("PaymentNumberCard")%>','<%#Eval("CreditCardAmount")%>','<%#Eval("DocumentNumber")%>','<%#Eval("Comments")%>','lnkview_<%# Container.DataSetIndex + 1 %>');">
                                            </ItemTemplate>
                                        </asp:TemplateColumn>

                                        <asp:TemplateColumn HeaderImageUrl="~/images/edit.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="gvColLnkBtn" class="btn btn-default btn-sm btn-block" OnClick="gvColLnkBtn_Click" CommandArgument='<%#Eval("tbl_DownPaymentFromCustomerId") %>'>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><span>
                        <asp:Literal runat="server" ID="ltrRecordDetails" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_ltrDownPaymentFromCustomerDetails %>"></asp:Literal></span></h4>
                </div>
                <div class="modal-body">
                    <table class="table table-striped" style="width: 100%; font-size: 9.5pt;">
                        <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrReceiptNumber" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_ltrReceiptNumber%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrBatchId" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_ltrBatchId%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrCustomer" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_ltrCustomerName%>"></asp:Literal></td>                           
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                             ...
                             <td>
                                <asp:Label ID="lblCustomerId" runat="server" ClientIDMode="Static"></asp:Label></td>
                          
                        </tr>
                       <tr>   
                        
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrCurrencyId" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_ltrCurrencyId%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrPayablesCash" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_ltrPayablesCash%>"></asp:Literal></td>
                           <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrCashAmount" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_ltrCashAmount%>"></asp:Literal></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrPayablesCheque" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_ltrPayablesCheque%>"></asp:Literal></td>
                            
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrChequeAmount" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_ltrChequeAmount%>"></asp:Literal></td>
                            
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrPayablesCreditCard" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_ltrPayablesCreditCard%>"></asp:Literal></td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                             <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrCreditCardAmount" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_ltrCreditCardAmount%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrDocumentNumber" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_ltrDocumentNumber%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrComments" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_ltrComments%>"></asp:Literal></td>                   
