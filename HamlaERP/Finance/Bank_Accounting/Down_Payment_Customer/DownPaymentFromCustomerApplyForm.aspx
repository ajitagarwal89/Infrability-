                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-12" style="background-color: #f6f6f6">
                            <h5>
                                <asp:Literal runat="server" ID="ltrDownPaymentFromCustomerApply" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomerApply_ltrInformation%>"></asp:Literal></h5>
                        </div>
                        ...
                        <div class="form-group col-md-12 col-sm-12">
                            <div class="form-group col-md-4 col-sm-4">
                                ...
                                <div>
                                    <asp:Label runat="server" ID="lblDownPaymentFromCustomer" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomerApply_lblDownPaymentFromCustomer%>"></asp:Label>
                                </div>
                            ...
                            <div id="divCustomerInvoice" visible="false" runat="server" class="form-group col-md-4 col-sm-4">
                                <div>
                                    <asp:Label runat="server" ID="lblApplyToDocument" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomerApply_lblApplyToDocument%>"></asp:Label>
                                </div>
                           ...
                           <div id="divCustomerInvoiceProcess" visible="false" runat="server" class="form-group col-md-4 col-sm-4">
                                <div>
                                    <asp:Label runat="server" ID="lblApplytoDocumentCIP" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomerApply_lblApplytoDocument%>"></asp:Label>
                                </div>
                            ...
                            <div class="form-group col-md-4 col-sm-4">
                                <asp:Label runat="server" ID="lblDueDate" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomerApply_lblDueDate%>"></asp:Label>
                            ...
                            <div class="form-group col-md-4 col-sm-4">
                                <asp:Label runat="server" ID="lblRemainingAmount" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomerApply_lblRemainingAmount%>"></asp:Label>
                            ...
                            <div class="form-group col-md-4 col-sm-4">
                                <asp:Label runat="server" ID="lblApplyAmount" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomerApply_lblApplyAmount%>"></asp:Label>
                            ...
                            <div class="form-group col-md-4 col-sm-4">
                                <asp:Label runat="server" ID="lblType" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomerApply_lblType%>"></asp:Label>
                                <asp:DropDownList ID="ddloptType" runat="server" ClientIDMode="Static" class="form-control" placeholder="" required="required">
                                </asp:DropDownList>
                            </div>

                            <div class="form-group col-md-4 col-sm-4">
                                <asp:Label runat="server" ID="lblOrignalDocumentAmount" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomerApply_lblOrignalDocumentAmount%>"></asp:Label>
                            ...
                            <div class="form-group col-md-4 col-sm-4">
                                <asp:Label runat="server" ID="lblDiscountDate" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomerApply_lblDiscountDate%>"></asp:Label>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div>
                                    <asp:Label runat="server" ID="lblCurrencyId" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomerApply_lblCurrencyId %>"></asp:Label>
                                </div>
                                <div class="input-group">
                            ...
                            <div class="form-group col-md-12" style="background-color: #f6f6f6">
                                <h5>
                                    <asp:Literal runat="server" ID="ltrDownPaymentFromCustomer" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomerApply_lblDownPaymentFromCustomer%>"></asp:Literal></h5>
                            </div>
                            ...
                            <div id="divdownPaymentfromCustomer" runat="server" class="form-group col-md-12 col-sm-12">
                                ...
                                <div>
                                    <div class="form-group col-md-4 col-sm-4">
                                        <asp:Label runat="server" ID="lblCustomerId" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomerApply_lblCustomerId%>"></asp:Label>
                                    ...
                                    <div class="form-group col-md-4 col-sm-4">
                                        <asp:Label runat="server" ID="lblCustomerName" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomerApply_lblCustomerName%>"></asp:Label>
                                    ...
                                    <div class="form-group col-md-4 col-sm-4">
                                        <asp:Label runat="server" ID="lblType1" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomerApply_lblType%>"></asp:Label>
                                    ...
                                    <div class="form-group col-md-4 col-sm-4">
                                        <asp:Label runat="server" ID="lblCurrency" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomerApply_lblCurrency%>"></asp:Label>
                                    ...
                                    <div class="form-group col-md-4 col-sm-4">
                                        <asp:Label runat="server" ID="lblDocumentNo" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomerApply_lblDocumentNo%>"></asp:Label>
                                    ...
                                    <div class="form-group col-md-4 col-sm-4">
                                        <asp:Label runat="server" ID="lblOrignalAmount" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomerApply_lblOrignalAmount%>"></asp:Label>
                                    ...
                                    <div class="form-group col-md-4 col-sm-4">
                                        <asp:Label runat="server" ID="lblApplyDate" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomerApply_lblApplyDate%>"></asp:Label>
                                    ...
                                    <div class="form-group col-md-4 col-sm-4">
                                        <asp:Label runat="server" ID="lblUnappliedAmount" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomerApply_lblUnappliedAmount%>"></asp:Label>
                ...
                <div class="modal-content">
                    <div class="modal-header" style="text-align: left;">
                        ...
                        <h4 class="modal-title" id="hdrModalDownPaymentCustTitle"><span>
                            <asp:Literal runat="server" ID="ltr_DownPaymentFromCust_information1" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomerApply_ltrInformation %>"></asp:Literal>
                        </span>
                        </h4>
                    </div>
                            ...
                            <asp:UpdatePanel runat="server" ID="updpnlgvDownPaymentCustSearch">
                                <ContentTemplate>
                                    ...
                                    <asp:GridView ID="gvDownPaymentCustSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, DownPaymentFromCustomerApply_htCashAmount%>">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, DownPaymentFromCustomerApply_htReceiptNumber%>">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, DownPaymentFromCustomerApply_htDownPaymentFromCustomerGuid%>" Visible="false">
                                                <ItemTemplate>
                ...
                <div class="modal-content">
                    <div class="modal-header" style="text-align: left;">
                        ...
                        <h4 class="modal-title" id="hdrModalCurrencyTitle"><span>
                            <asp:Literal runat="server" ID="ltrCurrencyTitle" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomerApply_ltrCurrency%>"></asp:Literal>
                        </span>
                        </h4>
                    </div>
                    <div class="modal-body">
                            ...
                            <asp:UpdatePanel runat="server" ID="updpnlgvCurrencySearch">
                                <ContentTemplate>
                                    ...
                                    <asp:GridView ID="gvCurrencySearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                        EmptyDataText="<%$ Resources:GlobalResource,msgNoRecordFound%>" AllowPaging="True" PageSize="10" ClientIDMode="Static">
                                        <Columns>
                                            <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, DownPaymentFromCustomerApply_htCurrencyCode%>">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,DownPaymentFromCustomerApply_htCurrencyCode_htCurrencyName%>">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblgvCurrencyName" runat="server" Text='<%# Bind("CurrencyName") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,DownPaymentFromCustomerApply_htCurrencyGuid%>" Visible="false">
                                                <ItemTemplate>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="hdrModalCustomerInvoiceTitle"><span>
                        <asp:Literal runat="server" ID="ltrCustomerInvoiceTitle" Text="<%$ Resources:GlobalResource,DownPaymentFromCustomerApply_ltrCustomerInvoiceTitle %>"></asp:Literal>
                    </span>
                    </h4>
                </div>
                <div class="modal-body">
                        ...
                        <asp:UpdatePanel runat="server" ID="updpnlgvCustomerInvoiceSearch">
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvCustomerInvoiceSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    EmptyDataText="<%$ Resources:GlobalResource,msgNoRecordFound%>" AllowPaging="True" PageSize="10" ClientIDMode="Static">
                                    <Columns>
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,DownPaymentFromCustomerApply_htCustomerPONumber%>">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,DownPaymentFromCustomerApply_htCustomerInvoiceGuid%>" Visible="false">
                                            <ItemTemplate>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="hdrModalCustomerInvoiceProcessTitle"><span>
                        <asp:Literal runat="server" ID="ltrCustomerInvoiceProcessTitle" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomerApply_ltrCustomerInvoiceProcessTitle %>"></asp:Literal>
                    </span>
                    </h4>
                </div>
                <div class="modal-body">
                            ...
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvCustomerInvoiceProcessSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,DownPaymentFromCustomerApply_htCustomerInvoiceProcessGuid%>" Visible="false">
                                            <ItemTemplate>
