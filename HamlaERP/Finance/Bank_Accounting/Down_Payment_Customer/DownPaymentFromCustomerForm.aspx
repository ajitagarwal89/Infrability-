                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                          ...
                          <div class="form-group col-md-4 col-sm-4">
                             <asp:Label runat="server" ID="lblIsPosted"  Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_lblIsPosted%>"></asp:Label>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                             <asp:Label runat="server" ID="lblPostingDate"  Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_lblPostingDate%>"></asp:Label>
