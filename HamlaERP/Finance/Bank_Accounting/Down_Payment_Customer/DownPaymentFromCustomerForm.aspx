<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="DownPaymentFromCustomerForm.aspx.cs" Inherits="Finance_Bank_Accounting_Customer_Down_Payment_DownPaymentFromCustomerForm" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
	<script src="../../../infra_ui/js/CommonJS/CommonValidations.js"></script>   
	<script src="../../../infra_ui/js/Finance_JS/Bank_Accounting_JS/Customer_Down_Payment_JS/DownPaymentFromCustomerForm.js"></script>
</asp:Content>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-12" style="background-color: #f6f6f6">
                            <h5>
                                <asp:Literal runat="server" ID="ltrDownPaymentFromCustomer" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_ltrInformation%>"></asp:Literal></h5>
                        </div>
						 <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblReceiptNumber" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_lblReceiptNumber%>"></asp:Label>
                            <asp:TextBox runat="server" ID="txtReceiptNumber" ClientIDMode="Static"  class="form-control" placeholder=""  onkeypress="return isAlphaNumberKey(this);" maxlength="30" required="required" autofocus="autofocus"></asp:TextBox>
                        </div>

                       <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblReceiptDate" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_lblReceiptDate%>"></asp:Label>
                            <asp:TextBox runat="server" ID="txtReceiptDate" TextMode="Date" ClientIDMode="Static" class="form-control" placeholder="" required="required"></asp:TextBox>
                        </div>
                       <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblDocumentType" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_lblDocumentType%>"></asp:Label>
                       ...
                       <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblDocumentNumber" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_lblDocumentNumber%>"></asp:Label>
                            <asp:TextBox runat="server" ID="txtDocumentNumber" ReadOnly="true" ClientIDMode="Static" class="form-control" placeholder=""  onkeypress="return isAlphaNumberKey(this);" maxlength="30" 
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <div>
                                <asp:Label runat="server" ID="lblBatchId" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_lblBatchId %>"></asp:Label>
                            </div>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <div>
                                <asp:Label runat="server" ID="lblCustomerId" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_lblCustomerId %>"></asp:Label>
                            </div>
                            <div class="input-group">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <div>
                                <asp:Label runat="server" ID="lblDownPaymentFromCustomer" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_SourceDocument%>"></asp:Label>
                            </div>
                        ...
                        <div class="col-md-4 col-sm-4">
                            <div>
                                <asp:Label runat="server" ID="lblCurrencyId" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_lblCurrencyId %>"></asp:Label>
                            </div>
                            <div class="input-group">
						...
						<asp:UpdatePanel ID="uplApplyDate" runat="server" >
							<ContentTemplate>
							<div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblApplyDate" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_lblApplyDate%>"></asp:Label>
                            <asp:TextBox runat="server" ID="txtApplyDate" TextMode="Date" ClientIDMode="Static" AutoPostBack="true"  class="form-control" placeholder="" required="required" OnTextChanged="txtApplyDate_TextChanged"></asp:TextBox>
                        </div>
							</ContentTemplate>
						</asp:UpdatePanel>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:Label runat="server" ID="lblPayablesType" Text="<%$ Resources:GlobalResource, EmployeeGeneralExpenses_lblPayablesType%>"></asp:Label>
                            <asp:UpdatePanel ID="upPayablesType" runat="server">
                                <ContentTemplate>
                                    <asp:DropDownList ID="ddlOpt_PayablesType" runat="server" class="form-control " placeholder="" required="required" AutoPostBack="true" OnLoad="ddlOpt_PayablesType_Load">
                                    </asp:DropDownList>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        ...
                        <div class="col-md-4 col-sm-4">
                            <div>
                                <asp:Label runat="server" ID="lblPayablesCash" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_lblPayablesCash%>"></asp:Label>
                            </div>
                            <div class="input-group">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblCashAmount" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_lblCashAmount%>"></asp:Label>
                            <asp:TextBox runat="server" ID="txtCashAmount" ClientIDMode="Static" class="form-control" onkeypress="return isNumberKeyPoint(this);" maxlength="9" placeholder="" required="required"></asp:TextBox>
                        </div>
                            </div>
                        </ContentTemplate>
                        </asp:UpdatePanel>
                        ...
                        <div class="col-md-4 col-sm-4">
                            <div>
                                <asp:Label runat="server" ID="lblPayablesCheque" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_lblPayablesCheque%>"></asp:Label>
                            </div>
                            <div class="input-group">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblChequeAmount" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_lblChequeAmount%>"></asp:Label>
                            <asp:TextBox runat="server" ID="txtChequeAmount" ClientIDMode="Static" class="form-control" placeholder="" onkeypress="return isNumberKeyPoint(this);" maxlength="9" required="required"></asp:TextBox>
                        </div>
                                              </div>
                    </ContentTemplate>
                            </asp:UpdatePanel>
                        ...
                        <div class="col-md-4 col-sm-4">
                            <div>
                                <asp:Label runat="server" ID="lblPayablesCreditCard" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_lblPayablesCreditCard%>"></asp:Label>
                            </div>
                            <div class="input-group">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblCreditCardAmount" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_lblCreditCardAmount%>"></asp:Label>
                            <asp:TextBox runat="server" ID="txtCreditCardAmount" ClientIDMode="Static" class="form-control" onkeypress="return isNumberKeyPoint(this);" maxlength="9" placeholder="" required="required"></asp:TextBox>
                        </div>
                                    </div>
                                  </ContentTemplate>
                        </asp:UpdatePanel>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblIsAutoApplyTo" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_lblIsAutoApplyTo%>"></asp:Label>
						  ...
						  <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblTotalAmount" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_lblTotalAmount%>"></asp:Label>
                            <asp:TextBox runat="server" ID="txtTotalAmount" ClientIDMode="Static" class="form-control" onkeypress="return isNumberKeyPoint(this);" maxlength="9" placeholder="" required="required"></asp:TextBox>
                        </div>

						
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblComments" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_lblComments%>"></asp:Label>
                            <asp:TextBox runat="server" TextMode="MultiLine" ID="txtComments" ClientIDMode="Static" class="form-control" placeholder="" required="required"></asp:TextBox>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="hdrModalBatchTitle"><span>
                        <asp:Literal runat="server" ID="ltr_Batch_information1" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_ltrinformation %>"></asp:Literal>
                    </span>
                    </h4>
                </div>
                        ...
                        <asp:UpdatePanel runat="server" ID="updpnlgvBatchSearch">
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvBatchSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,DownPaymentFromCustomer_htBatchType%>">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, DownPaymentFromCustomer_htBatchName%>">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, DownPaymentFromCustomer_htBatchGuid%>" Visible="false">
                                            <ItemTemplate>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="hdrModalCustomerTitle"><span>
                        <asp:Literal runat="server" ID="ltr_CustomerInfomation" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_ltrCustomerInfomation %>"></asp:Literal>
                    </span>
                    </h4>
                </div>
                <div class="modal-body">
                    ...
                    <div>
                        ...
                        <asp:UpdatePanel runat="server" ID="updpnlgvCustomerSearch">
                            <ContentTemplate>
                                <asp:Button runat="server" ID="btnCustomerRefresh" ClientIDMode="Static" OnClick="btnCustomerRefresh_Click" Style="display: none;" formnovalidate />
                                <asp:GridView ID="gvCustomerSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    EmptyDataText="<%$ Resources:GlobalResource,msgNoRecordFound%>" AllowPaging="True" PageSize="10" ClientIDMode="Static">
                                    <Columns>
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, DownPaymentFromCustomer_CustomerName%>">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,DownPaymentFromCustomer_CustomerCode%>">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, DownPaymentFromCustomer_htCustomerGuid %>" Visible="false">
                                            <ItemTemplate>
                        ...
                        <asp:UpdatePanel runat="server" ID="updpnlgvCurrencySearch">
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvCurrencySearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    EmptyDataText="<%$ Resources:GlobalResource,msgNoRecordFound%>" AllowPaging="True" PageSize="10" ClientIDMode="Static">
                                    <Columns>
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, DownPaymentFromCustomer_htCurrencyCode%>">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,DownPaymentFromCustomer_htCurrencyName%>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblgvCurrencyName" runat="server" Text='<%# Bind("CurrencyName") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,DownPaymentFromCustomer_htCurrencyGuid%>" Visible="false">
                                            <ItemTemplate>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="hdrModalPayablesCashTitle"><span>
                        <asp:Literal runat="server" ID="ltrPayablesCashTitle" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_ltrPayablesCashTitle %>"></asp:Literal>
                    </span>
                    </h4>
                </div>
                <div class="modal-body">
                        ...
                        <asp:UpdatePanel runat="server" ID="updpnlgvPayablesCashSearch">
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvPayablesCashSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    EmptyDataText="<%$ Resources:GlobalResource,msgNoRecordFound%>" AllowPaging="True" PageSize="10" ClientIDMode="Static">
                                    <Columns>
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, DownPaymentFromCustomer_htPaymentNumber%>">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, DownPaymentFromCustomer_htPayablesType%>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblgvCashPayablesType" runat="server" Text='<%# Bind("PayablesType") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, DownPaymentFromCustomer_htProcessType%>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblgvPayablesCashProcessType" runat="server" Text='<%# Bind("ProcessType") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, DownPaymentFromCustomer_htPayablesCashGuid%>" Visible="false">
                                            <ItemTemplate>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="hdrModalPayablesChequeTitle"><span>
                        <asp:Literal runat="server" ID="ltrPayablesChequeTitle" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_htPayablesChequeTitle %>"></asp:Literal>
                    </span>
                    </h4>
                </div>
                <div class="modal-body">
                        ...
                        <asp:UpdatePanel runat="server" ID="updpnlgvPayablesChequeSearch">
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvPayablesChequeSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    EmptyDataText="<%$ Resources:GlobalResource,msgNoRecordFound%>" AllowPaging="True" PageSize="10" ClientIDMode="Static">
                                    <Columns>
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, DownPaymentFromCustomer_htChequeNumber%>">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,  DownPaymentFromCustomer_htPayablesGuid  %>" Visible="false">
                                            <ItemTemplate>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="hdrModalPayablesCreditCardTitle"><span>
                        <asp:Literal runat="server" ID="ltrPayablesCreditCardTitle" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_htpayablesCreditCard %>"></asp:Literal>
                    </span>
                    </h4>
                </div>
                <div class="modal-body">
                        ...
                        <asp:UpdatePanel runat="server" ID="updpnlgvPayablesCreditCardSearch">
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvPayablesCreditCardSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    EmptyDataText="<%$ Resources:GlobalResource,msgNoRecordFound%>" AllowPaging="True" PageSize="10" ClientIDMode="Static">
                                    <Columns>
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, DownPaymentFromCustomer_htCreditCardName%>">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, DownPaymentFromCustomer_htPayablesCreditCardGuid%>" Visible="false">
                                            <ItemTemplate>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="hdrModalSourceDocumentTitle"><span>
                        <asp:Literal runat="server" ID="ltrSourceDocument_information1" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomer_ltrInformation %>"></asp:Literal>
                    </span>
                    </h4>
                </div>
                <div class="modal-body">
                        ...
                        <asp:UpdatePanel runat="server" ID="updpnlgvSourceDocumentSearch">
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvSourceDocumentSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    EmptyDataText="<%$ Resources:GlobalResource,msgNoRecordFound%>" AllowPaging="True" PageSize="10" ClientIDMode="Static">
                                    <Columns>
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, DownPaymentFromCustomer_htDescription%>">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, DownPaymentFromCustomer_htDocumentNumber%>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblgvDocumentNumber" runat="server" Text='<%# Bind("DocumentNumber") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, DownPaymentFromCustomer_htSourceDocumentGuid%>" Visible="false">
                                            <ItemTemplate>
