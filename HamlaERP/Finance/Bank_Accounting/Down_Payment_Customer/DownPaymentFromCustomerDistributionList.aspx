<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="DownPaymentFromCustomerDistributionList.aspx.cs" Inherits="Finance_Bank_Accounting_Customer_Down_Payment_DownPaymentFromCustomerDistributionList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    <script src="../../../infra_ui/js/Finance_JS/Bank_Accounting_JS/Customer_Down_Payment_JS/DownPaymentFromCustomerDistributionList.js"></script>
</asp:Content>
                                ...
                                <asp:DataGrid runat="server" ClientIDMode="Static" Font-Size="10pt" ID="gvData" AutoGenerateColumns="false" Width="100%" GridLines="None" BorderStyle="None" CssClass="table table-hover">
                                    <Columns>
                                        <asp:TemplateColumn>
                                         ...
                                         <asp:BoundColumn DataField="tbl_DownPaymentFromCustomerDistributionId" Visible="false"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, DownPaymentFromCustomerDistribution_htCustomer%>" DataField="tbl_Customer"></asp:BoundColumn>
                                        ...
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, DownPaymentFromCustomerDistribution_htType%>" DataField="Type"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, DownPaymentFromCustomerDistribution_htDebit%>" DataField="Debit"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, DownPaymentFromCustomerDistribution_htOriginatingDebit%>" DataField="OriginatingDebit"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, DownPaymentFromCustomerDistribution_htCredit%>" DataField="Credit"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, DownPaymentFromCustomerDistribution_htOriginatingCredit%>" DataField="OriginatingCredit"></asp:BoundColumn>
                                        ...
                                        <asp:TemplateColumn HeaderImageUrl="~/images/edit.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="gvColLnkBtn" class="btn btn-default btn-sm btn-block" OnClick="gvColLnkBtn_Click" CommandArgument='<%#Eval("tbl_DownPaymentFromCustomerDistributionId") %>'>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><span>
                        <asp:Literal runat="server" ID="ltrRecordDetails" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomerDistribution_ltrDetails %>"></asp:Literal></span></h4>
                </div>
                <div class="modal-body">
                      <table class="table table-striped" style="width: 100%; font-size: 9.5pt;">
                        <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrCustomer" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomerDistribution_ltrCustomer %>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrGLAccount" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomerDistribution_ltrGLAccount %>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrType" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomerDistribution_ltrType %>"></asp:Literal></td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrOriginatingDebit" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomerDistribution_ltrOriginatingDebit%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrCredit" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomerDistribution_ltrCredit %>"></asp:Literal></td>
                        ...
                        <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrOriginatingCredit" Text="<%$ Resources:GlobalResource, DownPaymentFromCustomerDistribution_ltrOriginatingCredit %>"></asp:Literal></td>
                            <td class="auto-style1">
