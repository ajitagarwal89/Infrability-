...
public partial class Finance_Bank_Accounting_Customer_Down_Payment_DownPaymentFromCustomerForm : System.Web.UI.Page
{
    #region Data Members
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                downPaymentFromCustomerFormUI.IsPosted = true;
            }
            else
            {
                downPaymentFromCustomerFormUI.IsPosted = false;
            }
            downPaymentFromCustomerFormUI.PostingDate = Convert.ToDateTime(txtPostingDate.Text);
