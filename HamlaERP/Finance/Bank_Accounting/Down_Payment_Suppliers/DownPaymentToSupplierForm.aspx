                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox runat="server" ID="txtPaymentNumber" ClientIDMode="Static"  class="form-control"  onkeypress="return isAlphaNumberKey(this);" maxlength="30"  placeholder="" required="required"></asp:TextBox>
                        </div>
                        ...
                        <asp:TextBox runat="server" ID="txtDocumentNumber" ReadOnly="true" ClientIDMode="Static"  class="form-control" placeholder=""  onkeypress="return isAlphaNumberKey(this);" maxlength="30"  required="required"></asp:TextBox>
                    </div>
                    ...
                    <div class="form-group col-md-4 col-sm-4">
                        ...
                        <asp:TextBox runat="server" ID="txtUnapplied"  ClientIDMode="Static" class="form-control" onkeypress="return isNumberKeyPoint(this);" maxlength="9"   placeholder="" required="required"></asp:TextBox>
                    </div>
 
                    <div class="form-group col-md-4 col-sm-4">

                        <asp:Label runat="server" ID="lblApplied" Text="<%$ Resources:GlobalResource, DownPaymentToSupplier_lblApplied%>"></asp:Label>
                        <asp:TextBox runat="server" ID="txtApplied"  ClientIDMode="Static" class="form-control" onkeypress="return isNumberKeyPoint(this);" maxlength="9"   placeholder="" required="required"></asp:TextBox>
                    </div>
                        ...
                        <asp:TextBox runat="server" ID="txtComments" TextMode="MultiLine" ClientIDMode="Static" class="form-control" onkeypress="return function isAddress(evt) {
(this);" maxlength="100"   placeholder="" required="required"></asp:TextBox>
                    </div>
