<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="DownPaymentToSupplierApplyList.aspx.cs" Inherits="Finance_Bank_Accounting_Down_Payment_Suppliers_DownPaymentToSupplierApplyList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    <script src="../../../infra_ui/js/Finance_JS/Bank_Accounting_JS/Down_Payment_Suppliers_JS/DownPaymentToSupplierApplyList.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="PageContent" Runat="Server">
     <div id="content" class="ui-content ui-content-aside-overlay">
        ...
        <div class="ui-content-body">
            <div class="ui-container">
                <div class="row">
                    <h3 class="hepad">
                        <asp:Literal runat="server" ID="ltrSearch" Text="<%$ Resources:GlobalResource, DownPaymentToSupplierApply_ltrDownPaymentToSupplierApplys %>"></asp:Literal></h3>
                            ...
                            <ContentTemplate>
                                ...
                                <asp:DataGrid runat="server" ClientIDMode="Static" Font-Size="10pt" ID="gvData" AutoGenerateColumns="false" Width="100%" GridLines="None" BorderStyle="None" CssClass="table table-hover">
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="tbl_DownPaymentToSupplier" Visible="false"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="tbl_ApplyToDocument" Visible="false"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="DueDate" Visible="false"></asp:BoundColumn>
                                        ...
                                        <asp:TemplateColumn HeaderImageUrl="~/images/edit.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="gvColLnkBtn" class="btn btn-default btn-sm btn-block" OnClick="gvColLnkBtn_Click" CommandArgument='<%#Eval("tbl_DownPaymentToSupplierApplyId") %>'>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><span>
                        <asp:Literal runat="server" ID="ltrDetails" Text="<%$ Resources:GlobalResource, DownPaymentToSupplierApply_ltrDetails %>"></asp:Literal></span></h4>
                </div>
                <div class="modal-body">
                   <table class="table table-striped" style="width: 100%; font-size: 9.5pt;">
                        <tr>
                             <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrDownPaymentToSupplier" Text="<%$ Resources:GlobalResource, DownPaymentToSupplierApply_ltrDownPaymentToSupplier%>"></asp:Literal></td>

                               
                                <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrDueDate" Text="<%$ Resources:GlobalResource, DownPaymentToSupplierApply_ltrDueDate%>"></asp:Literal></td>
                      
                                 <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrRemainingAmount" Text="<%$ Resources:GlobalResource, DownPaymentToSupplierApply_ltrRemainingAmount%>"></asp:Literal></td>
                        </tr>
                       
                        <tr>
                          <td>
                                <asp:Label ID="lblDownPaymentToSupplier" runat="server" ClientIDMode="Static"></asp:Label></td>
                              <td>
                          ...
                          <tr>
                            ...
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrApplyAmount" Text="<%$ Resources:GlobalResource, DownPaymentToSupplierApply_ltrApplyAmount%>"></asp:Literal></td>
                          
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrType" Text="<%$ Resources:GlobalResource, DownPaymentToSupplierApply_ltrType%>"></asp:Literal></td>
                        
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrOrignalDocumentAmount" Text="<%$ Resources:GlobalResource, DownPaymentToSupplierApply_ltrOrignalDocumentAmount%>"></asp:Literal></td>
 ...
 <td>
                           ...
                           <tr>
                           <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrDiscountDate" Text="<%$ Resources:GlobalResource, DownPaymentToSupplierApply_ltrDiscountDate%>"></asp:Literal></td>
                                <%--      <td class="auto-style1">
                                <asp:Literal runat="server" ID="Literal1" Text="<%$ Resources:GlobalResource, DownPaymentToSupplierApply_ltrApplyToDocument%>"></asp:Literal></td>    
                     --%>
