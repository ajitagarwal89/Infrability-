<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="PaymentToSupplierEmployeeApplyList.aspx.cs" Inherits="Finance_Bank_Accounting_Payment_To_Employees_PaymentToSupplierEmployeeApplyList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    <script src="../../../infra_ui/js/Finance_JS/Bank_Accounting_JS/Payment_To_SupplierEmployee_JS/PaymentToSupplierEmployeeApplyList.js"></script>    
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="PageContent" Runat="Server">
     ...
     <div id="content" class="ui-content ui-content-aside-overlay">
        ...
        <div class="ui-content-body">
            <div class="ui-container">
                <div class="row">
                    <h3 class="hepad">
                        <asp:Literal runat="server" ID="ltrSearch" Text="<%$ Resources:GlobalResource, PaymentToSupplierEmployeeApply_ltrPaymentToSupplierEmployeeApplys %>"></asp:Literal></h3>
                            ...
                            <ContentTemplate>
                                ...
                                <asp:DataGrid runat="server" ClientIDMode="Static" Font-Size="10pt" ID="gvData" AutoGenerateColumns="false" Width="100%" GridLines="None" BorderStyle="None" CssClass="table table-hover">
                                    <Columns>
                                        ...
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, PaymentToSupplierEmployeeApply_htPaymentToSupplierEmployee%>" DataField="tbl_SupplierEmployee"></asp:BoundColumn>
                                        ...
                                        <asp:TemplateColumn HeaderImageUrl="~/images/eye.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <button id="lnkView_<%# Container.DataSetIndex + 1 %>" type="button" data-toggle="modal" data-target="#divBasicModal" data-keyboard="false" data-backdrop="static" class="btn btn-default btn-sm btn-block" onclick="SetDetails('<%#Eval("tbl_SupplierEmployee")%>','<%#Eval("tbl_ApplyToDocument")%>','<%#Eval("DueDate")%>','<%#Eval("RemainingAmount")%>','<%#Eval("ApplyAmount")%>','<%#Eval("Type")%>','<%#Eval("OrignalDocumentAmount")%>','<%#Eval("DiscountDate")%>','lnkview_<%# Container.DataSetIndex + 1 %>');">
                                                    <asp:Literal runat="server" ID="ltrView" Text="<%$ Resources:GlobalResource, ltrView%>"></asp:Literal></button>
                                                <button id="lnkViewNextPrev_<%# Container.DataSetIndex + 1 %>" style="display: none;" type="button" class="btn btn-default btn-sm" onclick="SetDetails('<%#Eval("tbl_SupplierEmployee")%>','<%#Eval("tbl_ApplyToDocument")%>','<%#Eval("DueDate")%>','<%#Eval("RemainingAmount")%>','<%#Eval("ApplyAmount")%>','<%#Eval("Type")%>','<%#Eval("OrignalDocumentAmount")%>','<%#Eval("DiscountDate")%>','lnkview_<%# Container.DataSetIndex + 1 %>');"></button>
                                                </ItemTemplate>
                                        ...
                                        <asp:TemplateColumn HeaderImageUrl="~/images/edit.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="gvColLnkBtn" class="btn btn-default btn-sm btn-block" OnClick="gvColLnkBtn_Click" CommandArgument='<%#Eval("tbl_PaymentToSupplierEmployeeApplyId") %>'>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><span>
                        <asp:Literal runat="server" ID="ltrDetails" Text="<%$ Resources:GlobalResource, PaymentToSupplierEmployeeApply_ltrDetails %>"></asp:Literal></span></h4>
                </div>
                <div class="modal-body">
                   <table class="table table-striped" style="width: 100%; font-size: 9.5pt;">
                        <tr>
                             <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrPaymentToSupplierEmployee" Text="<%$ Resources:GlobalResource, PaymentToSupplierEmployeeApply_ltrPaymentToSupplierEmployee%>"></asp:Literal></td>
                              
                                <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrDueDate" Text="<%$ Resources:GlobalResource, PaymentToSupplierEmployeeApply_ltrDueDate%>"></asp:Literal></td>
                      
                                 <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrRemainingAmount" Text="<%$ Resources:GlobalResource, PaymentToSupplierEmployeeApply_ltrRemainingAmount%>"></asp:Literal></td>
                        </tr>
                       
                        <tr>
                          <td>
                                <asp:Label ID="lblPaymentToSupplierEmployee" runat="server" ClientIDMode="Static"></asp:Label></td>
                              <td>
                          ...
                          <tr>
                            ...
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrApplyAmount" Text="<%$ Resources:GlobalResource, PaymentToSupplierEmployeeApply_ltrApplyAmount%>"></asp:Literal></td>
                          
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrType" Text="<%$ Resources:GlobalResource, PaymentToSupplierEmployeeApply_ltrType%>"></asp:Literal></td>
                        
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrOrignalDocumentAmount" Text="<%$ Resources:GlobalResource, PaymentToSupplierEmployeeApply_ltrOrignalDocumentAmount%>"></asp:Literal></td>
 ...
 <td>
                           ...
                           <tr>
                           <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrDiscountDate" Text="<%$ Resources:GlobalResource, PaymentToSupplierEmployeeApply_ltrDiscountDate%>"></asp:Literal></td>
                                  <%--<td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrApplyToDocument" Text="<%$ Resources:GlobalResource, PaymentToSupplierEmployeeApply_ltrApplyToDocument%>"></asp:Literal></td>    --%>
