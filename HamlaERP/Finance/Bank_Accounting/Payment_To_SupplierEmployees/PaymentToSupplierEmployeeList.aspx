<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="PaymentToSupplierEmployeeList.aspx.cs" Inherits="Finance_Bank_Accounting_Payment_To_Employees_PaymentToSupplierEmployeeList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">

    <script src="../../../infra_ui/js/Finance_JS/Bank_Accounting_JS/Payment_To_Employee_JS/PaymentToSupplierEmployeeList.js"></script>
</asp:Content>
  ...
  <div id="content" class="ui-content ui-content-aside-overlay">
        ...
        <div class="ui-content-body">
            <div class="ui-container">
                <div class="row">
                    <h3 class="hepad">
                        <asp:Literal runat="server" ID="ltrSearch" Text="<%$ Resources:GlobalResource, PaymentToSupplierEmployee_ltrPaymentToSupplierEmployee %>"></asp:Literal></h3>
                            ...
                            <ContentTemplate>
                                ...
                                <asp:DataGrid runat="server" ClientIDMode="Static" Font-Size="10pt" ID="gvData" AutoGenerateColumns="false" Width="100%" GridLines="None" BorderStyle="None" CssClass="table table-hover">
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="tbl_PaymentToSupplierEmployeeId" Visible="false"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, PaymentToSupplierEmployee_htPaymentNumber%>" DataField="PaymentNumber"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, PaymentToSupplierEmployee_htPaymentDate%>" DataField="PaymentDate"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, PaymentToSupplierEmployee_htBatchName%>" DataField="BatchName"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, PaymentToSupplierEmployee_htCurrencyName%>" DataField="CurrencyName"></asp:BoundColumn>
                                        ...
                                        <asp:BoundColumn DataField="IsAutoAppliyTo" Visible="false"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="ApplyDate" Visible="false"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="PostingDate" Visible="false"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="tbl_SourceDocument" Visible="false"></asp:BoundColumn>
                                        ...
                                        <asp:TemplateColumn HeaderImageUrl="~/images/eye.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <button id="lnkView_<%# Container.DataSetIndex + 1 %>" type="button" data-toggle="modal" data-target="#divBasicModal" data-keyboard="false" data-backdrop="static" class="btn btn-default btn-sm btn-block" onclick="SetDetails('<%#Eval("PaymentNumber")%>','<%#Eval("PaymentDate")%>','<%#Eval("BatchName")%>','<%#Eval("SupplierEmployeeName")%>','<%#Eval("CurrencyName")%>','<%#Eval("BankName")%>','<%#Eval("BankTransferAmount")%>','<%#Eval("PayablesTypeCash")%>','<%#Eval("CashAmount")%>','<%#Eval("PayablesTypeCheque")%>','<%#Eval("ChequeAmount")%>','<%#Eval("CardName")%>','<%#Eval("CreditCardAmount")%>','<%#Eval("Unapplied")%>','<%#Eval("Applied")%>','<%#Eval("Total")%>','lnkview_<%# Container.DataSetIndex + 1 %>');">
                                                    <asp:Literal runat="server" ID="ltrView" Text="<%$ Resources:GlobalResource, ltrView%>"></asp:Literal></button>
                                                <button id="lnkViewNextPrev_<%# Container.DataSetIndex + 1 %>" style="display: none;" type="button" class="btn btn-default btn-sm" onclick="SetDetails('<%#Eval("PaymentNumber")%>','<%#Eval("PaymentDate")%>','<%#Eval("BatchName")%>','<%#Eval("SupplierEmployeeName")%>','<%#Eval("CurrencyName")%>','<%#Eval("BankName")%>','<%#Eval("BankTransferAmount")%>','<%#Eval("PayablesTypeCash")%>','<%#Eval("CashAmount")%>','<%#Eval("PayablesTypeCheque")%>','<%#Eval("ChequeAmount")%>','<%#Eval("CardName")%>','<%#Eval("CreditCardAmount")%>','<%#Eval("Unapplied")%>','<%#Eval("Applied")%>','<%#Eval("Total")%>','lnkview_<%# Container.DataSetIndex + 1 %>');"></button>
                                                </ItemTemplate>
                                        ...
                                        <asp:TemplateColumn HeaderImageUrl="~/images/edit.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="gvColLnkBtn" class="btn btn-default btn-sm btn-block" OnClick="gvColLnkBtn_Click" CommandArgument='<%#Eval("tbl_PaymentToSupplierEmployeeId") %>'>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><span>
                        <asp:Literal runat="server" ID="ltrDetails" Text="<%$ Resources:GlobalResource, PaymentToSupplierEmployee_ltrDetails %>"></asp:Literal></span></h4>
                </div>
                <div class="modal-body">
                    <table class="table table-striped" style="width: 100%; font-size: 9.5pt;">
                        <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrPaymentNumber" Text="<%$ Resources:GlobalResource, PaymentToSupplierEmployee_ltrPaymentNumber%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrPaymentDate" Text="<%$ Resources:GlobalResource, PaymentToSupplierEmployee_ltrPaymentDate%>"></asp:Literal></td>

                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrBatchName" Text="<%$ Resources:GlobalResource, PaymentToSupplierEmployee_ltrBatchName%>"></asp:Literal></td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrEmployeeName" Text="<%$ Resources:GlobalResource, PaymentToSupplierEmployee_ltrEmployeeName%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrCurrencyName" Text="<%$ Resources:GlobalResource, PaymentToSupplierEmployee_ltrCurrencyName%>"></asp:Literal></td>
                          
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrBankName" Text="<%$ Resources:GlobalResource, PaymentToSupplierEmployee_ltrBankName%>"></asp:Literal></td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="lblEmployeeName" runat="server" ClientIDMode="Static"></asp:Label></td>
                             <td>
                           ...
                           <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrBankTransferAmount" Text="<%$ Resources:GlobalResource, PaymentToSupplierEmployee_ltrBankTransferAmount%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrPayablesTypeCash" Text="<%$ Resources:GlobalResource, PaymentToSupplierEmployee_ltrPayablesTypeCash%>"></asp:Literal></td>
                          
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrCashAmount" Text="<%$ Resources:GlobalResource, PaymentToSupplierEmployee_ltrCashAmount%>"></asp:Literal></td>
                        </tr>
                        <tr>
                            <td>
                           ...
                           <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrPayablesTypeCheque" Text="<%$ Resources:GlobalResource, PaymentToSupplierEmployee_ltrPayablesTypeCheque%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrChequeAmount" Text="<%$ Resources:GlobalResource, PaymentToSupplierEmployee_ltrChequeAmount%>"></asp:Literal></td>
                          
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrCardName" Text="<%$ Resources:GlobalResource, PaymentToSupplierEmployee_ltrCardName%>"></asp:Literal></td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrCreditCardAmount" Text="<%$ Resources:GlobalResource, PaymentToSupplierEmployee_ltrCreditCardAmount%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrUnaplied" Text="<%$ Resources:GlobalResource, PaymentToSupplierEmployee_ltrUnapplied%>"></asp:Literal></td>
                          
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrApplied" Text="<%$ Resources:GlobalResource, PaymentToSupplierEmployee_ltrApplied%>"></asp:Literal></td>
                        </tr>
                        <tr>
                            <td>
                           ...
                           <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrTotal" Text="<%$ Resources:GlobalResource, PaymentToSupplierEmployee_ltrTotal%>"></asp:Literal></td>
                           </tr>
                        <tr>
                            <td>
