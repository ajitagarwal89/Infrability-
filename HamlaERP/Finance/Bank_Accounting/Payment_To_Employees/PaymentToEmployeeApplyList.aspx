<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="PaymentToEmployeeApplyList.aspx.cs" Inherits="Finance_Bank_Accounting_Payment_To_Employees_PaymentToEmployeeApplyList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    <script src="../../../infra_ui/js/Finance_JS/Bank_Accounting_JS/Payment_To_Employee_JS/PaymentToEmployeeApplyList.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="PageContent" Runat="Server">
     ...
     <div id="content" class="ui-content ui-content-aside-overlay">
        ...
        <div class="ui-content-body">
            <div class="ui-container">
                <div class="row">
                    <h3 class="hepad">
                        <asp:Literal runat="server" ID="ltrSearch" Text="<%$ Resources:GlobalResource, PaymentToEmployeeApply_ltrPaymentToEmployeeApplys %>"></asp:Literal></h3>
                                ...
                                <asp:DataGrid runat="server" ClientIDMode="Static" Font-Size="10pt" ID="gvData" AutoGenerateColumns="false" Width="100%" GridLines="None" BorderStyle="None" CssClass="table table-hover">
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderImageUrl="~/images/edit.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="gvColLnkBtn" class="btn btn-default btn-sm btn-block" OnClick="gvColLnkBtn_Click" CommandArgument='<%#Eval("tbl_PaymentToEmployeeApplyId") %>'>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><span>
                        <asp:Literal runat="server" ID="ltrDetails" Text="<%$ Resources:GlobalResource, PaymentToEmployeeApply_ltrDetails %>"></asp:Literal></span></h4>
                </div>
                <div class="modal-body">
                   <table class="table table-striped" style="width: 100%; font-size: 9.5pt;">
                        <tr>
                             <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrPaymentToEmployee" Text="<%$ Resources:GlobalResource, PaymentToEmployeeApply_ltrPaymentToEmployee%>"></asp:Literal></td>
                              
                                <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrDueDate" Text="<%$ Resources:GlobalResource, PaymentToEmployeeApply_ltrDueDate%>"></asp:Literal></td>
                      
                                 <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrRemainingAmount" Text="<%$ Resources:GlobalResource, PaymentToEmployeeApply_ltrRemainingAmount%>"></asp:Literal></td>
                        </tr>
                       
                        <tr>
                          <td>
                                <asp:Label ID="lblPaymentToEmployee" runat="server" ClientIDMode="Static"></asp:Label></td>
                              <td>
                          ...
                          <tr>
                            ...
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrApplyAmount" Text="<%$ Resources:GlobalResource, PaymentToEmployeeApply_ltrApplyAmount%>"></asp:Literal></td>
                          
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrType" Text="<%$ Resources:GlobalResource, PaymentToEmployeeApply_ltrType%>"></asp:Literal></td>
                        
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrOrignalDocumentAmount" Text="<%$ Resources:GlobalResource, PaymentToEmployeeApply_ltrOrignalDocumentAmount%>"></asp:Literal></td>
 ...
 <td>
                           ...
                           <tr>
                           <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrDiscountDate" Text="<%$ Resources:GlobalResource, PaymentToEmployeeApply_ltrDiscountDate%>"></asp:Literal></td>
                                  <%--<td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrApplyToDocument" Text="<%$ Resources:GlobalResource, PaymentToEmployeeApply_ltrApplyToDocument%>"></asp:Literal></td>    --%>
