<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="PaymentToEmployeeForm.aspx.cs" Inherits="Finance_Bank_Accounting_Payment_To_Employee_PaymentToEmployeeForm" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
	<script src="../../../infra_ui/js/Finance_JS/Bank_Accounting_JS/Payment_To_Employee_JS/PaymentToEmployeeForm.js"></script>
				...
				<div class="row">
					...
					<div class="col-md-12 col-sm-12 colformstyle">
						...
						<div class="form-group col-md-12" style="background-color: #f6f6f6">
							<h5>
								<asp:Literal runat="server" ID="ltrInformation" Text="<%$ Resources:GlobalResource, PaymentToEmployee_ltrInformation%>"></asp:Literal></h5>
						</div>
						<div class="form-group col-md-4 col-sm-4">
							<asp:Label runat="server" ID="lblPaymentNumber" Text="<%$ Resources:GlobalResource, PaymentToEmployee_lblPaymentNumber%>"></asp:Label>
							<asp:TextBox runat="server" ID="txtPaymentNumber" ClientIDMode="Static" ReadOnly="true" class="form-control" placeholder=""  onkeypress="return isAlphaNumberKey(this);" maxlength="9" required="required"></asp:TextBox>
						</div>

						<div class="form-group col-md-4 col-sm-4">
							<asp:Label runat="server" ID="lbOpt_DocumentType" Text="<%$ Resources:GlobalResource, PaymentToEmployee_lblOpt_DocumentType %>"></asp:Label>
						...
						<div class="form-group col-md-4 col-sm-4">
							<asp:Label runat="server" ID="lblPaymentDate" Text="<%$ Resources:GlobalResource, PaymentToEmployee_lblPaymentDate%>"></asp:Label>
							<asp:TextBox runat="server" ID="txtPaymentDate" TextMode="Date" ClientIDMode="Static" class="form-control" placeholder="" required="required"></asp:TextBox>
						</div>
						<div class="form-group col-md-4 col-sm-4">

							<div>
								<asp:Label runat="server" ID="lblBatch" Text="<%$ Resources:GlobalResource,PaymentToEmployee_lblBatchId %>"></asp:Label>
							</div>
						...
						<div class="form-group col-md-4 col-sm-4">
							...
							<div>
								<asp:Label runat="server" ID="lblEmployee" Text="<%$ Resources:GlobalResource, PaymentToEmployee_lblEmployeeId %>"></asp:Label>
							</div>
						...
						<div class="form-group col-md-4 col-sm-4">
							...
							<div>
								<asp:Label runat="server" ID="lblSourceDocumentId" Text="<%$ Resources:GlobalResource, PaymentToEmployee_lblSourceDocumentId %>"></asp:Label>
							</div>
						...
						<div class="form-group col-md-4 col-sm-4">
							<div>
								<asp:Label runat="server" ID="lblCurrencyId" Text="<%$ Resources:GlobalResource,PaymentToEmployee_lblCurrencyId %>"></asp:Label>
							</div>
							<div class="input-group">
							...
							<ContentTemplate>
								<div id="divBank" runat="server">
									<div class="form-group col-md-4 col-sm-4">
										...
										<div>
											<asp:Label runat="server" ID="lblPayablesId_BankTransfer" Text="<%$ Resources:GlobalResource, PaymentToEmployee_lblPayablesId_BankTransfer %>"></asp:Label>
										</div>
									...
									<div class="form-group col-md-4 col-sm-4">
										<asp:Label runat="server" ID="lblBankTransferAmount" Text="<%$ Resources:GlobalResource, PaymentToEmployee_lblBankTransferAmount%>"></asp:Label>
										<asp:TextBox runat="server" ID="txtBankTransferAmount" ClientIDMode="Static" class="form-control" placeholder="" onkeypress="return isNumberKeyPoint(this);" maxlength="9" required="required"></asp:TextBox>
									</div>
								</div>
							</ContentTemplate>
						</asp:UpdatePanel>
							...
							<ContentTemplate>
								<div id="divCash" runat="server">
									<div class="form-group col-md-4 col-sm-4">
										...
										<div>
											<asp:Label runat="server" ID="lblPayablesId_Cash" Text="<%$ Resources:GlobalResource, PaymentToEmployee_lblPayablesId_Cash %>"></asp:Label>
										</div>
									...
									<div class="form-group col-md-4 col-sm-4">
										...
										<asp:Label runat="server" ID="lblCashAmount" Text="<%$ Resources:GlobalResource,  PaymentToEmployee_lblCashAmount%>"></asp:Label>
										<asp:TextBox runat="server" ID="txtCashAmount" ClientIDMode="Static" class="form-control" placeholder="" onkeypress="return isNumberKeyPoint(this);" maxlength="9" required="required"></asp:TextBox>
									</div>
								</div>
							</ContentTemplate>
						</asp:UpdatePanel>
							...
							<ContentTemplate>
								<div id="divCheque" runat="server">
									<div class="form-group col-md-4 col-sm-4">
										...
										<div>
											<asp:Label runat="server" ID="lblPayablesId_Cheque" Text="<%$ Resources:GlobalResource, PaymentToEmployee_lblPayablesId_Cheque  %>"></asp:Label>
										</div>
									...
									<div class="form-group col-md-4 col-sm-4">
										...
										<asp:Label runat="server" ID="lblChequeAmount" Text="<%$ Resources:GlobalResource, PaymentToEmployee_lblChequeAmount%>"></asp:Label>
							...
							<ContentTemplate>
								<div id="divCreditCard" runat="server">
									<div class="form-group col-md-4 col-sm-4">
										...
										<div>
											<asp:Label runat="server" ID="lblPayablesId_CreditCard" Text="<%$ Resources:GlobalResource, PaymentToEmployee_lblPayablesId_CreditCard %>"></asp:Label>
										</div>
									...
									<div class="form-group col-md-4 col-sm-4">
										<asp:Label runat="server" ID="lblCreditCardAmount" Text="<%$ Resources:GlobalResource, PaymentToEmployee_lblCreditCardAmount%>"></asp:Label>
						...
						<div class="form-group col-md-4 col-sm-4">
							<asp:Label runat="server" ID="lblIsAutoApplyTo" Text="<%$ Resources:GlobalResource, PaymentToEmployee_lblIsAutoApplyTo%>"></asp:Label>

							<asp:CheckBox ID="chkIsAutoApplyTo" runat="server" ClientIDMode="Static" class="form-control" placeholder="" required="required" />
						</div>
						...
						<div class="form-group col-md-4 col-sm-4">
							...
							<asp:Label runat="server" ID="lblApplyDate" Text="<%$ Resources:GlobalResource, PaymentToEmployee_lblApplyDate%>"></asp:Label>
						...
						<div class="form-group col-md-4 col-sm-4">
							...
							<asp:Label runat="server" ID="lblUnapplied" Text="<%$ Resources:GlobalResource, PaymentToEmployee_lblUnapplied%>"></asp:Label>
						...
						<div class="form-group col-md-4 col-sm-4">
							...
							<asp:Label runat="server" ID="lblApplied" Text="<%$ Resources:GlobalResource, PaymentToEmployee_lblApplied%>"></asp:Label>
						...
						<div class="form-group col-md-4 col-sm-4">
							...
							<asp:Label runat="server" ID="lblTotal" Text="<%$ Resources:GlobalResource, PaymentToEmployee_lblTotal%>"></asp:Label>
			...
			<div class="modal-content">
				<div class="modal-header" style="text-align: left;">
					...
					<h4 class="modal-title" id="hdrModalBatchTitle"><span>
						<asp:Literal runat="server" ID="ltrBatchTitle" Text="<%$ Resources:GlobalResource, PaymentToEmployee_ltrBatchTitle %>"></asp:Literal>
					</span>
					</h4>
				</div>
						...
						<asp:UpdatePanel runat="server" ID="updpnlgvBatchSearch">
							<ContentTemplate>
								...
								<asp:GridView ID="gvBatchSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
									...
									<Columns>
										<asp:TemplateField HeaderText="<%$ Resources:GlobalResource, PaymentToEmployee_htBatchType%>">
											<ItemTemplate>
										...
										<asp:TemplateField HeaderText="<%$ Resources:GlobalResource, PaymentToEmployee_htBatchName%>">
											<ItemTemplate>
												<asp:Label ID="lblgvBatchName" runat="server" Text='<%# Bind("BatchName") %>'></asp:Label>
											</ItemTemplate>
										</asp:TemplateField>
										<asp:TemplateField HeaderText="<%$ Resources:GlobalResource, PaymentToEmployee_htBatchGuid%>" Visible="false">
											<ItemTemplate>
			...
			<div class="modal-content">
				<div class="modal-header" style="text-align: left;">
					...
					<h4 class="modal-title" id="hdrModalSupplierTitle"><span>
						<asp:Literal runat="server" ID="ltrEmployeeTitle" Text="<%$ Resources:GlobalResource, PaymentToEmployee_ltrEmployeeTitle %>"></asp:Literal>
					</span>
					</h4>
				</div>
				<div class="modal-body">
						...
						<asp:UpdatePanel runat="server" ID="updpnlgvEmployeeSearch">
							<ContentTemplate>
								...
								<asp:GridView ID="gvEmployeeSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
									EmptyDataText="<%$ Resources:GlobalResource,msgNoRecordFound%>" AllowPaging="True" PageSize="10" ClientIDMode="Static">
									<Columns>
										<asp:TemplateField HeaderText="<%$ Resources:GlobalResource, PaymentToEmployee_htEmployeeCode%>">
											<ItemTemplate>
										...
										<asp:TemplateField HeaderText="<%$ Resources:GlobalResource, PaymentToEmployee_htEmployeeName%>">
											<ItemTemplate>
												<asp:Label ID="lblgvEmployeeName" runat="server" Text='<%# Bind("EmployeeName") %>'></asp:Label>
											</ItemTemplate>
										</asp:TemplateField>
										<asp:TemplateField HeaderText="<%$ Resources:GlobalResource, PaymentToEmployee_htEmployeeGuid%>" Visible="false">
											<ItemTemplate>
			...
			<div class="modal-content">
				<div class="modal-header" style="text-align: left;">
					...
					<h4 class="modal-title" id="hdrModalCurrencyTitle"><span>
						<asp:Literal runat="server" ID="ltrCurrencyTitle" Text="<%$ Resources:GlobalResource, PaymentToEmployee_ltrCurrencyInformation %>"></asp:Literal>
					</span>
					</h4>
				</div>
				<div class="modal-body">
							...
							<ContentTemplate>
								...
								<asp:GridView ID="gvCurrencySearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
									...
									<Columns>
										...
										<asp:TemplateField HeaderText="<%$ Resources:GlobalResource,PaymentToEmployee_htCurrencyCode%>">
											<ItemTemplate>
										...
										<asp:TemplateField HeaderText="<%$ Resources:GlobalResource, PaymentToEmployee_htCurrencyName%>">
											<ItemTemplate>
												<asp:Label ID="lblgvCurrencyName" runat="server" Text='<%# Bind("CurrencyName") %>'></asp:Label>
											</ItemTemplate>
										</asp:TemplateField>

										<asp:TemplateField HeaderText="<%$ Resources:GlobalResource, PaymentToEmployee_htCurrencyGuid%>" Visible="false">
											<ItemTemplate>
			...
			<div class="modal-content">
				<div class="modal-header" style="text-align: left;">
					...
					<h4 class="modal-title" id="hdrModalPayablesBankTitle"><span>
						<asp:Literal runat="server" ID="ltrPayablesBankTitle" Text="<%$ Resources:GlobalResource, PaymentToEmployee_ltrPayablesBankTitle %>"></asp:Literal>
					</span>
					</h4>
				</div>
				<div class="modal-body">
						...
						<asp:UpdatePanel runat="server" ID="updpnlgvPayablesBankSearch">
							<ContentTemplate>
								...
								<asp:GridView ID="gvPayablesBankSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
									EmptyDataText="<%$ Resources:GlobalResource,msgNoRecordFound%>" AllowPaging="True" PageSize="10" ClientIDMode="Static">
									<Columns>
										<asp:TemplateField HeaderText="<%$ Resources:GlobalResource, PaymentToEmployee_htPayablesBankName%>">
											<ItemTemplate>
										...
										<asp:TemplateField HeaderText="<%$ Resources:GlobalResource, PaymentToEmployee_htPaymentNumber%>">
											<ItemTemplate>
										...
										<asp:TemplateField HeaderText="<%$ Resources:GlobalResource, PaymentToEmployee_htPayablesBankGuid%>" Visible="false">
											<ItemTemplate>
			...
			<div class="modal-content">
				<div class="modal-header" style="text-align: left;">
					...
					<h4 class="modal-title" id="hdrModalPayablesCashTitle"><span>
						<asp:Literal runat="server" ID="ltrPayablesCashTitle" Text="<%$ Resources:GlobalResource,  PaymentToEmployee_ltrPayablesCashTitle %>"></asp:Literal>
					</span>
					</h4>
				</div>
				<div class="modal-body">
						...
						<asp:UpdatePanel runat="server" ID="updpnlgvPayablesCashSearch">
							<ContentTemplate>
								...
								<asp:GridView ID="gvPayablesCashSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
									EmptyDataText="<%$ Resources:GlobalResource,msgNoRecordFound%>" AllowPaging="True" PageSize="10" ClientIDMode="Static">
									<Columns>
										<asp:TemplateField HeaderText="<%$ Resources:GlobalResource,PaymentToEmployee_htPayablesType %>">
											<ItemTemplate>
										...
										<asp:TemplateField HeaderText="<%$ Resources:GlobalResource,PaymentToEmployee_htProcessType%>">
											<ItemTemplate>
												<asp:Label ID="lblgvPayablesCashProcessType" runat="server" Text='<%# Bind("ProcessType") %>'></asp:Label>
											</ItemTemplate>
										</asp:TemplateField>
										<asp:TemplateField HeaderText="<%$ Resources:GlobalResource, PaymentToEmployee_htPayablesCashGuid%>" Visible="false">
											<ItemTemplate>
			...
			<div class="modal-content">
				<div class="modal-header" style="text-align: left;">
					...
					<h4 class="modal-title" id="hdrModalPayablesChequeTitle"><span>
						<asp:Literal runat="server" ID="ltrPayablesChequeTitle" Text="<%$ Resources:GlobalResource, PaymentToEmployee_htPayablesChequeTitle %>"></asp:Literal>
					</span>
					</h4>
				</div>
				<div class="modal-body">
							...
							<ContentTemplate>
								...
								<asp:GridView ID="gvPayablesChequeSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
									...
									<Columns>
										...
										<asp:TemplateField HeaderText="<%$ Resources:GlobalResource,PaymentToEmployee_htChequeNumber %>">
											<ItemTemplate>
										...
										<asp:TemplateField HeaderText="<%$ Resources:GlobalResource, PaymentToEmployee_htPayablesChequeGuid%>" Visible="false">
											<ItemTemplate>
			...
			<div class="modal-content">
				<div class="modal-header" style="text-align: left;">
					...
					<h4 class="modal-title" id="hdrModalPayablesCreditCardTitle"><span>
						<asp:Literal runat="server" ID="ltrPayablesCreditCardTitle" Text="<%$ Resources:GlobalResource,  PaymentToEmployee_htPayablesCreditCardTitle %>"></asp:Literal>
					</span>
					</h4>
				</div>
				<div class="modal-body">
						...
						<asp:UpdatePanel runat="server" ID="updpnlgvPayablesCreditCardSearch">
							<ContentTemplate>
								...
								<asp:GridView ID="gvPayablesCreditCardSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
									EmptyDataText="<%$ Resources:GlobalResource,msgNoRecordFound%>" AllowPaging="True" PageSize="10" ClientIDMode="Static">
									<Columns>
										<asp:TemplateField HeaderText="<%$ Resources:GlobalResource, PaymentToEmployee_htCreditCardName%>">
											<ItemTemplate>
										...
										<asp:TemplateField HeaderText="<%$ Resources:GlobalResource, PaymentToEmployee_htPayablesCreditCardGuid%>" Visible="false">
											<ItemTemplate>
			...
			<div class="modal-content">
				<div class="modal-header" style="text-align: left;">
					...
					<h4 class="modal-title" id="hdrSourceDocumentTitle"><span>
						<asp:Literal runat="server" ID="ltr_Source_Document" Text="<%$ Resources:GlobalResource, PaymentToEmployee_ltrSourceDocument %>"></asp:Literal>
					</span>
					</h4>
				</div>
				<div class="modal-body">
						...
						<asp:UpdatePanel runat="server" ID="updpnlgvSource_DocumentSearch">
							<ContentTemplate>
								...
								<asp:GridView ID="gvSource_DocumentSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
									EmptyDataText="<%$ Resources:GlobalResource,msgNoRecordFound%>" AllowPaging="True" PageSize="10" ClientIDMode="Static">
									<Columns>
										<asp:TemplateField HeaderText="<%$ Resources:GlobalResource,PaymentToEmployee_htSource_DocumentNumber%>">
											<ItemTemplate>
										...
										<asp:TemplateField HeaderText="<%$ Resources:GlobalResource, PaymentToEmployee_htSourceDocumentName%>">
											<ItemTemplate>
												<asp:Label ID="lblSource_DocumentDescription" runat="server" Text='<%# Bind("Description") %>'></asp:Label>
											</ItemTemplate>
										</asp:TemplateField>
										<asp:TemplateField HeaderText="<%$Resources:GlobalResource, PaymentToEmployee_htSourceDocumentGuid%>" Visible="false">
											<ItemTemplate>
