...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    <script src="../../../infra_ui/js/Finance_JS/Bank_Accounting_JS/PaymentToEmployee_JS/PaymentToEmployeeForm.js"></script>
</asp:Content>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:Label runat="server" ID="lblUnapplied" Text="<%$ Resources:GlobalResource, PaymentToEmployeer_lblUnapplied%>"></asp:Label>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblIsAutoAppliyTo" Text="<%$ Resources:GlobalResource, PaymentToEmployee_lblIsAutoAppliyTo%>"></asp:Label>

                            <asp:CheckBox ID="chkIsAutoAppliyTo" runat="server"  ClientIDMode="Static" class="form-control" placeholder="" required="required"/>
                        </div>
                      
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblIsPosted" Text="<%$ Resources:GlobalResource, PaymentToEmployee_lblIsPosted%>"></asp:Label>

                            <asp:CheckBox ID="chkIsPosted" runat="server"  ClientIDMode="Static" class="form-control" placeholder="" required="required"/>
                        </div>
                        <div class="form-group col-md-4 col-sm-4">

                            <asp:Label runat="server" ID="lblPostingDate" Text="<%$ Resources:GlobalResource, PaymentToEmployee_lblPostingDate%>"></asp:Label>
                        ...
                        <asp:UpdatePanel runat="server" ID="updpnlgvSource_DocumentSearch">
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvSource_DocumentSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    EmptyDataText="<%$ Resources:GlobalResource,msgNoRecordFound%>" AllowPaging="True" PageSize="10" ClientIDMode="Static">
                                    <Columns>
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource,PaymentToEmployeer_htSource_DocumentNumber%>">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, PaymentToEmployeer_htSourceDocumentName%>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblSource_DocumentDescription" runat="server" Text='<%# Bind("Description") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="<%$Resources:GlobalResource, PaymentToEmployeer_htSourceDocumentGuid%>" Visible="false">
                                            <ItemTemplate>
