                            ...
                            <div id="divPaymentToEmployee" runat="server" class="form-group col-md-12 col-sm-12">
                                ...
                                <div>
                                    <div class="form-group col-md-4 col-sm-4">
                                        ...
                                        <asp:TextBox type="text" runat="server" ID="txtEmployeeId" ReadOnly="true" ClientIDMode="Static" class="form-control" placeholder="" required="required"></asp:TextBox>
                                    </div>

                                    <div class="form-group col-md-4 col-sm-4">
                                        <asp:Label runat="server" ID="lblEmployeeName" Text="<%$ Resources:GlobalResource, PaymentToEmployeeApply_lblEmployeeName%>"></asp:Label>
                                        <asp:TextBox type="text" runat="server" ID="txtEmployeename" ReadOnly="true" ClientIDMode="Static" class="form-control" placeholder="" required="required"></asp:TextBox>
                                    </div>
