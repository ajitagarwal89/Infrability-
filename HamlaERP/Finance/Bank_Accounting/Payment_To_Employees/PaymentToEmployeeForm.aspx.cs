...
public partial class Finance_Bank_Accounting_Payment_To_Employee_PaymentToEmployeeForm : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (Request.QueryString["PaymentToEmployeeId"] != null || Request.QueryString["recordId"] != null)
            {
                paymentToEmployeeFormUI.Tbl_PaymentToEmployeeId = (Request.QueryString["PaymentToEmployeeId"] != null ? Request.QueryString["PaymentToEmployeeId"] : Request.QueryString["recordId"]);
            ...
            {
                paymentToEmployeeFormUI.InvoiceType = invoiceTypeInvoice;
                GetSerialNumber(paymentToEmployeeFormUI);
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            paymentToEmployeeFormUI.Opt_PayablesType = int.Parse(ddlOpt_PayablesType.SelectedValue.ToString());
            ...
            {
                paymentToEmployeeFormUI.BankTransferAmount = 0;
                paymentToEmployeeFormUI.Tbl_PayablesId_BankTransfer = null;
            }
            ...
            {
                paymentToEmployeeFormUI.Tbl_PayablesId_Cash = null;
                paymentToEmployeeFormUI.CashAmount = 0;
            }
            ...
            {
                paymentToEmployeeFormUI.ChequeAmount = 0;
                paymentToEmployeeFormUI.Tbl_PayablesId_Cheque = null;
            }
        ...
        {
                paymentToEmployeeFormUI.Tbl_PayablesId_CreditCard = null;
                paymentToEmployeeFormUI.CreditCardAmount = 0;
            }
            ...
            if (chkIsAutoApplyTo.Checked)
            { paymentToEmployeeFormUI.IsAutoApplyTo = true; }
            else
            {
                paymentToEmployeeFormUI.IsAutoApplyTo = false;
            }
    ...
    protected void btnPost_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            paymentToEmployeeFormUI.Tbl_OrganizationId = SessionContext.OrganizationId;
            paymentToEmployeeFormUI.Tbl_PaymentToEmployeeId = Request.QueryString["PaymentToEmployeeId"];
            paymentToEmployeeFormUI.IsPosted = isPosted;

            if (paymentToEmployeeFormBAL.UpdatePostingPaymentToEmployee(paymentToEmployeeFormUI) == 1)
            {
                divSuccess.Visible = true;
        ...
        catch (Exception exp)
        {
            ...
            log.Error("[Finance_Bank_Accounting_Payment_To_Employee_PaymentToEmployeeForm : btnPost_Click] An error occured in the processing of Record Id : " + paymentToEmployeeFormUI.Tbl_PaymentToEmployeeId + ".  Details : [" + exp.ToString() + "]");
        }
    }
    ...
    {
        string Form = "~/Finance/Bank_Accounting/Payment_To_Employees/PaymentToEmployeeForm.aspx";
        string recordId = Request.QueryString["PaymentToEmployeeId"];
    ...
    private void GetSerialNumber(PaymentToEmployeeFormUI paymentToEmployeeFormUI)
    {
        try
        {
            DataTable dtb = paymentToEmployeeFormBAL.GetSerialNumber(paymentToEmployeeFormUI);
            if (dtb.Rows.Count > 0)
            {
        ...
        catch (Exception exp)
        {
            ...
            logExcpUIobj.ExceptionDetails = "Error Occured. System Generated Error is: " + exp.ToString();
            logExcpDALobj.SaveExceptionToDB(logExcpUIobj);
            log.Error("[Finance_Bank_Accounting_Payment_To_Employee_PaymentToEmployeeForm : GetSerialNumber] An error occured in the processing of Record Details : [" + exp.ToString() + "]");
        }
    }
    ...
    private void BindPayablesTypeDropDownList()
    {
        ...
        catch (Exception exp)
        {
            ...
            log.Error("[Finance_Bank_Accounting_Payment_To_Employee_PaymentToEmployeeForm : BindPayablesTypeDropDownList] An error occured in the processing of Record Details : [" + exp.ToString() + "]");
        }
    ...
    private void FillForm(PaymentToEmployeeFormUI paymentToEmployeeFormUI)
    {
        try
        {
            ...
            if (dtb.Rows.Count > 0)
            {
                ...
                ddlOpt_PayablesType.SelectedValue = dtb.Rows[0]["PayablesType"].ToString();
