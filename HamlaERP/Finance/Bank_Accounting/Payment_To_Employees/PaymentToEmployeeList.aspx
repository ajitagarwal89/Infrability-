<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="PaymentToEmployeeList.aspx.cs" Inherits="Finance_Bank_Accounting_Payment_To_Employee_PaymentToEmployeeList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    <script src="../../../infra_ui/js/Finance_JS/Bank_Accounting_JS/Payment_To_Employee_JS/PaymentToEmployeeList.js"></script>
</asp:Content>
      ...
      <div id="content" class="ui-content ui-content-aside-overlay">
        ...
        <div class="ui-content-body">
            <div class="ui-container">
                <div class="row">
                    <h3 class="hepad">
                        <asp:Literal runat="server" ID="ltrSearch" Text="<%$ Resources:GlobalResource, PaymentToEmployee_ltrPaymentToEmployee %>"></asp:Literal></h3>
                            ...
                            <ContentTemplate>
                                ...
                                <asp:DataGrid runat="server" ClientIDMode="Static" Font-Size="10pt" ID="gvData" AutoGenerateColumns="false" Width="100%" GridLines="None" BorderStyle="None" CssClass="table table-hover">
                                    <Columns>
                                        ...
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, PaymentToEmployee_htPaymentNumber%>" DataField="PaymentNumber"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, PaymentToEmployee_htPaymentDate%>" DataField="PaymentDate"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, PaymentToEmployee_htBatchName%>" DataField="BatchName"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, PaymentToEmployee_htEmployeeName%>" DataField="EmployeeName"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, PaymentToEmployee_htPayableType%>" DataField="PayablesType"></asp:BoundColumn>
                                        ...
                                        <asp:TemplateColumn HeaderImageUrl="~/images/eye.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <button id="lnkView_<%# Container.DataSetIndex + 1 %>" type="button" data-toggle="modal" data-target="#divBasicModal" data-keyboard="false" data-backdrop="static" class="btn btn-default btn-sm btn-block" onclick="SetDetails('<%#Eval("PaymentNumber")%>','<%#Eval("PaymentDate")%>','<%#Eval("BatchName")%>','<%#Eval("EmployeeName")%>','<%#Eval("CurrencyName")%>','<%#Eval("BankName")%>','<%#Eval("BankTransferAmount")%>','<%#Eval("PayablesTypeCash")%>','<%#Eval("CashAmount")%>','<%#Eval("PayablesTypeCheque")%>','<%#Eval("ChequeAmount")%>','<%#Eval("CardName")%>','<%#Eval("CreditCardAmount")%>','<%#Eval("Unapplied")%>','<%#Eval("Applied")%>','<%#Eval("Total")%>','lnkview_<%# Container.DataSetIndex + 1 %>');">
                                                    <asp:Literal runat="server" ID="ltrView" Text="<%$ Resources:GlobalResource, ltrView%>"></asp:Literal></button>
                                                <button id="lnkViewNextPrev_<%# Container.DataSetIndex + 1 %>" style="display: none;" type="button" class="btn btn-default btn-sm" onclick="SetDetails('<%#Eval("PaymentNumber")%>','<%#Eval("PaymentDate")%>','<%#Eval("BatchName")%>','<%#Eval("EmployeeName")%>','<%#Eval("CurrencyName")%>','<%#Eval("BankName")%>','<%#Eval("BankTransferAmount")%>','<%#Eval("PayablesTypeCash")%>','<%#Eval("CashAmount")%>','<%#Eval("PayablesTypeCheque")%>','<%#Eval("ChequeAmount")%>','<%#Eval("CardName")%>','<%#Eval("CreditCardAmount")%>','<%#Eval("Unapplied")%>','<%#Eval("Applied")%>','<%#Eval("Total")%>','lnkview_<%# Container.DataSetIndex + 1 %>');"></button>
                                                </ItemTemplate>
                                        ...
                                        <asp:TemplateColumn HeaderImageUrl="~/images/edit.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="gvColLnkBtn" class="btn btn-default btn-sm btn-block" OnClick="gvColLnkBtn_Click" CommandArgument='<%#Eval("tbl_PaymentToEmployeeId") %>'>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><span>
                        <asp:Literal runat="server" ID="ltrDetails" Text="<%$ Resources:GlobalResource, PaymentToEmployee_ltrDetails %>"></asp:Literal></span></h4>
                </div>
                <div class="modal-body">
                    <table class="table table-striped" style="width: 100%; font-size: 9.5pt;">
                        <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrPaymentNumber" Text="<%$ Resources:GlobalResource, PaymentToEmployee_ltrPaymentNumber%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrPaymentDate" Text="<%$ Resources:GlobalResource, PaymentToEmployee_ltrPaymentDate%>"></asp:Literal></td>

                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrBatchName" Text="<%$ Resources:GlobalResource, PaymentToEmployee_ltrBatchName%>"></asp:Literal></td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrEmployeeName" Text="<%$ Resources:GlobalResource, PaymentToEmployee_ltrEmployeeName%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrCurrencyName" Text="<%$ Resources:GlobalResource, PaymentToEmployee_ltrCurrencyName%>"></asp:Literal></td>
                          
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrBankName" Text="<%$ Resources:GlobalResource, PaymentToEmployee_ltrBankName%>"></asp:Literal></td>
                        </tr>
                        <tr>
                            <td>
                           ...
                           <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrBankTransferAmount" Text="<%$ Resources:GlobalResource, PaymentToEmployee_ltrBankTransferAmount%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrPayablesTypeCash" Text="<%$ Resources:GlobalResource, PaymentToEmployee_ltrPayablesTypeCash%>"></asp:Literal></td>
                          
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrCashAmount" Text="<%$ Resources:GlobalResource, PaymentToEmployee_ltrCashAmount%>"></asp:Literal></td>
                        </tr>
                        <tr>
                            <td>
                           ...
                           <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrPayablesTypeCheque" Text="<%$ Resources:GlobalResource, PaymentToEmployee_ltrPayablesTypeCheque%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrChequeAmount" Text="<%$ Resources:GlobalResource, PaymentToEmployee_ltrChequeAmount%>"></asp:Literal></td>
                          
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrCardName" Text="<%$ Resources:GlobalResource, PaymentToEmployee_ltrCardName%>"></asp:Literal></td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrCreditCardAmount" Text="<%$ Resources:GlobalResource, PaymentToEmployee_ltrCreditCardAmount%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrUnaplied" Text="<%$ Resources:GlobalResource, PaymentToEmployee_ltrUnapplied%>"></asp:Literal></td>
                          
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrApplied" Text="<%$ Resources:GlobalResource, PaymentToEmployee_ltrApplied%>"></asp:Literal></td>
                        </tr>
                        <tr>
                            <td>
                           ...
                           <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrTotal" Text="<%$ Resources:GlobalResource, PaymentToEmployee_ltrTotal%>"></asp:Literal></td>
                           </tr>
                        <tr>
                            <td>
