<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="GLAccountConfigurationSettingsList.aspx.cs" Inherits="Finance_General_Ledger_GLAccountConfigurationSettings_GLAccountConfigurationSettingsList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    <script src="../../../infra_ui/js/Finance_JS/General_Ledger_JS/GLAccountConfigurationSettings_JS/GLAccountConfigurationSettingsList.js"></script>
</asp:Content>
      ...
      <div id="content" class="ui-content ui-content-aside-overlay">
        ...
        <div class="ui-content-body">
            <div class="ui-container">
                <div class="row">
                    <h3 class="hepad">
                        <asp:Literal runat="server" ID="ltrSearch" Text="<%$ Resources:GlobalResource, GLAccountConfigurationSettings_ltrSearch %>"></asp:Literal></h3>
                            ...
                            <ContentTemplate>
                                ...
                                <asp:DataGrid runat="server" ClientIDMode="Static" Font-Size="10pt" ID="gvData" AutoGenerateColumns="false" Width="100%" GridLines="None" BorderStyle="None" CssClass="table table-hover">
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="tbl_GLAccountConfigurationSettingsId" Visible="false"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, GLAccountConfigurationSettings_htGLAccountId_RetainedEarning%>" DataField="RetainedEarning"></asp:BoundColumn>
                                          <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, GLAccountConfigurationSettings_htPostingToHistory%>" DataField="PostingToHistory"></asp:BoundColumn>
                                          <asp:BoundColumn HeaderText="<%$ Resources:GlobalResource, GLAccountConfigurationSettings_htDeletionOfSavedTransaction%>" DataField="DeletionOfSavedTransaction"></asp:BoundColumn>

                                        <asp:TemplateColumn HeaderImageUrl="~/images/eye.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <button id="lnkView_<%# Container.DataSetIndex + 1 %>" type="button" data-toggle="modal" data-target="#basicModalGLAccountSearch" data-keyboard="false" data-backdrop="static" class="btn btn-default btn-sm btn-block" onclick="setDetails('<%#Eval("RetainedEarning")%>','<%#Eval("PostingToHistory")%>','<%#Eval("DeletionOfSavedTransaction")%>','lnkview_<%# Container.DataSetIndex + 1 %>');">
                                                    <asp:Literal runat="server" ID="ltrView" Text="<%$ Resources:GlobalResource, ltrView%>"></asp:Literal></button>
                                                <button id="lnkViewNextPrev_<%# Container.DataSetIndex + 1 %>" style="display: none;" type="button" class="btn btn-default btn-sm" onclick="setDetails('<%#Eval("RetainedEarning")%>','<%#Eval("PostingToHistory")%>','<%#Eval("DeletionOfSavedTransaction")%>','lnkview_<%# Container.DataSetIndex + 1 %>');"></button>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>

                                        <asp:TemplateColumn HeaderImageUrl="~/images/edit.png" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="gvColLnkBtn" class="btn btn-default btn-sm btn-block" OnClick="gvColLnkBtn_Click" CommandArgument='<%#Eval("tbl_GLAccountConfigurationSettingsId") %>'>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><span>
                        <asp:Literal runat="server" ID="ltrRecordDetails" Text="<%$ Resources:GlobalResource, GLAccountConfigurationSettings_ltrDetails %>"></asp:Literal></span></h4>
                </div>
                <div class="modal-body">
                    <table class="table table-striped" style="width: 100%; font-size: 9.5pt;">
                        <tr>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrGLAccountId_RetainedEarning" Text="<%$ Resources:GlobalResource, GLAccountConfigurationSettings_ltrGLAccountId_RetainedEarning%>"></asp:Literal></td>
                            <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrPostingToHistory" Text="<%$ Resources:GlobalResource, GLAccountConfigurationSettings_ltrPostingToHistory%>"></asp:Literal></td>
                              <td class="auto-style1">
                                <asp:Literal runat="server" ID="ltrDeletionOfSavedTransaction" Text="<%$ Resources:GlobalResource, GLAccountConfigurationSettings_ltrDeletionOfSavedTransaction%>"></asp:Literal></td>
                       
                             </tr>
                        <tr>
                            <td>
                                <asp:Label ID="lblGLAccountId_RetainedEarning" runat="server" ClientIDMode="Static"></asp:Label></td>
                            <td>
                                <asp:Label ID="lblPostingToHistory" runat="server" ClientIDMode="Static"></asp:Label></td>
                         <td>
                                <asp:Label ID="lblDeletionOfSavedTransaction" runat="server" ClientIDMode="Static"></asp:Label></td>
