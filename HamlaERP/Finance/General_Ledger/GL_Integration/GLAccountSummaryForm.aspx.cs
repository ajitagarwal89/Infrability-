...
public partial class Finance_General_Ledger_GL_Integration_GLAccountSummaryForm : PageBase
{
    ...
    protected override void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            if (Request.QueryString["GLAccountSummaryId"] != null || Request.QueryString["recordId"] != null)
            {
                gLAccountSummaryFormUI.Tbl_GLAccountSummaryId = (Request.QueryString["GLAccountSummaryId"] != null ? Request.QueryString["GLAccountSummaryId"] : Request.QueryString["recordId"]);
    ...
    {
        string Form = "~//Finance/General_Ledger/GL_Integration/GLAccountSummaryForm.aspx";
        string recordId = Request.QueryString["GLAccountSummaryId"];
