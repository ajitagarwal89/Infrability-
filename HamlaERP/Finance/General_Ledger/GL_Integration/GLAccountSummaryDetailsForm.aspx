                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox runat="server" ID="txtPeriod" ClientIDMode="Static" class="form-control " onkeypress="return isNumberKey(this);" maxlength="2" placeholder="" required="required"></asp:TextBox>
                        </div>

                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblPeriodName" Text="<%$ Resources:GlobalResource, GLAccountSummaryDetails_lblPeriodName%>"></asp:Label>
                            <asp:TextBox runat="server" ID="txtPeriodName" ClientIDMode="Static" class="form-control "  onkeypress="return isAlphaNumberKey(this);" maxlength="20"  placeholder="" required="required"></asp:TextBox>
                        </div>

                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblPeriodDate" Text="<%$ Resources:GlobalResource, GLAccountSummaryDetails_lblPeriodDate%>"></asp:Label>
                            <asp:TextBox runat="server" ID="txtPeriodDate" TextMode="Date" ClientIDMode="Static" class="form-control " placeholder="" required="required"></asp:TextBox>
                        </div>

                         <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblDebitAmount" Text="<%$ Resources:GlobalResource, GLAccountSummaryDetails_lblDebitAmount%>"></asp:Label>
                            <asp:TextBox runat="server" ID="txtDebitAmount" ClientIDMode="Static" class="form-control " placeholder=""  onkeypress="return isNumberKeyPoint(this);" maxlength="9" required="required"></asp:TextBox>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox runat="server" ID="txtCreditAmount" ClientIDMode="Static" class="form-control " onkeypress="return isNumberKeyPoint(this);" maxlength="9"  placeholder="" required="required"></asp:TextBox>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox runat="server" ID="txtNetChargeAmount" ClientIDMode="Static" class="form-control " placeholder="" onkeypress="return isNumberKeyPoint(this);" maxlength="9"  required="required"></asp:TextBox>
                        </div>
                         ...
                         <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox runat="server" ID="txtPeriodBalanceAmount" ClientIDMode="Static" class="form-control " onkeypress="return isNumberKeyPoint(this);" maxlength="9"  placeholder="" required="required"></asp:TextBox>
                        </div>
                    </div>
                </div>
            </div>
