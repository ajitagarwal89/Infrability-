...
public partial class Finance_General_Ledger_GL_Integration_GLAccountCurrencyForm : PageBase
{
    ...
    protected override void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            if (Request.QueryString["GLAccountCurrencyId"] != null || Request.QueryString["recordId"] != null)
            {
                gLAccountCurrencyFormUI.Tbl_GLAccountCurrencyId = (Request.QueryString["GLAccountCurrencyId"] != null ? Request.QueryString["GLAccountCurrencyId"] : Request.QueryString["recordId"]);
    ...
    {
        string Form = "~/Finance/General_Ledger/GL_Integration/GLAccountCurrencyForm.aspx";
        string recordId = Request.QueryString["GLAccountCurrencyId"];
