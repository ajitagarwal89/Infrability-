...
public partial class Finance_General_Ledger_GL_Integration_GLAccountList : PageBase
{
    #region Data Members
    ...
    {
        Response.Redirect("GLAccountForm.aspx");
    }

    protected void gvColLnkBtn_Click(object sender, EventArgs e)
    {
        string gLAccountId = (sender as LinkButton).CommandArgument;
        Response.Redirect("GLAccountForm.aspx?GLAccountId=" + gLAccountId);
    }
    ...
    protected void btnMainSearch_Click(object sender, EventArgs e)
    {
        ...
        gLAccountListUI.Search = txtSearch.Text;
        BindListBySearchParameters(gLAccountListUI);
    }
    ...
    protected void lnkExportToExcel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            dtb = gLAccountListBAL.GetGLAccountListForExportToExcel();
            string exportedFileName = "GLAccount_" + System.DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
            Response.Clear();
            Response.Charset = "";
        ...
        catch (Exception exp)
        {
            ...
            logExcpUIobj.ExceptionDetails = "Error Occured. System Generated Error is: " + exp.ToString();
            logExcpDALobj.SaveExceptionToDB(logExcpUIobj);
            log.Error("[Finance_General_Ledger_GL_Integration_GLAccountList : lnkExportToExcel_Click] An error occured in the processing of Records. Details : [" + exp.ToString() + "]");
        }
    }
    ...
    private void BindList()
    {
        ...
        catch (Exception exp)
        {
            ...
            log.Error("[Finance_General_Ledger_GL_Integration_GLAccountList : BindList] An error occured in the processing of Record. Details : [" + exp.ToString() + "]");
        }
    }
