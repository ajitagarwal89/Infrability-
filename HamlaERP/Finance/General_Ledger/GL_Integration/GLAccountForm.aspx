                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-1 col-sm-1">
                            <asp:DropDownList ID="ddlSegment01" runat="server" ClientIDMode="Static" class="form-control " placeholder="" required="required" AutoPostBack="True" OnSelectedIndexChanged="ddlSegment01_SelectedIndexChanged">
                            </asp:DropDownList>
                        </div>

                        <div class="form-group col-md-1 col-sm-1">
                            <asp:DropDownList ID="ddlSegment02" runat="server" ClientIDMode="Static" class="form-control " placeholder="" required="required" AutoPostBack="True" OnSelectedIndexChanged="ddlSegment02_SelectedIndexChanged">
                            </asp:DropDownList>
                        </div>

                        <div class="form-group col-md-1 col-sm-1">
                            <asp:DropDownList ID="ddlSegment03" runat="server" ClientIDMode="Static" class="form-control " placeholder="" required="required" AutoPostBack="True" OnSelectedIndexChanged="ddlSegment03_SelectedIndexChanged">
                            </asp:DropDownList>
                        </div>

                        <div class="form-group col-md-1 col-sm-1">
                            <asp:DropDownList ID="ddlSegment04" runat="server" ClientIDMode="Static" class="form-control " placeholder="" required="required" AutoPostBack="True" OnSelectedIndexChanged="ddlSegment04_SelectedIndexChanged">
                            </asp:DropDownList>
                        </div>

                        <div class="form-group col-md-1 col-sm-1">
                            <asp:DropDownList ID="ddlSegment05" runat="server" ClientIDMode="Static" class="form-control " placeholder="" required="required" AutoPostBack="True" OnSelectedIndexChanged="ddlSegment05_SelectedIndexChanged">
                            </asp:DropDownList>
                        </div>

                        <div class="form-group col-md-1 col-sm-1">
                            <asp:DropDownList ID="ddlSegment06" runat="server" ClientIDMode="Static" class="form-control " placeholder="" required="required" AutoPostBack="True" OnSelectedIndexChanged="ddlSegment06_SelectedIndexChanged">
                            </asp:DropDownList>
                        </div>

                        <div class="form-group col-md-1 col-sm-1">
                            <asp:DropDownList ID="ddlSegment07" runat="server" ClientIDMode="Static" class="form-control " placeholder="" required="required" AutoPostBack="True" OnSelectedIndexChanged="ddlSegment07_SelectedIndexChanged">
                            </asp:DropDownList>
                        </div>

                        <div class="form-group col-md-1 col-sm-1">
                            <asp:DropDownList ID="ddlSegment08" runat="server" ClientIDMode="Static" class="form-control " placeholder="" required="required" AutoPostBack="True" OnSelectedIndexChanged="ddlSegment08_SelectedIndexChanged">
                            </asp:DropDownList>
                        </div>

                        <div class="form-group col-md-1 col-sm-1">
                            <asp:DropDownList ID="ddlSegment09" runat="server" ClientIDMode="Static" class="form-control " placeholder="" required="required" AutoPostBack="True" OnSelectedIndexChanged="ddlSegment09_SelectedIndexChanged">
                            </asp:DropDownList>
                        </div>

                        <div class="form-group col-md-1 col-sm-1">
                            <asp:DropDownList ID="ddlSegment10" runat="server" ClientIDMode="Static" class="form-control " placeholder="" required="required" AutoPostBack="True" OnSelectedIndexChanged="ddlSegment10_SelectedIndexChanged">
                            </asp:DropDownList>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox type="text" runat="server" ID="txtAccountNumber" ClientIDMode="Static" class="form-control " placeholder="" required="required" aufocus="autofocus"></asp:TextBox>
                        </div>

                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblIsActive" Text="<%$ Resources:GlobalResource, GLAccount_lblIsActive%>"></asp:Label>
                            <asp:CheckBox runat="server" ID="chckIsActive" Checked="false" ClientIDMode="Static" class="form-control" PlaceHolder="" required="required"></asp:CheckBox>
                        </div>

                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblAllowAccountEntry" Text="<%$ Resources:GlobalResource, GLAccount_lblAllowAccountEntry %>"></asp:Label>
                            <asp:CheckBox runat="server" ID="chckAllowAccountEntry" Checked="false" ClientIDMode="Static" class="form-control" PlaceHolder="" required="required"></asp:CheckBox>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:CheckBox runat="server" ID="chckPostingType" Checked="false" ClientIDMode="Static" class="form-control" PlaceHolder="" required="required"></asp:CheckBox>
                        </div>

                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblTypicalBalance" Text="<%$ Resources:GlobalResource, GLAccount_lblTypicalBalance %>"></asp:Label>
                            <asp:CheckBox runat="server" ID="chckTypicalBalance" Checked="false" ClientIDMode="Static" class="form-control" PlaceHolder="" required="required"></asp:CheckBox>
                        </div>

                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblAppearInFinance" Text="<%$ Resources:GlobalResource, GLAccount_lblAppearInFinance %>"></asp:Label>
                            <asp:CheckBox runat="server" ID="chckAppearInFinance" Checked="false" ClientIDMode="Static" class="form-control" PlaceHolder="" required="required"></asp:CheckBox>
                        </div>

                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblAppearInHR" Text="<%$ Resources:GlobalResource, GLAccount_lblAppearInHR %>"></asp:Label>
                            <asp:CheckBox runat="server" ID="chckAppearInHR" Checked="false" ClientIDMode="Static" class="form-control" PlaceHolder="" required="required"></asp:CheckBox>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:CheckBox runat="server" ID="chckAppearInProcurement" Checked="false" ClientIDMode="Static" class="form-control" PlaceHolder="" required="required"></asp:CheckBox>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:CheckBox runat="server" ID="chckAppearInSystemSettings" Checked="false" ClientIDMode="Static" class="form-control" PlaceHolder="" required="required"></asp:CheckBox>
                        </div>
                    </div>
                                ...
                                <asp:GridView ID="gvGLAccountCategorySearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, GLAccount_htCategoryNumber%>">
                                            <ItemTemplate>
                                                <a href="#" data-dismiss="modal" onclick="SetGLAccountCategoryDetails('<%#Eval("CategoryNumber")%>','<%#Eval("tbl_GLAccountCategoryId")%>');">
                                                    <asp:Literal runat="server" ID="ltrgvGLAccountCategoryCode" Text='<%# Bind("CategoryNumber") %>'></asp:Literal>
                                                </a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, GLAccount_AccountCategory%>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblgvGLAccountCategory" runat="server" Text='<%# Bind("Description") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
