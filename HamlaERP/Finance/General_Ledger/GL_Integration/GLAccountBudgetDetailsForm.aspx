                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-12" style="background-color: #f6f6f6">
                         ...
                         <div class="form-group col-md-4 col-sm-4">
                          ...
                          <div class="form-group col-md-4 col-sm-4">
                           <asp:Label runat="server" ID="lblPeriod" Text="<%$ Resources:GlobalResource,GLAccountBudgetDetails_lblPeriod%>"></asp:Label>
                            <asp:TextBox runat="server" ID="txtPeriod" ClientIDMode="Static" class="form-control" placeholder="" onkeypress="return isNumberKey(this);" maxlength="2" required="required"></asp:TextBox>
                        </div>
                         <div class="form-group col-md-4 col-sm-4">

                            <asp:Label runat="server" ID="lblPeriodName" Text="<%$ Resources:GlobalResource, GLAccountBudgetDetails_lblPeriodName%>"></asp:Label>
                            <asp:TextBox runat="server" ID="txtPeriodName" ClientIDMode="Static" class="form-control" placeholder="" onkeypress="return isAlphaKey(this);" maxlength="20" required="required"></asp:TextBox>
                        </div>
                         ...
                         <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox runat="server" ID="txtAmount" ClientIDMode="Static" class="form-control" placeholder="" onkeypress="return isNumberKeyPoint(this);" MaxLength="9" required="required"></asp:TextBox>
                        </div>
                        </div>
                    </div>
                </div>
                        ...
                        <asp:UpdatePanel runat="server" ID="updpnlgvFiscalPeriodSearch">
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvFiscalPeriodSearch" runat="server" Width="100%" CssClass="table table-hover" AutoGenerateColumns="False"
                                    EmptyDataText="<%$ Resources:GlobalResource,msgNoRecordFound%>" AllowPaging="True" PageSize="10" ClientIDMode="Static">
                                    <Columns>
                                        <asp:TemplateField HeaderText="<%$ Resources:GlobalResource, GLAccountBudgetDetails_htNumberofPeriod%>">
                                            <ItemTemplate>
