...
public partial class Finance_General_Ledger_GL_Integration_GLAccountSummaryDetailsForm : PageBase
{
    ...
    protected override void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            if (Request.QueryString["GLAccountSummaryDetailsId"] != null || Request.QueryString["recordId"] != null)
            {
                gLAccountSummaryDetailsFormUI.Tbl_GLAccountSummaryDetailsId =(Request.QueryString["GLAccountSummaryDetailsId"] != null ? Request.QueryString["GLAccountSummaryDetailsId"] : Request.QueryString["recordId"]);
    ...
    {
        string Form = "~/Finance/General_Ledger/GL_Integration/GLAccountSummaryDetailsForm.aspx";
        string recordId = Request.QueryString["GLAccountSummaryDetailsId"];
    ...
    private void FillForm(GLAccountSummaryDetailsFormUI gLAccountSummaryDetailsFormUI)
    {
        ...
        try
        {
            ...
            if (dtb.Rows.Count > 0)
            {
                ...
                txtGLAccountSummary.Text = dtb.Rows[0]["tbl_GLAccountSummaryId"].ToString();
