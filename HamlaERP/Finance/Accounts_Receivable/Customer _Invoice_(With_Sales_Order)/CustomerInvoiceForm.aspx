                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox type="text" runat="server" ID="txtCustomerPONumber" ClientIDMode="Static" class="form-control" placeholder="" required="required"></asp:TextBox>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox type="text" runat="server" ID="txtAmountReceived" ClientIDMode="Static" class="form-control" placeholder="" required="required"></asp:TextBox>
                        </div>
                        <div class="form-group col-md-4 col-sm-4">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox type="text" runat="server" ID="txtQuoteDate" ClientIDMode="Static" class="form-control " TextMode="Date" placeholder="" required="required"></asp:TextBox>
                        </div>
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblOrderDate" Text="<%$ Resources:GlobalResource, CustomerInvoice_lblOrderDate%>"></asp:Label>
                            <asp:TextBox type="text" runat="server" ID="txtOrderDate" ClientIDMode="Static" class="form-control " TextMode="Date" placeholder="" required></asp:TextBox>
                        </div>
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblInvoiceDate" Text="<%$ Resources:GlobalResource, CustomerInvoice_lblInvoiceDate %>"></asp:Label>
                            <asp:TextBox type="text" runat="server" ID="txtInvoiceDate" ClientIDMode="Static" class="form-control " TextMode="Date" placeholder="" required></asp:TextBox>
                        </div>


                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblBackOrderDate" Text="<%$ Resources:GlobalResource, CustomerInvoice_lblBackOrderDate%>"></asp:Label>
                            <asp:TextBox type="text" runat="server" ID="txtBackOrderDate" ClientIDMode="Static" class="form-control" TextMode="Date" placeholder="" required></asp:TextBox>
                        </div>
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblReturnDate" Text="<%$ Resources:GlobalResource, CustomerInvoice_lblReturnDate%>"></asp:Label>
                            <asp:TextBox type="text" runat="server" ID="txtReturnDate" ClientIDMode="Static" class="form-control " TextMode="Date" placeholder="" required></asp:TextBox>
                        </div>
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox type="text" runat="server" ID="txtRequestedShipDate" ClientIDMode="Static" class="form-control" TextMode="Date" placeholder="" required></asp:TextBox>
                        </div>


                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblDateFulfilled" Text="<%$ Resources:GlobalResource, CustomerInvoice_lblDateFulfilled%>"></asp:Label>
                            <asp:TextBox type="text" runat="server" ID="txtDateFulfilled" ClientIDMode="Static" class="form-control " TextMode="Date" placeholder="" required="required"></asp:TextBox>
                        </div>
                        <div class="form-group col-md-4 col-sm-4">
                            <asp:Label runat="server" ID="lblActualShipDate" Text="<%$ Resources:GlobalResource, CustomerInvoice_lblActualShipDate%>"></asp:Label>
                            <asp:TextBox type="text" runat="server" ID="txtActualShipDate" ClientIDMode="Static" class="form-control " TextMode="Date" placeholder="" required="required"></asp:TextBox>
                        </div>
            ...
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    ...
                    <h4 class="modal-title" id="hdrModalSitesTitle"><span>
                        <asp:Literal runat="server" ID="ltrSitesTitle" Text="<%$ Resources:GlobalResource, CustomerInvoice__ltrSitesInfomation%>"></asp:Literal>
                    </span>
                    </h4>
                </div>
                <div class="modal-body">
