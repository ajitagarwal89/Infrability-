                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 colformstyle">
						...
						<asp:UpdatePanel ID="uplInvoiceDate" runat="server" >
                            ...
                            <asp:TextBox runat="server" ID="txtInvoiceDate" ClientIDMode="Static" TextMode="Date" class="form-control "  AutoPostBack="true"  placeholder="" required="required" OnTextChanged="txtInvoiceDate_TextChanged"></asp:TextBox>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox runat="server" ID="txtInvoiceIssueDate" ClientIDMode="Static" class="form-control " TextMode="Date" placeholder="" required="required"></asp:TextBox>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox runat="server" ID="txtPONumber" ClientIDMode="Static" onkeypress="return isAlphaNumberKey(this);" MaxLength="20" class="form-control " placeholder="" required="required"></asp:TextBox>
                        </div>
                        <div class="form-group col-md-4 col-sm-4">

                            <asp:Label runat="server" ID="lblCost" Text="<%$ Resources:GlobalResource, CustomerInvoiceProcess_lblCost%>"></asp:Label>

                            <asp:TextBox runat="server" ID="txtCost" ClientIDMode="Static" onkeypress="return isNumberKeyPoint(this);" MaxLength="9" class="form-control " placeholder="" required="required"></asp:TextBox>
                        </div>
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox runat="server" ID="txtSales" ClientIDMode="Static" onkeypress="return isNumberKeyPoint(this);" MaxLength="9" class="form-control" placeholder="" required="required"></asp:TextBox>
                        </div>
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox runat="server" ID="txtTradeDiscount" onkeypress="return isNumberKeyPoint(this);" MaxLength="9" ClientIDMode="Static" class="form-control" placeholder="" required="required"></asp:TextBox>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox runat="server" ID="txtFreight" ClientIDMode="Static" onkeypress="return isNumberKeyPoint(this);" MaxLength="9" class="form-control" placeholder="" required="required"></asp:TextBox>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox runat="server" ID="txtTotal" ClientIDMode="Static" onkeypress="return isNumberKeyPoint(this);" MaxLength="9" class="form-control" placeholder="" required="required"></asp:TextBox>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                              ...
                              <asp:UpdatePanel ID ="upPayablesType" runat="server">
                                  <ContentTemplate>
                            <asp:DropDownList ID="ddlOpt_PayablesType" runat="server" class="form-control " placeholder="" required="required" AutoPostBack="true" OnSelectedIndexChanged="ddlOpt_PayablesType_SelectedIndexChanged" OnLoad="ddlOpt_PayablesType_Load"  >
                               </asp:DropDownList>
                                      </ContentTemplate>
                                  </asp:UpdatePanel>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <div class="input-group">
                                ...
                                <asp:TextBox ID="txtPayablesCashGuid" runat="server" ClientIDMode="Static" onkeypress="return isNumberKeyPoint(this);" MaxLength="9" Style="display: none;"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group col-md-4 col-sm-4">
                        ...
                        <asp:UpdatePanel ID ="upCheque" runat="server">
                             <ContentTemplate>
                        <div id="divChequeNumber" runat="server">
                        <div class="form-group col-md-4 col-sm-4">
                            <div>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:Label runat="server" ID="lblOnAccount" Text="<%$ Resources:GlobalResource, CustomerInvoiceProcess_lblOnAccount%>"></asp:Label>
                         ...
                         <div class="form-group col-md-4 col-sm-4">
                            ...
                            <asp:TextBox runat="server" ID="txtDescription" TextMode="MultiLine" ClientIDMode="Static" onkeypress="return isAddress(this);" MaxLength="200" class="form-control " placeholder="" required="required"></asp:TextBox>
