...
public partial class Finance_Accounts_Receivable_Customer_Invoice_Processing__Services_CustomerInvoiceProcessForm : PageBase
{
    ...
    protected override void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            if (Request.QueryString["CustomerInvoiceProcessId"] != null || Request.QueryString["recordId"] != null)
            {
                customerInvoiceProcessFormUI.Tbl_CustomerInvoiceProcessId = (Request.QueryString["CustomerInvoiceProcessId"] != null ? Request.QueryString["CustomerInvoiceProcessId"] : Request.QueryString["recordId"]);
            ...
            {
                customerInvoiceProcessFormUI.InvoiceType = invoiceTypeInvoice;
                GetSerialNumber(customerInvoiceProcessFormUI);
                BindDocumentTypeDropDownList();
                BindPayablesTypeDropDownList();
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            customerInvoiceProcessFormUI.Opt_PayablesType = Convert.ToByte(ddlOpt_PayablesType.SelectedValue);
            if (payablesType == bank)
            {
                ...
                customerInvoiceProcessFormUI.Tbl_PayablesId_BankTransfer = null;
                customerInvoiceProcessFormUI.BankTransferAmount = 0;
            }
            ...
            if (payablesType == Cheque)
            {
                ...
                customerInvoiceProcessFormUI.Tbl_PayablesId_Cheque = null;
                customerInvoiceProcessFormUI.ChequeAmount = 0;
            ...
            if (payablesType == card)
            {
                ...
                customerInvoiceProcessFormUI.Tbl_PayablesId_CreditCard = null;
                customerInvoiceProcessFormUI.CreditCardAmount = 0;
            }
            if (payablesType == Cash)
            {
                ...
                customerInvoiceProcessFormUI.Tbl_PayablesId_Cash = null;
                customerInvoiceProcessFormUI.CashAmount = 0;
            }
    ...
    {
        string Form = "~/Finance/Accounts_Receivable/Customer_Invoice_Processing_(Services)/CustomerInvoiceProcessForm.aspx";
        string recordId = Request.QueryString["CustomerInvoiceProcessId"];
    ...
    protected void btnPost_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            customerInvoiceProcessFormUI.Tbl_OrganizationId = SessionContext.OrganizationId;
            customerInvoiceProcessFormUI.Tbl_CustomerInvoiceProcessId = Request.QueryString["CustomerInvoiceProcessId"];
            customerInvoiceProcessFormUI.IsPosted = isPosted;

            if (customerInvoiceProcessFormBAL.UpdatePostingCustomerInvoiceProcess(customerInvoiceProcessFormUI) == 1)
            {
                divSuccess.Visible = true;
        ...
        catch (Exception exp)
        {
            ...
            log.Error("[Finance_Accounts_Receivable_Customer_Invoice_Processing__Services_CustomerInvoiceProcessForm : btnPost_Click] An error occured in the processing of Record Id : " + customerInvoiceProcessFormUI.Tbl_CustomerInvoiceProcessId + ".  Details : [" + exp.ToString() + "]");
        }
    ...
    private void BindPayablesTypeDropDownList()
    {
        ...
        catch (Exception exp)
        {
            ...
            log.Error("[Finance_Accounts_Receivable_Customer_Invoice_Processing__Services_CustomerInvoiceProcessForm : BindPayablesTypeDropDownList] An error occured in the processing of Record Details : [" + exp.ToString() + "]");
        }
    }
    private void GetSerialNumber(CustomerInvoiceProcessFormUI customerInvoiceProcessFormUI)
    {
        try
        {
            DataTable dtb = customerInvoiceProcessFormBAL.GetSerialNumber(customerInvoiceProcessFormUI);
            if (dtb.Rows.Count > 0)
            {
        ...
        catch (Exception exp)
        {
            ...
            logExcpUIobj.ExceptionDetails = "Error Occured. System Generated Error is: " + exp.ToString();
            logExcpDALobj.SaveExceptionToDB(logExcpUIobj);
            log.Error("[Finance_Accounts_Receivable_Customer_Invoice_Processing__Services_CustomerInvoiceProcessForm : GetSerialNumber] An error occured in the processing of Record Details : [" + exp.ToString() + "]");
        }
    }
