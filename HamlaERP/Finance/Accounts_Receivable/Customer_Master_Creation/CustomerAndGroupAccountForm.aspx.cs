...
public partial class Finance_Accounts_Receivable_Customer_Master_Creation_CustomerAndGroupAccount : PageBase
{
    ...
    protected override void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            if (Request.QueryString["CustomerAndGroupAccountId"] != null || Request.QueryString["recordId"] != null)
            {
                customerAndGroupAccountFormUI.Tbl_CustomerAndGroupAccountId = (Request.QueryString["CustomerAndGroupAccountId"] != null ? Request.QueryString["CustomerAndGroupAccountId"] : Request.QueryString["recordId"]);
    ...
    {
        string Form = "~/Finance/Accounts_Receivable/Customer_Master_Creation/CustomerAndGroupAccountForm.aspx";
        string recordId = Request.QueryString["CustomerAndGroupAccountId"];
