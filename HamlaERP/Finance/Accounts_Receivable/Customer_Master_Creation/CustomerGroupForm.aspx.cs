...
public partial class Finance_Accounts_Receivable_Customer_Master_Creation_CustomerGroupForm : PageBase
{
    ...
    protected override void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            if (Request.QueryString["CustomerGroupId"] != null || Request.QueryString["recordId"] != null)
            {
                customerGroupFormUI.Tbl_CustomerGroupId = (Request.QueryString["CustomerGroupId"] != null ? Request.QueryString["CustomerGroupId"] : Request.QueryString["recordId"]);
    ...
    {
        string Form = "~/Finance/Accounts_Receivable/Customer_Master_Creation/CustomerGroupForm.aspx";
        string recordId = Request.QueryString["CustomerGroupId"];
    ...
    private void FillForm(CustomerGroupFormUI customerGroupFormUI)
    {
        try
        {
            ...
            if (dtb.Rows.Count > 0)
            {
                ...
                txtCustomerGroupId_Self.Text = dtb.Rows[0]["description"].ToString();
