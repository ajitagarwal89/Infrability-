...
/// </summary>
public class BankAccountFormDAL:IRequiresSessionState 
{
    ...
    public DataTable GetBankAccountListById(BankAccountFormUI bankAccountFormUI)
    {
        ...
        try
        {
            ...
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                ...
                audit_IUD.WebServiceSelectInsert("tbl_BankAccount", bankAccountFormUI.BankAccountId, selectedValue);
            }
    ...
    public int AddBankAccount(BankAccountFormUI bankAccountFormUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                sqlCmd.Parameters.Add("@tbl_BankAccountID", SqlDbType.UniqueIdentifier);
                sqlCmd.Parameters["@tbl_BankAccountID"].Direction = ParameterDirection.Output;

                result = sqlCmd.ExecuteNonQuery();              

               string RecoredID =Convert.ToString(sqlCmd.Parameters["@tbl_BankAccountId"].Value);
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    ...
                    string tableName = "tbl_BankAccount";
                        ...
                        string newValue = obj.GetSerializedString(bankAccountFormUI);
                        audit_IUD.WebServiceInsert(bankAccountFormUI.Tbl_OrganizationId, tableName, RecoredID, bankAccountFormUI.CreatedBy, newValue);
                        return 1;
                    }
                    else
                    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    SerializeInputParameters obj = new SerializeInputParameters();
                    string newValue = obj.GetSerializedString(bankAccountFormUI);
                    audit_IUD.WebServiceUpdate(bankAccountFormUI.Tbl_OrganizationId, "tbl_BankAccount", bankAccountFormUI.Tbl_BankAccountId, bankAccountFormUI.ModifiedBy, newValue);
                }
    ...
    public int DeleteBankAccount(BankAccountFormUI bankAccountFormUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    audit_IUD.WebServiceDelete("tbl_BankAccount", bankAccountFormUI.Tbl_BankAccountId);
                }
                sqlCmd.Dispose();
                SupportCon.Close();
