...
/// </summary>
public class BankListDAL : IRequiresSessionState
{
    ...
    public DataTable GetBankListById(BankListUI bankListUI)
    {
        ...
        try
        {
            ...
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                ...
                audit_IUD.WebServiceSelectInsert("tbl_Bank",bankListUI.Tbl_BankId, selectedValue);
            }
        }
        catch (Exception exp)
        {
    ...
    public int DeleteBank(BankListUI bankListUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    audit_IUD.WebServiceDelete("tbl_Bank", bankListUI.Tbl_BankId);
                }
    ...
    public DataTable GetBankListBySearchParameters(BankListUI bankListUI)
    {
        ...
        try
        {
            ...
            if (ds.Tables.Count > 0)
                dtbl = ds.Tables[0];
            string record = dtbl.Rows[0]["tbl_BankId"].ToString();
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                string selectedValue;
                selectedValue = JsonConvert.SerializeObject(dtbl);
