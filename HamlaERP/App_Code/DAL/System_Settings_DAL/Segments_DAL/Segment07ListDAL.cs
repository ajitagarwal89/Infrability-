...
/// </summary>
public class Segment07ListDAL : IRequiresSessionState
{
    ...
    public DataTable GetSegment07ListById(Segment07ListUI segment07ListUI)
    {
        ...
        try
        {
            ...
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                ...
                audit_IUD.WebServiceSelectInsert("tbl_Segment07", segment07ListUI.Tbl_Segment07Id, selectedValue);
            }
        }
        catch (Exception exp)
        {
    ...
    public int DeleteSegment07(Segment07ListUI segment07ListUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    audit_IUD.WebServiceDelete("tbl_Segment07", segment07ListUI.Tbl_Segment07Id);
                }
                sqlCmd.Dispose();
                SupportCon.Close();
            }
