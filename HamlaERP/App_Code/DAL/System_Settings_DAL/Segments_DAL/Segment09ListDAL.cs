...
/// </summary>
public class Segment09ListDAL : IRequiresSessionState
{
    ...
    public DataTable GetSegment09ListById(Segment09ListUI segment09ListUI)
    {
        ...
        try
        {
            ...
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                ...
                audit_IUD.WebServiceSelectInsert("tbl_Segment09", segment09ListUI.Tbl_Segment09Id, selectedValue);
            }
        }
        catch (Exception exp)
        {
    ...
    public int DeleteSegment09(Segment09ListUI segment09ListUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    audit_IUD.WebServiceDelete("tbl_Segment09", segment09ListUI.Tbl_Segment09Id);
                }
                sqlCmd.Dispose();
                SupportCon.Close();
            }
