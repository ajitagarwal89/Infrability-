...
/// </summary>
public class Segment03ListDAL : IRequiresSessionState
{
    ...
    public DataTable GetSegment03ListById(Segment03ListUI segment03ListUI)
    {
        ...
        try
        {
            ...
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                ...
                audit_IUD.WebServiceSelectInsert("tbl_Segment03", segment03ListUI.Tbl_Segment03Id, selectedValue);
            }
        }
        catch (Exception exp)
        {
    ...
    public int DeleteSegment03(Segment03ListUI segment03ListUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    audit_IUD.WebServiceDelete("tbl_Segment03", segment03ListUI.Tbl_Segment03Id);
                }
                sqlCmd.Dispose();
                SupportCon.Close();
            }
