...
/// </summary>
public class FiscalPeriodListDAL : IRequiresSessionState
{
    ...
    public DataTable GetFiscalPeriodListById(FiscalPeriodListUI fiscalPeriodListUI)
    {
        ...
        try
        {
            ...
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                ...
                audit_IUD.WebServiceSelectInsert("tbl_FiscalPeriod", fiscalPeriodListUI.Tbl_FiscalPeriodId, selectedValue);
            }
        }
        catch (Exception exp)
        {
    ...
    public DataTable GetFiscalPeriodListBySearchParameters(FiscalPeriodListUI fiscalPeriodListUI)
    {
        ...
        try
        {
            ...
            if (ds.Tables.Count > 0)
                dtbl = ds.Tables[0];
            string recordId = dtbl.Rows[0]["tbl_FiscalPeriodId"].ToString();
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                string selectedValue;
                selectedValue = JsonConvert.SerializeObject(dtbl);
                audit_IUD.WebServiceSelectInsert("tbl_FiscalPeriod", recordId, selectedValue);
            }
    ...
    public int DeleteFiscalPeriod(FiscalPeriodListUI fiscalPeriodListUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    audit_IUD.WebServiceDelete("tbl_FiscalPeriod", fiscalPeriodListUI.Tbl_FiscalPeriodId);
                }
                sqlCmd.Dispose();
                SupportCon.Close();
            }
