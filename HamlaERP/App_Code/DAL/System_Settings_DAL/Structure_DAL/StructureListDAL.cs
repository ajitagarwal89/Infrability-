...
using Finware;
/// <summary>
/// Summary description for StructureListDAL
/// </summary>
public class StructureListDAL : IRequiresSessionState
{
    ...
    public StructureListDAL()
    {
        ...
        {
            logExcpUIobj.MethodName = "StructureListDAL()";
            logExcpUIobj.ResourceName = "StructureListDAL.CS";
            logExcpUIobj.RecordId = "";
            logExcpUIobj.ExceptionDetails = "Error Occured. System Generated Error is: " + exp.ToString();
            logExcpDALobj.SaveExceptionToDB(logExcpUIobj);

            throw new Exception("[StructureListDAL : StructureListDAL] ERROR: An error occured while connection to staging database. Please check the connection settings : [" + exp.ToString() + "]");
        }
    }
    ...
    public DataTable GetStructureList()
    {
        ...
        try
        {
            ...
            {
                SqlCommand sqlCmd = new SqlCommand("SP_Structure_Select", SupportCon);
        ...
        {
            logExcpUIobj.MethodName = "getStructureList()";
            logExcpUIobj.ResourceName = "StructureListDAL.CS";
            logExcpUIobj.RecordId = "";
            logExcpUIobj.ExceptionDetails = "Error Occured. System Generated Error is: " + exp.ToString();
            logExcpDALobj.SaveExceptionToDB(logExcpUIobj);

            log.Error("[StructureListDAL : getStructureList] An error occured in the processing of Record. Details : [" + exp.ToString() + "]");
        }
        finally
        {
            ds.Dispose();
    ...
    public DataTable GetStructureListForExportToExcel()
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                SqlCommand sqlCmd = new SqlCommand("SP_Structure_SelectExportToExcel", SupportCon);
                sqlCmd.CommandType = CommandType.StoredProcedure;
                sqlCmd.CommandTimeout = commandTimeout;
        ...
        {
            logExcpUIobj.MethodName = "GetStructureListForExportToExcel()";
            logExcpUIobj.ResourceName = "StructureListDAL.CS";
            logExcpUIobj.RecordId = "";
            logExcpUIobj.ExceptionDetails = "Error Occured. System Generated Error is: " + exp.ToString();
            logExcpDALobj.SaveExceptionToDB(logExcpUIobj);

            log.Error("[StructureListDAL : GetStructureListForExportToExcel] An error occured in the processing of Record. Details : [" + exp.ToString() + "]");
        }
        finally
        {
            ds.Dispose();
    ...
    public DataTable GetStructureListById(StructureListUI structureListUI)
    {
        ...
        try
        {
            ...
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                ...
                audit_IUD.WebServiceSelectInsert("tbl_Structure", structureListUI.Tbl_StructureId, selectedValue);
            }
        }
        catch (Exception exp)
        {
            ...
            log.Error("[StructureListDAL : getStructureListById] An error occured in the processing of Record Id : " + structureListUI.Tbl_StructureId + ". Details : [" + exp.ToString() + "]");
        }
        finally
        {
            ds.Dispose();
    ...
    public DataTable GetStructureListBySearchParameters(StructureListUI structureListUI)
    {
        ...
        try
        {
            ...
            if (ds.Tables.Count > 0)
                dtbl = ds.Tables[0];
            string recordId = dtbl.Rows[0]["tbl_StructureId"].ToString();
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                string selectedValue;
                selectedValue = JsonConvert.SerializeObject(dtbl);
                audit_IUD.WebServiceSelectInsert("tbl_Structure", recordId, selectedValue);
            }
        }
        catch (Exception exp)
        {
    ...
    public int DeleteStructure(StructureListUI structureListUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    audit_IUD.WebServiceDelete("tbl_Structure", structureListUI.Tbl_StructureId);
                }
                sqlCmd.Dispose();
                SupportCon.Close();
            }
