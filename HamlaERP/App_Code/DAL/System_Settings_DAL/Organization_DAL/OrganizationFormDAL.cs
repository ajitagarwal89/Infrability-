...
/// </summary>
public class OrganizationFormDAL : IRequiresSessionState
{
    ...
    public DataTable GetOrganizationListById(OrganizationFormUI organizationFormUI)
    {
        ...
        try
        {
            ...
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                ...
                audit_IUD.WebServiceSelectInsert("tbl_Organization", organizationFormUI.Tbl_OrganizationId, selectedValue);
            }
        }
        catch (Exception exp)
        {
    ...
    public int AddOrganization(OrganizationFormUI organizationFormUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                sqlCmd.Parameters["@tbl_CurrencyId"].Value = organizationFormUI.Tbl_CurrencyId;
                ...
                sqlCmd.Parameters.Add("@tbl_OrganizationId", SqlDbType.UniqueIdentifier);
                sqlCmd.Parameters["@tbl_OrganizationId"].Direction = ParameterDirection.Output;

                result = sqlCmd.ExecuteNonQuery();

                string RecoredID = Convert.ToString(sqlCmd.Parameters["@tbl_OrganizationId"].Value);

                if (SessionContext.GlobalAuditEnabledStatus == true)
                {

                    string tableName = "tbl_Organization";

                    sqlCmd.Dispose();
                    SupportCon.Close();
                    SerializeInputParameters obj = new SerializeInputParameters();
                    string newValue = obj.GetSerializedString(organizationFormUI);
                    audit_IUD.WebServiceInsert(SessionContext.OrganizationId, tableName, RecoredID, organizationFormUI.CreatedBy, newValue);
                    return 1;
                }
                else
                {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    SerializeInputParameters obj = new SerializeInputParameters();
                    string newValue = obj.GetSerializedString(organizationFormUI);
                    audit_IUD.WebServiceUpdate(organizationFormUI.Tbl_OrganizationId, "Tbl_Organization", organizationFormUI.Tbl_OrganizationId, organizationFormUI.ModifiedBy, newValue);
                }
                sqlCmd.Dispose();
                SupportCon.Close();
            }
    ...
    public int DeleteOrganization(OrganizationFormUI organizationFormUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    audit_IUD.WebServiceDelete("tbl_Organization", organizationFormUI.Tbl_OrganizationId);
                }
                sqlCmd.Dispose();
                SupportCon.Close();
            }
