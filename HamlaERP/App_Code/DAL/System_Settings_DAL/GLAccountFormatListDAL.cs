...
/// <summary>
/// Summary description for GLAccountFormatListDAL
/// </summary>
public class GLAccountFormatListDAL
{
    ...
    public GLAccountFormatListDAL()
    {
        ...
        {
            logExcpUIobj.MethodName = "GLAccountFormatListDAL()";
            logExcpUIobj.ResourceName = "GLAccountFormatListDAL.CS";
            logExcpUIobj.RecordId = "";
            logExcpUIobj.ExceptionDetails = "Error Occured. System Generated Error is: " + exp.ToString();
            logExcpDALobj.SaveExceptionToDB(logExcpUIobj);

            throw new Exception("[GLAccountFormatListDAL : GLAccountFormatListDAL] ERROR: An error occured while connection to staging database. Please check the connection settings : [" + exp.ToString() + "]");
        }
    }
    ...
    public DataTable GetGLAccountFormatList()
    {
        ...
        try
        {
            ...
            {
                SqlCommand sqlCmd = new SqlCommand("SP_GLAccountFormat_Select", SupportCon);
        ...
        {
            logExcpUIobj.MethodName = "getGLAccountFormatList()";
            logExcpUIobj.ResourceName = "GLAccountFormatListDAL.CS";
            logExcpUIobj.RecordId = "";
            logExcpUIobj.ExceptionDetails = "Error Occured. System Generated Error is: " + exp.ToString();
            logExcpDALobj.SaveExceptionToDB(logExcpUIobj);

            log.Error("[GLAccountFormatListDAL : getGLAccountFormatList] An error occured in the processing of Record. Details : [" + exp.ToString() + "]");
        }
        finally
        {
            ds.Dispose();
    ...
    public DataTable GetGLAccountFormatListBySearchParameters(GLAccountFormatListUI gLAccountFormatListUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                SqlCommand sqlCmd = new SqlCommand("SP_GLAccountFormat_SelectBySearchParameters", SupportCon);
                sqlCmd.CommandType = CommandType.StoredProcedure;
                sqlCmd.CommandTimeout = commandTimeout;

                sqlCmd.Parameters.Add("@Search", SqlDbType.NVarChar);
                sqlCmd.Parameters["@Search"].Value = gLAccountFormatListUI.Search;
        ...
        {
            logExcpUIobj.MethodName = "GetGLAccountFormatListBySearchParameters()";
            logExcpUIobj.ResourceName = "GLAccountFormatListDAL.CS";
            logExcpUIobj.RecordId = "Search = " + gLAccountFormatListUI.Search;
            logExcpUIobj.ExceptionDetails = "Error Occured. System Generated Error is: " + exp.ToString();
            logExcpDALobj.SaveExceptionToDB(logExcpUIobj);

            log.Error("[GLAccountFormatListDAL : GetGLAccountFormatListBySearchParameters] An error occured in the processing of Record Search = " + gLAccountFormatListUI.Search + " . Details : [" + exp.ToString() + "]");
        }
        finally
        {
            ds.Dispose();
