...
/// </summary>
public class OptionSetListDAL : IRequiresSessionState
{
    ...
    public DataTable GetOptionSetListById(OptionSetListUI optionSetListUI)
    {
        ...
        try
        {
            ...
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                ...
                audit_IUD.WebServiceSelectInsert("tbl_OptionSet", optionSetListUI.Tbl_OptionSetId, selectedValue);
            }
        }
        catch (Exception exp)
        {
    ...
    public int DeleteOptionSet(OptionSetListUI optionSetListUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    audit_IUD.WebServiceDelete("tbl_OptionSet", optionSetListUI.Tbl_OptionSetId);
                }
                sqlCmd.Dispose();
                SupportCon.Close();
            }
