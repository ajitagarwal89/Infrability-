...
/// </summary>
public class InvoiceAndOrderTypeListDAL : IRequiresSessionState
{
    ...
    public DataTable GetInvoiceAndOrderTypeListById(InvoiceAndOrderTypeListUI invoiceAndOrderTypeListUI)
    {
        ...
        try
        {
            ...
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                ...
                audit_IUD.WebServiceSelectInsert("tbl_InvoiceAndOrderType", invoiceAndOrderTypeListUI.Tbl_InvoiceAndOrderTypeId, selectedValue);
            }
        }
        catch (Exception exp)
        {
    ...
    public int DeleteInvoiceAndOrderType(InvoiceAndOrderTypeListUI invoiceAndOrderTypeListUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    audit_IUD.WebServiceDelete("tbl_InvoiceAndOrderType", invoiceAndOrderTypeListUI.Tbl_InvoiceAndOrderTypeId);
                }
                sqlCmd.Dispose();
                SupportCon.Close();
            }
