...
public class GoodsReceivedNoteFormDAL
{
    ...
    public int AddGoodsReceivedNote(GoodsReceivedNoteFormUI goodsReceivedNoteFormUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                sqlCmd.Parameters["@tbl_POId"].Value = goodsReceivedNoteFormUI.Tbl_POId;
                ...
                sqlCmd.Parameters.Add("@tbl_GoodsReceivedNoteId", SqlDbType.UniqueIdentifier);
                sqlCmd.Parameters["@tbl_GoodsReceivedNoteId"].Direction = ParameterDirection.Output;


                result = sqlCmd.ExecuteNonQuery();
                string recordId = Convert.ToString(sqlCmd.Parameters["@tbl_GoodsReceivedNoteId"].Value);
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    sqlCmd.Dispose();
                    SupportCon.Close();
                    SerializeInputParameters obj = new SerializeInputParameters();
                    string newValue = obj.GetSerializedString(goodsReceivedNoteFormUI);
                    audit_IUD.WebServiceInsert(goodsReceivedNoteFormUI.Tbl_OrganizationId,"tbl_GoodsReceivedNote", recordId, goodsReceivedNoteFormUI.CreatedBy, newValue);
                    return 1;
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    SerializeInputParameters obj = new SerializeInputParameters();
                    string newValue = obj.GetSerializedString(goodsReceivedNoteFormUI);
                    audit_IUD.WebServiceUpdate(goodsReceivedNoteFormUI.Tbl_OrganizationId, "tbl_GoodsReceivedNote", goodsReceivedNoteFormUI.Tbl_GoodsReceivedNoteId, goodsReceivedNoteFormUI.ModifiedBy, newValue);
                }
    ...
    public int DeleteGoodsReceivedNote(GoodsReceivedNoteFormUI goodsReceivedNoteFormUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    audit_IUD.WebServiceDelete("tbl_GoodsReceivedNote", goodsReceivedNoteFormUI.Tbl_GoodsReceivedNoteId);
                }
    ...
    public int UpdatePostingGoodsReceivedNote(GoodsReceivedNoteFormUI goodsReceivedNoteFormUI)
    {
        ...
        try
        {
            ...
            {
                SupportCon.Open();
                SqlCommand sqlCmd = new SqlCommand("SP_GoodsReceivedNote_UpdatePosting", SupportCon);
                sqlCmd.CommandType = CommandType.StoredProcedure;
                sqlCmd.CommandTimeout = commandTimeout;
                ...
                sqlCmd.Parameters["@IsPosted"].Value = goodsReceivedNoteFormUI.IsPosted;
        ...
        {
            logExcpUIobj.MethodName = "UpdatePostingGoodsReceivedNote()";
            logExcpUIobj.ResourceName = "GoodsReceivedNoteFormDAL.CS";
            logExcpUIobj.RecordId = goodsReceivedNoteFormUI.Tbl_GoodsReceivedNoteId;
            logExcpUIobj.ExceptionDetails = "Error Occured. System Generated Error is: " + exp.ToString();
            logExcpDALobj.SaveExceptionToDB(logExcpUIobj);
            log.Error("[GoodsReceivedNoteFormDAL : UpdatePostingGoodsReceivedNote] An error occured in the processing of Record Id : " + goodsReceivedNoteFormUI.Tbl_GoodsReceivedNoteId + ". Details : [" + exp.ToString() + "]");
        }
