...
/// </summary>
public class GLAccountSummaryDetailsListDAL : IRequiresSessionState
{
    ...
    public DataTable GetGLAccountSummaryDetailsListById(GLAccountSummaryDetailsListUI gLAccountSummaryDetailsListUI)
    {
        ...
        try
        {
            ...
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                ...
                audit_IUD.WebServiceSelectInsert("tbl_GLAccountSummaryDetails", gLAccountSummaryDetailsListUI.Tbl_GLAccountSummaryDetailsId, selectedValue);
            }
        }
        catch (Exception exp)
        {
    ...
    public DataTable GetGLAccountSummaryDetailsListBySearchParameters(GLAccountSummaryDetailsListUI gLAccountSummaryDetailsListUI)
    {
        ...
        try
        {
            ...
            string recordId = dtbl.Rows[0]["tbl_GLAccountSummaryDetailsId"].ToString();
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                string selectedValue;
                selectedValue = JsonConvert.SerializeObject(dtbl);
                audit_IUD.WebServiceSelectInsert("tbl_GLAccountSummaryDetails", recordId, selectedValue);
            }
        }
        catch (Exception exp)
        {
    ...
    public int DeleteGLAccountSummaryDetails(GLAccountSummaryDetailsListUI gLAccountSummaryDetailsListUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    audit_IUD.WebServiceDelete("tbl_GLAccountSummaryDetails", gLAccountSummaryDetailsListUI.Tbl_GLAccountSummaryDetailsId);
                }
                sqlCmd.Dispose();
                SupportCon.Close();
            }
