...
/// </summary>
public class GLAccountCurrencyListDAL : IRequiresSessionState
{
    ...
    public DataTable GetGLAccountCurrencyListById(GLAccountCurrencyListUI gLAccountCurrencyListUI)
    {
        ...
        try
        {
            ...
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                ...
                audit_IUD.WebServiceSelectInsert("tbl_GLAccountCurrency", gLAccountCurrencyListUI.Tbl_GLAccountCurrencyId, selectedValue);
            }
        }
        catch (Exception exp)
        {
    ...
    public DataTable GetGLAccountCurrencyListBySearchParameters(GLAccountCurrencyListUI gLAccountCurrencyListUI)
    {
        ...
        try
        {
            ...
            if (ds.Tables.Count > 0)
                dtbl = ds.Tables[0];
            string recordId = dtbl.Rows[0]["tbl_GLAccountCurrencyId"].ToString();
            
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                string selectedValue;
                selectedValue = JsonConvert.SerializeObject(dtbl);
                audit_IUD.WebServiceSelectInsert("tbl_GLAccountCurrency", recordId, selectedValue);
            }
        }
        catch (Exception exp)
        {
    ...
    public int DeleteGLAccountCurrency(GLAccountCurrencyListUI gLAccountCurrencyListUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    audit_IUD.WebServiceDelete("tbl_GLAccountCurrency", gLAccountCurrencyListUI.Tbl_GLAccountCurrencyId);
                }
                sqlCmd.Dispose();
                SupportCon.Close();
            }
