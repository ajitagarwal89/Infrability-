...
/// </summary>
public class CustomerInvoiceFormDAL : IRequiresSessionState
{
    ...
    public DataTable GetCustomerInvoiceListById(CustomerInvoiceFormUI customerInvoiceFormUI)
    {
        ...
        try
        {
            ...
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                ...
                audit_IUD.WebServiceSelectInsert("tbl_CustomerInvoice", customerInvoiceFormUI.Tbl_CustomerInvoiceId, selectedValue);
            }
        }
        catch (Exception exp)
        {
    ...
    public int AddCustomerInvoice(CustomerInvoiceFormUI customerInvoiceFormUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                sqlCmd.Parameters.Add("@tbl_CustomerInvoiceID", SqlDbType.UniqueIdentifier);
                sqlCmd.Parameters["@tbl_CustomerInvoiceID"].Direction = ParameterDirection.Output;


                result = sqlCmd.ExecuteNonQuery();


                string RecoredID = Convert.ToString(sqlCmd.Parameters["@tbl_CustomerInvoiceId"].Value);

                if (SessionContext.GlobalAuditEnabledStatus == true)
                {

                    string tableName = "tbl_CustomerInvoice";

                    sqlCmd.Dispose();
                    SupportCon.Close();
                    SerializeInputParameters obj = new SerializeInputParameters();
                    string newValue = obj.GetSerializedString(customerInvoiceFormUI);
                    audit_IUD.WebServiceInsert(customerInvoiceFormUI.Tbl_OrganizationId, tableName, RecoredID, customerInvoiceFormUI.CreatedBy, newValue);
                    return 1;
                }
                else
                {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    SerializeInputParameters obj = new SerializeInputParameters();
                    string newValue = obj.GetSerializedString(customerInvoiceFormUI);
                    audit_IUD.WebServiceUpdate(customerInvoiceFormUI.Tbl_OrganizationId, "tbl_CustomerInvoice", customerInvoiceFormUI.Tbl_CustomerInvoiceId, customerInvoiceFormUI.ModifiedBy, newValue);
                }
    ...
    public int DeleteCustomerInvoice(CustomerInvoiceFormUI customerInvoiceFormUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    audit_IUD.WebServiceDelete("tbl_CustomerInvoice", customerInvoiceFormUI.Tbl_CustomerInvoiceId);
                }
                sqlCmd.Dispose();
                SupportCon.Close();
            }
    ...
    public int UpdatePostingCustomerInvoice(CustomerInvoiceFormUI customerInvoiceFormUI)
    {
        ...
        try
        {
            ...
            {
                SupportCon.Open();
                SqlCommand sqlCmd = new SqlCommand("SP_CustomerInvoice_UpdatePosting", SupportCon);
                sqlCmd.CommandType = CommandType.StoredProcedure;
                sqlCmd.CommandTimeout = commandTimeout;
                ...
                sqlCmd.Parameters["@IsPosted"].Value = customerInvoiceFormUI.IsPosted;
        ...
        {
            logExcpUIobj.MethodName = "UpdatePostingCustomerInvoice()";
            logExcpUIobj.ResourceName = "CustomerInvoiceFormDAL.CS";
            logExcpUIobj.RecordId = customerInvoiceFormUI.Tbl_CustomerInvoiceId;
            logExcpUIobj.ExceptionDetails = "Error Occured. System Generated Error is: " + exp.ToString();
            logExcpDALobj.SaveExceptionToDB(logExcpUIobj);
            log.Error("[CustomerInvoiceFormDAL : UpdatePostingCustomerInvoice] An error occured in the processing of Record Id : " + customerInvoiceFormUI.Tbl_CustomerInvoiceId + ". Details : [" + exp.ToString() + "]");
        }
    ...
    public DataTable GetSerialNumber(CustomerInvoiceFormUI customerInvoiceFormUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                SqlCommand sqlCmd = new SqlCommand("SP_CustomerInvoice_SerialNumber", SupportCon);
                sqlCmd.CommandType = CommandType.StoredProcedure;
                sqlCmd.CommandTimeout = commandTimeout;
                sqlCmd.Parameters.Add("@RecordType", SqlDbType.TinyInt);
                sqlCmd.Parameters["@RecordType"].Value = customerInvoiceFormUI.InvoiceType;
        ...
        catch (Exception exp)
        {
            ...
            log.Error("[CustomerInvoiceFormDAL : GetSerialNumber] An error occured in the processing of Record Id : " + customerInvoiceFormUI.Tbl_CustomerInvoiceId + ". Details : [" + exp.ToString() + "]");
        }
        finally
        {
            ds.Dispose();
