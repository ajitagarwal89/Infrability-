...
/// </summary>
public class AssetBookSetupListDAL : IRequiresSessionState
{
    ...
    public DataTable GetAssetBookSetupListById(AssetBookSetupListUI assetBookSetupListUI)
    {
        ...
        try
        {
            ...
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                ...
                audit_IUD.WebServiceSelectInsert("tbl_AssetBookSetup", assetBookSetupListUI.Tbl_AssetBookSetupId, selectedValue);
            }
        }
        catch (Exception exp)
        {
    ...
    public int DeleteAssetBookSetup(AssetBookSetupListUI assetBookSetupListUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    audit_IUD.WebServiceDelete("tbl_AssetBookSetup", assetBookSetupListUI.Tbl_AssetBookSetupId);
                }
