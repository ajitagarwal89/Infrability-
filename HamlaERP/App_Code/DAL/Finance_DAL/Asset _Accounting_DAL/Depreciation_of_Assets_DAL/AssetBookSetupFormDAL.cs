...
/// </summary>
public class AssetBookSetupFormDAL : IRequiresSessionState
{
    ...
    public DataTable GetAssetBookSetupListById(AssetBookSetupFormUI assetBookSetupFormUI)
    {
        ...
        try
        {
            ...
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                ...
                audit_IUD.WebServiceSelectInsert("tbl_AssetBookSetup", assetBookSetupFormUI.Tbl_AssetBookSetupId, selectedValue);
            }
        }
        catch (Exception exp)
        {
    ...
    public int AddAssetBookSetup(AssetBookSetupFormUI assetBookSetupFormUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                sqlCmd.Parameters.Add("@tbl_AssetBookSetupID", SqlDbType.UniqueIdentifier);
                sqlCmd.Parameters["@tbl_AssetBookSetupID"].Direction = ParameterDirection.Output;



                result = sqlCmd.ExecuteNonQuery();
                string RecoredID = Convert.ToString(sqlCmd.Parameters["@tbl_AssetBookSetupId"].Value);

                if (SessionContext.GlobalAuditEnabledStatus == true)
                {

                    string tableName = "tbl_AssetBookSetup";

                    sqlCmd.Dispose();
                    SupportCon.Close();
                    SerializeInputParameters obj = new SerializeInputParameters();
                    string newValue = obj.GetSerializedString(assetBookSetupFormUI);
                    audit_IUD.WebServiceInsert(assetBookSetupFormUI.Tbl_OrganizationId, tableName, RecoredID, assetBookSetupFormUI.CreatedBy, newValue);
                    return 1;
                }
                else
                {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    SerializeInputParameters obj = new SerializeInputParameters();
                    string newValue = obj.GetSerializedString(assetBookSetupFormUI);
                    audit_IUD.WebServiceUpdate(assetBookSetupFormUI.Tbl_OrganizationId, "tbl_AssetBookSetup", assetBookSetupFormUI.Tbl_AssetBookSetupId, assetBookSetupFormUI.ModifiedBy, newValue);
                }
    ...
    public int DeleteAssetBookSetup(AssetBookSetupFormUI assetBookSetupFormUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    audit_IUD.WebServiceDelete("tbl_AssetBookSetup", assetBookSetupFormUI.Tbl_AssetBookSetupId);
                }
