...
/// </summary>
public class AssetPurchaseDetailsFormDAL : IRequiresSessionState
{
    ...
    public DataTable GetAssetPurchaseDetailsListById(AssetPurchaseDetailsFormUI assetPurchaseDetailsFormUI)
    {
        ...
        try
        {
            ...
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                ...
                audit_IUD.WebServiceSelectInsert("tbl_AssetPurchaseDetails", assetPurchaseDetailsFormUI.Tbl_AssetPurchaseDetailsId, selectedValue);
            }
   ...
   public int AddAssetPurchaseDetails(AssetPurchaseDetailsFormUI assetPurchaseDetailsFormUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                sqlCmd.Parameters["@tbl_POId"].Value = assetPurchaseDetailsFormUI.Tbl_PONumberId;
                ...
                sqlCmd.Parameters.Add("@tbl_AssetPurchaseDetailsId", SqlDbType.UniqueIdentifier);
                sqlCmd.Parameters["@tbl_AssetPurchaseDetailsId"].Direction = ParameterDirection.Output;

                result = sqlCmd.ExecuteNonQuery();

                string RecoredID = Convert.ToString(sqlCmd.Parameters["@tbl_AssetPurchaseDetailsId"].Value);

                if (SessionContext.GlobalAuditEnabledStatus == true)
                {

                    string tableName = "tbl_AssetPurchaseDetails";

                    sqlCmd.Dispose();
                    SupportCon.Close();
                    SerializeInputParameters obj = new SerializeInputParameters();
                    string newValue = obj.GetSerializedString(assetPurchaseDetailsFormUI);
                    audit_IUD.WebServiceInsert(assetPurchaseDetailsFormUI.Tbl_OrganizationId, tableName, RecoredID, assetPurchaseDetailsFormUI.CreatedBy, newValue);
                    return 1;
                }
                else
                {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    SerializeInputParameters obj = new SerializeInputParameters();
                    string newValue = obj.GetSerializedString(assetPurchaseDetailsFormUI);
                    audit_IUD.WebServiceUpdate(assetPurchaseDetailsFormUI.Tbl_OrganizationId, "tbl_AssetPurchaseDetails", assetPurchaseDetailsFormUI.Tbl_AssetPurchaseDetailsId, assetPurchaseDetailsFormUI.ModifiedBy, newValue);
                }
                sqlCmd.Dispose();
                SupportCon.Close();
            }
    ...
    public int DeleteAssetPurchaseDetails(AssetPurchaseDetailsFormUI assetPurchaseDetailsFormUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    audit_IUD.WebServiceDelete("tbl_AssetPurchaseDetails", assetPurchaseDetailsFormUI.Tbl_AssetPurchaseDetailsId);
                }
                sqlCmd.Dispose();
                SupportCon.Close();
            }
