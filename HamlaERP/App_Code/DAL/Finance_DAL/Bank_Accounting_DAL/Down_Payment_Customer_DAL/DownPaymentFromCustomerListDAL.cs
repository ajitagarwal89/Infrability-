...
/// </summary>
public class DownPaymentFromCustomerListDAL : IRequiresSessionState
{
    ...
    public DataTable GetDownPaymentFromCustomerListById(DownPaymentFromCustomerListUI downPaymentFromCustomerListUI)
    {
        ...
        try
        {
            ...
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                ...
                audit_IUD.WebServiceSelectInsert("tbl_DownPaymentFromCustomer", downPaymentFromCustomerListUI.Tbl_DownPaymentFromCustomerId, selectedValue);
            }
        }
        catch (Exception exp)
        {
    ...
    public int DeleteDownPaymentFromCustomer(DownPaymentFromCustomerListUI downPaymentFromCustomerListUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    audit_IUD.WebServiceDelete("tbl_DownPaymentFromCustomer", downPaymentFromCustomerListUI.Tbl_DownPaymentFromCustomerId);
                }
                sqlCmd.Dispose();
                SupportCon.Close();
            }
