...
/// </summary>
public class DownPaymentFromCustomerApplyListDAL : IRequiresSessionState
{
    ...
    public DataTable GetDownPaymentFromCustomerApplyListById(DownPaymentFromCustomerApplyListUI downPaymentFromCustomerApplyListUI)
    {
        ...
        try
        {
            ...
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                ...
                audit_IUD.WebServiceSelectInsert("tbl_DownPaymentFromCustomerApply", downPaymentFromCustomerApplyListUI.Tbl_DownPaymentFromCustomerApplyId, selectedValue);
            }
        }
        catch (Exception exp)
        {
    ...
    public int DeleteDownPaymentFromCustomerApply(DownPaymentFromCustomerApplyListUI downPaymentFromCustomerApplyListUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    audit_IUD.WebServiceDelete("tbl_DownPaymentFromCustomerApply", downPaymentFromCustomerApplyListUI.Tbl_DownPaymentFromCustomerApplyId);
                }
                sqlCmd.Dispose();
                SupportCon.Close();
            }
