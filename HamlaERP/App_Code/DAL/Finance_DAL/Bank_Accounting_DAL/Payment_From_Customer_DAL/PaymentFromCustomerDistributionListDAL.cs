...
/// </summary>
public class PaymentFromCustomerDistributionListDAL : IRequiresSessionState
{
    ...
    public DataTable GetPaymentFromCustomerDistributionListById(PaymentFromCustomerDistributionListUI PaymentFromCustomerDistributionListUI)
    {
        ...
        try
        {
            ...
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                ...
                audit_IUD.WebServiceSelectInsert("tbl_PaymentFromCustomerDistribution", PaymentFromCustomerDistributionListUI.Tbl_PaymentFromCustomerDistributionId, selectedValue);
            }
        }
        catch (Exception exp)
        {
    ...
    public int DeletePaymentFromCustomerDistribution(PaymentFromCustomerDistributionListUI PaymentFromCustomerDistributionListUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    audit_IUD.WebServiceDelete("tbl_PaymentFromCustomerDistribution", PaymentFromCustomerDistributionListUI.Tbl_PaymentFromCustomerDistributionId);
                }
                sqlCmd.Dispose();
                SupportCon.Close();
            }
