...
/// </summary>
public class PaymentFromCustomerApplyListDAL : IRequiresSessionState
{
    ...
    public DataTable GetPaymentFromCustomerApplyListById(PaymentFromCustomerApplyListUI PaymentFromCustomerApplyListUI)
    {
        ...
        try
        {
            ...
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                ...
                audit_IUD.WebServiceSelectInsert("tbl_PaymentFromCustomerApply", PaymentFromCustomerApplyListUI.Tbl_PaymentFromCustomerApplyId, selectedValue);
            }
        }
        catch (Exception exp)
        {
    ...
    public int DeletePaymentFromCustomerApply(PaymentFromCustomerApplyListUI PaymentFromCustomerApplyListUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    audit_IUD.WebServiceDelete("tbl_PaymentFromCustomerApply", PaymentFromCustomerApplyListUI.Tbl_PaymentFromCustomerApplyId);
                }
                sqlCmd.Dispose();
                SupportCon.Close();
            }
