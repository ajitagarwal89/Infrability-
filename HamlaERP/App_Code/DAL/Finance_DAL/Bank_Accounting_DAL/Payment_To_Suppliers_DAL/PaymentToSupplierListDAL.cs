...
/// </summary>
public class PaymentToSupplierListDAL : IRequiresSessionState
{
    ...
    public DataTable GetPaymentToSupplierListById(PaymentToSupplierListUI paymentToSupplierListUI)
    {
        ...
        try
        {
            ...
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                ...
                audit_IUD.WebServiceSelectInsert("tbl_PaymentToSupplier", paymentToSupplierListUI.Tbl_PaymentToSupplierId, selectedValue);
            }
        }
        catch (Exception exp)
        {
    ...
    public int DeletePaymentToSupplier(PaymentToSupplierListUI paymentToSupplierListUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    audit_IUD.WebServiceDelete("tbl_PaymentToSupplier", paymentToSupplierListUI.Tbl_PaymentToSupplierId);
                }
                sqlCmd.Dispose();
                SupportCon.Close();
            }
