...
/// </summary>
public class PaymentToSupplierApplyFormDAL : IRequiresSessionState
{
    ...
    public DataTable GetPaymentToSupplierApplyListById(PaymentToSupplierApplyFormUI PaymentToSupplierApplyFormUI)
    {
        ...
        try
        {
            ...
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                ...
                audit_IUD.WebServiceSelectInsert("tbl_PaymentToSupplierApply", PaymentToSupplierApplyFormUI.Tbl_PaymentToSupplierApplyId, selectedValue);
            }
        }
        catch (Exception exp)
        {
    ...
    public int AddPaymentToSupplierApply(PaymentToSupplierApplyFormUI PaymentToSupplierApplyFormUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                sqlCmd.Parameters.Add("@Tbl_PaymentToSupplierApplyId", SqlDbType.UniqueIdentifier);
                sqlCmd.Parameters["@Tbl_PaymentToSupplierApplyId"].Direction = ParameterDirection.Output;

                result = sqlCmd.ExecuteNonQuery();

                string RecoredID = Convert.ToString(sqlCmd.Parameters["@Tbl_PaymentToSupplierApplyId"].Value);

                if (SessionContext.GlobalAuditEnabledStatus == true)
                {

                    string tableName = "tbl_PaymentToSupplierApply";

                    sqlCmd.Dispose();
                    SupportCon.Close();
                    SerializeInputParameters obj = new SerializeInputParameters();
                    string newValue = obj.GetSerializedString(PaymentToSupplierApplyFormUI);
                    audit_IUD.WebServiceInsert(PaymentToSupplierApplyFormUI.Tbl_OrganizationId, tableName, RecoredID, PaymentToSupplierApplyFormUI.CreatedBy, newValue);
                    return 1;
                }
                else
                {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    SerializeInputParameters obj = new SerializeInputParameters();
                    string newValue = obj.GetSerializedString(PaymentToSupplierApplyFormUI);
                    audit_IUD.WebServiceUpdate(PaymentToSupplierApplyFormUI.Tbl_OrganizationId, "tbl_PaymentToSupplierApply", PaymentToSupplierApplyFormUI.Tbl_PaymentToSupplierApplyId, PaymentToSupplierApplyFormUI.ModifiedBy, newValue);
                }
                sqlCmd.Dispose();
                SupportCon.Close();
            }
    ...
    public int DeletePaymentToSupplierApply(PaymentToSupplierApplyFormUI PaymentToSupplierApplyFormUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    audit_IUD.WebServiceDelete("tbl_PaymentToSupplierApply", PaymentToSupplierApplyFormUI.Tbl_PaymentToSupplierApplyId);
                }
                sqlCmd.Dispose();
                SupportCon.Close();
            }
