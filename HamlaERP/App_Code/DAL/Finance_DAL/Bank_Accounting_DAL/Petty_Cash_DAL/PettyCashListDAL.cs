...
/// </summary>
public class PettyCashListDAL : IRequiresSessionState
{
    ...
    public DataTable GetPettyCashListById(PettyCashListUI pettyCashListUI)
    {
        ...
        try
        {
            ...
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                ...
                audit_IUD.WebServiceSelectInsert("tbl_PettyCash", pettyCashListUI.Tbl_PettyCashId, selectedValue);
            }
        }
        catch (Exception exp)
        {
    ...
    public int DeletePettyCash(PettyCashListUI pettyCashListUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    audit_IUD.WebServiceDelete("tbl_PettyCash", pettyCashListUI.Tbl_PettyCashId);
                }
                sqlCmd.Dispose();
                SupportCon.Close();
            }
