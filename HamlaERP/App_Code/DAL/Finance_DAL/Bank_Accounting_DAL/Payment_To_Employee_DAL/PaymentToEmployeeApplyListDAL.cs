...
/// </summary>
public class PaymentToEmployeeApplyListDAL : IRequiresSessionState
{
    ...
    public DataTable GetPaymentToEmployeeApplyListById(PaymentToEmployeeApplyListUI PaymentToEmployeeApplyListUI)
    {
        ...
        try
        {
            ...
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                ...
                audit_IUD.WebServiceSelectInsert("tbl_PaymentToEmployeeApply", PaymentToEmployeeApplyListUI.Tbl_PaymentToEmployeeApplyId, selectedValue);
            }
        }
        catch (Exception exp)
        {
    ...
    public int DeletePaymentToEmployeeApply(PaymentToEmployeeApplyListUI PaymentToEmployeeApplyListUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    audit_IUD.WebServiceDelete("tbl_PaymentToEmployeeApply", PaymentToEmployeeApplyListUI.Tbl_PaymentToEmployeeApplyId);
                }
                sqlCmd.Dispose();
                SupportCon.Close();
            }
