...
/// </summary>
public class PaymentToEmployeeApplyFormDAL : IRequiresSessionState
{
    ...
    public DataTable GetPaymentToEmployeeApplyListById(PaymentToEmployeeApplyFormUI PaymentToEmployeeApplyFormUI)
    {
        ...
        try
        {
            ...
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                ...
                audit_IUD.WebServiceSelectInsert("tbl_PaymentToEmployeeApply", PaymentToEmployeeApplyFormUI.Tbl_PaymentToEmployeeApplyId, selectedValue);
            }
        }
        catch (Exception exp)
        {
    ...
    public int AddPaymentToEmployeeApply(PaymentToEmployeeApplyFormUI PaymentToEmployeeApplyFormUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                sqlCmd.Parameters.Add("@tbl_PaymentToEmployeeApplyId", SqlDbType.UniqueIdentifier);
                sqlCmd.Parameters["@tbl_PaymentToEmployeeApplyId"].Direction = ParameterDirection.Output;

                result = sqlCmd.ExecuteNonQuery();

                string RecoredID = Convert.ToString(sqlCmd.Parameters["@tbl_PaymentToEmployeeApplyId"].Value);

                if (SessionContext.GlobalAuditEnabledStatus == true)
                {

                    string tableName = "tbl_PaymentToEmployeeApply";

                    sqlCmd.Dispose();
                    SupportCon.Close();
                    SerializeInputParameters obj = new SerializeInputParameters();
                    string newValue = obj.GetSerializedString(PaymentToEmployeeApplyFormUI);
                    audit_IUD.WebServiceInsert(PaymentToEmployeeApplyFormUI.Tbl_OrganizationId, tableName, RecoredID, PaymentToEmployeeApplyFormUI.CreatedBy, newValue);
                    return 1;
                }
                else
                {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    SerializeInputParameters obj = new SerializeInputParameters();
                    string newValue = obj.GetSerializedString(PaymentToEmployeeApplyFormUI);
                    audit_IUD.WebServiceUpdate(PaymentToEmployeeApplyFormUI.Tbl_OrganizationId, "tbl_PaymentToEmployeeApply", PaymentToEmployeeApplyFormUI.Tbl_PaymentToEmployeeApplyId, PaymentToEmployeeApplyFormUI.ModifiedBy, newValue);
                }
                sqlCmd.Dispose();
                SupportCon.Close();
            }
    ...
    public int DeletePaymentToEmployeeApply(PaymentToEmployeeApplyFormUI PaymentToEmployeeApplyFormUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    audit_IUD.WebServiceDelete("tbl_PaymentToEmployeeApply", PaymentToEmployeeApplyFormUI.Tbl_PaymentToEmployeeApplyId);
                }
                sqlCmd.Dispose();
                SupportCon.Close();
            }
