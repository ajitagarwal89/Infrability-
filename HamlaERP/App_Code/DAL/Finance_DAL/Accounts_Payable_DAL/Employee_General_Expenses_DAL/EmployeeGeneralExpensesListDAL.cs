...
/// </summary>
public class EmployeeGeneralExpensesListDAL : IRequiresSessionState
{
    ...
    public DataTable GetEmployeeGeneralExpensesListById(EmployeeGeneralExpensesListUI employeeGeneralExpensesListUI)
    {
        ...
        try
        {
            ...
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                ...
                audit_IUD.WebServiceSelectInsert("tbl_EmployeeGeneralExpenses", employeeGeneralExpensesListUI.Tbl_EmployeeGeneralExpensesId, selectedValue);
            }
        }
        catch (Exception exp)
        {
    ...
    public DataTable GetEmployeeGeneralExpensesListBySearchParameters(EmployeeGeneralExpensesListUI employeeGeneralExpensesListUI)
    {
        ...
        try
        {
            ...
            if (ds.Tables.Count > 0)
                dtbl = ds.Tables[0];
            string recordId = dtbl.Rows[0]["tbl_EmployeeGeneralExpensesId"].ToString(); 
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                string selectedValue;
                selectedValue = JsonConvert.SerializeObject(dtbl);
                audit_IUD.WebServiceSelectInsert("tbl_EmployeeGeneralExpenses", recordId, selectedValue);
            }
    ...
    public int DeleteEmployeeGeneralExpenses(EmployeeGeneralExpensesListUI employeeGeneralExpensesListUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    audit_IUD.WebServiceDelete("tbl_EmployeeGeneralExpenses", employeeGeneralExpensesListUI.Tbl_EmployeeGeneralExpensesId);
                }
                sqlCmd.Dispose();
                SupportCon.Close();
            }
