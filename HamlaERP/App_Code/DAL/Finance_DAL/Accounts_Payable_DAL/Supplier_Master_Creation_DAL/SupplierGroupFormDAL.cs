...
/// </summary>
public class SupplierGroupFormDAL : IRequiresSessionState
{
    ...
    public DataTable GetSupplierGroupListById(SupplierGroupFormUI supplierGroupFormUI)
    {
        ...
        try
        {
            ...
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                ...
                audit_IUD.WebServiceSelectInsert("tbl_SupplierGroup", supplierGroupFormUI.Tbl_SupplierGroupId, selectedValue);
            }
    ...
    public int AddSupplierGroup(SupplierGroupFormUI supplierGroupFormUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                sqlCmd.Parameters.Add("@tbl_SupplierGroupId", SqlDbType.UniqueIdentifier);
                sqlCmd.Parameters["@tbl_SupplierGroupId"].Direction = ParameterDirection.Output;

                result = sqlCmd.ExecuteNonQuery();

                string RecoredID = Convert.ToString(sqlCmd.Parameters["@tbl_SupplierGroupId"].Value);

                if (SessionContext.GlobalAuditEnabledStatus == true)
                {

                    string tableName = "tbl_SupplierGroup";

                    sqlCmd.Dispose();
                    SupportCon.Close();
                    SerializeInputParameters obj = new SerializeInputParameters();
                    string newValue = obj.GetSerializedString(supplierGroupFormUI);
                    audit_IUD.WebServiceInsert(supplierGroupFormUI.Tbl_OrganizationId, tableName, RecoredID, supplierGroupFormUI.CreatedBy, newValue);
                    return 1;
                }
                else
                {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    SerializeInputParameters obj = new SerializeInputParameters();
                    string newValue = obj.GetSerializedString(supplierGroupFormUI);
                    audit_IUD.WebServiceUpdate(supplierGroupFormUI.Tbl_OrganizationId, "tbl_SupplierGroup", supplierGroupFormUI.Tbl_SupplierGroupId, supplierGroupFormUI.ModifiedBy, newValue);
                }
                sqlCmd.Dispose();
                SupportCon.Close();
            }
    ...
    public int DeleteSupplierGroup(SupplierGroupFormUI supplierGroupFormUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    audit_IUD.WebServiceDelete("tbl_SupplierGroup", supplierGroupFormUI.Tbl_SupplierGroupId);
                }
                sqlCmd.Dispose();
                SupportCon.Close();
            }
