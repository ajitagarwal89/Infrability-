...
/// </summary>
public class NonPOBasedInvoiceFormDAL : IRequiresSessionState
{
    ...
    public DataTable GetNonPOBasedInvoiceListById(NonPOBasedInvoiceFormUI nonPOBasedInvoiceFormUI)
    {
        ...
        try
        {
            ...
            if (SessionContext.GlobalAuditEnabledStatus == true)
            {
                ...
                audit_IUD.WebServiceSelectInsert("tbl_NonPOBasedInvoice", nonPOBasedInvoiceFormUI.Tbl_NonPOBasedInvoiceId, selectedValue);
            }
        }
        catch (Exception exp)
        {
    ...
    public DataTable GetSerialNumber(NonPOBasedInvoiceFormUI nonPOBasedInvoiceFormUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                SqlCommand sqlCmd = new SqlCommand("SP_NonPOBasedInvoice_SerialNumber", SupportCon);
                sqlCmd.CommandType = CommandType.StoredProcedure;
                sqlCmd.CommandTimeout = commandTimeout;
                sqlCmd.Parameters.Add("@RecordType", SqlDbType.TinyInt);
                sqlCmd.Parameters["@RecordType"].Value = nonPOBasedInvoiceFormUI.InvoiceType;
        ...
        catch (Exception exp)
        {
            ...
            log.Error("[NonPOBasedInvoiceFormDAL : GetSerialNumber] An error occured in the processing of Record Id : " + nonPOBasedInvoiceFormUI.Tbl_NonPOBasedInvoiceId + ". Details : [" + exp.ToString() + "]");
        }
        finally
        {
            ds.Dispose();
    ...
    public int AddNonPOBasedInvoice(NonPOBasedInvoiceFormUI nonPOBasedInvoiceFormUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                sqlCmd.Parameters["@Opt_PayablesType"].Value = nonPOBasedInvoiceFormUI.Opt_PayablesType;
                ...
                sqlCmd.Parameters.Add("@tbl_NonPOBasedInvoiceId", SqlDbType.UniqueIdentifier);
                sqlCmd.Parameters["@tbl_NonPOBasedInvoiceId"].Direction = ParameterDirection.Output;

                result = sqlCmd.ExecuteNonQuery();

                string recordID = Convert.ToString(sqlCmd.Parameters["@tbl_NonPOBasedInvoiceId"].Value);

                if (SessionContext.GlobalAuditEnabledStatus == true)
                {

                    string tableName = "tbl_NonPOBasedInvoice";

                    sqlCmd.Dispose();
                    SupportCon.Close();
                    SerializeInputParameters obj = new SerializeInputParameters();
                    string newValue = obj.GetSerializedString(nonPOBasedInvoiceFormUI);
                    audit_IUD.WebServiceInsert(nonPOBasedInvoiceFormUI.Tbl_OrganizationId, tableName, recordID, nonPOBasedInvoiceFormUI.CreatedBy, newValue);
                    return 1;
                }
                else
                {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    SerializeInputParameters obj = new SerializeInputParameters();
                    string newValue = obj.GetSerializedString(nonPOBasedInvoiceFormUI);
                    audit_IUD.WebServiceUpdate(nonPOBasedInvoiceFormUI.Tbl_OrganizationId, "tbl_NonPOBasedInvoice", nonPOBasedInvoiceFormUI.Tbl_NonPOBasedInvoiceId, nonPOBasedInvoiceFormUI.ModifiedBy, newValue);
                }
    ...
    public int DeleteNonPOBasedInvoice(NonPOBasedInvoiceFormUI nonPOBasedInvoiceFormUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                ...
                if (SessionContext.GlobalAuditEnabledStatus == true)
                {
                    audit_IUD.WebServiceDelete("tbl_NonPOBasedInvoice", nonPOBasedInvoiceFormUI.Tbl_NonPOBasedInvoiceId);
                }
                sqlCmd.Dispose();
                SupportCon.Close();
            }
    ...
    public int UpdatePostingNonPOBasedInvoice(NonPOBasedInvoiceFormUI nonPOBasedInvoiceFormUI)
    {
        ...
        try
        {
            ...
            {
                SupportCon.Open();
                SqlCommand sqlCmd = new SqlCommand("SP_NonPOBasedInvoice_UpdatePosting", SupportCon);
                sqlCmd.CommandType = CommandType.StoredProcedure;
                sqlCmd.CommandTimeout = commandTimeout;
                ...
                sqlCmd.Parameters["@IsPosted"].Value = nonPOBasedInvoiceFormUI.IsPosted;
        ...
        {
            logExcpUIobj.MethodName = "UpdatePostingNonPOBasedInvoice()";
            logExcpUIobj.ResourceName = "NonPOBasedInvoiceFormDAL.CS";
            logExcpUIobj.RecordId = nonPOBasedInvoiceFormUI.Tbl_NonPOBasedInvoiceId;
            logExcpUIobj.ExceptionDetails = "Error Occured. System Generated Error is: " + exp.ToString();
            logExcpDALobj.SaveExceptionToDB(logExcpUIobj);
            log.Error("[NonPOBasedInvoiceFormDAL : UpdatePostingNonPOBasedInvoice] An error occured in the processing of Record Id : " + nonPOBasedInvoiceFormUI.Tbl_NonPOBasedInvoiceId + ". Details : [" + exp.ToString() + "]");
        }
