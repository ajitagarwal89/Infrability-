...
/// <summary>
/// Summary description for EmployeeGroupListDAL
/// </summary>
public class EmployeeGroupListDAL
{
	...
	public EmployeeGroupListDAL()
	{
        ...
        {
            logExcpUIobj.MethodName = "EmployeeGroupListDAL()";
            logExcpUIobj.ResourceName = "EmployeeGroupListDAL.CS";
            logExcpUIobj.RecordId = "";
            logExcpUIobj.ExceptionDetails = "Error Occured. System Generated Error is: " + exp.ToString();
            logExcpDALobj.SaveExceptionToDB(logExcpUIobj);

            throw new Exception("[EmployeeGroupListDAL : EmployeeGroupListDAL] ERROR: An error occured while connection to staging database. Please check the connection settings : [" + exp.ToString() + "]");
        }
	}
    ...
    public DataTable GetEmployeeGroupList()
    {
        ...
        try
        {
            ...
            {
                SqlCommand sqlCmd = new SqlCommand("SP_EmployeeGroup_Select", SupportCon);
        ...
        {
            logExcpUIobj.MethodName = "getEmployeeGroupList()";
            logExcpUIobj.ResourceName = "EmployeeGroupListDAL.CS";
            logExcpUIobj.RecordId = "";
            logExcpUIobj.ExceptionDetails = "Error Occured. System Generated Error is: " + exp.ToString();
            logExcpDALobj.SaveExceptionToDB(logExcpUIobj);

            log.Error("[EmployeeGroupListDAL : getEmployeeGroupList] An error occured in the processing of Record. Details : [" + exp.ToString() + "]");
        }
        finally
        {
            ds.Dispose();
    ...
    public DataTable GetEmployeeGroupListBySearchParameters(EmployeeGroupListUI employeeGroupListUI)
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                SqlCommand sqlCmd = new SqlCommand("SP_EmployeeGroup_SelectBySearchParameters", SupportCon);
                sqlCmd.CommandType = CommandType.StoredProcedure;
                sqlCmd.CommandTimeout = commandTimeout;

                sqlCmd.Parameters.Add("@Search", SqlDbType.NVarChar);
                sqlCmd.Parameters["@Search"].Value = employeeGroupListUI.Search;
        ...
        {
            logExcpUIobj.MethodName = "GetEmployeeGroupListBySearchParameters()";
            logExcpUIobj.ResourceName = "EmployeeGroupListDAL.CS";
            logExcpUIobj.RecordId = "Search = " + employeeGroupListUI.Search;
            logExcpUIobj.ExceptionDetails = "Error Occured. System Generated Error is: " + exp.ToString();
            logExcpDALobj.SaveExceptionToDB(logExcpUIobj);

            log.Error("[EmployeeGroupListDAL : GetEmployeeGroupListBySearchParameters] An error occured in the processing of Record Search = " + employeeGroupListUI.Search + " . Details : [" + exp.ToString() + "]");
        }
        finally
        {
            ds.Dispose();
    ...
    public DataTable GetEmployeeGroupListForExportToExcel()
    {
        ...
        try
        {
            using (SqlConnection SupportCon = new SqlConnection(connectionString))
            {
                SqlCommand sqlCmd = new SqlCommand("SP_EmployeeGroup_SelectExportToExcel", SupportCon);
                sqlCmd.CommandType = CommandType.StoredProcedure;
                sqlCmd.CommandTimeout = commandTimeout;
                using (SqlDataAdapter adapter = new SqlDataAdapter(sqlCmd))
                {
        ...
        {
            logExcpUIobj.MethodName = "GetEmployeeGroupListForExportToExcel()";
            logExcpUIobj.ResourceName = "EmployeeGroupListDAL.CS";
            logExcpUIobj.RecordId = "";
            logExcpUIobj.ExceptionDetails = "Error Occured. System Generated Error is: " + exp.ToString();
            logExcpDALobj.SaveExceptionToDB(logExcpUIobj);
            log.Error("[EmployeeGroupListDAL : GetEmployeeGroupListForExportToExcel] An error occured in the processing of Record. Details : [" + exp.ToString() + "]");
        }
        finally
        {
            ds.Dispose();
