...
/// <summary>
/// Summary description for GenerateAutoSerialNumber
/// </summary>
public class GenerateAutoSerialNumber
{
    ...
    public GenerateAutoSerialNumber()
    {
        //
    ...
    public DataTable GetEmployeeGeneralExpensesList()
    {
        ...
        try
        {
            ...
            {
                SqlCommand sqlCmd = new SqlCommand("SP_Payables_SelectByGenerateSerialNumber", SupportCon);
