...
/// <summary>
/// Summary description for SupplierEmployeeGroupListUI
/// </summary>
public class SupplierEmployeeGroupListUI
{
    public SupplierEmployeeGroupListUI()
    {
        //
    ...
    public string Tbl_SupplierEmployeeGroupId_Self { get; set; }
