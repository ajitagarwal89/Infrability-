...
/// <summary>
/// Summary description for SupplierEmployeeAndGroupAccountListUI
/// </summary>
public class SupplierEmployeeAndGroupAccountListUI
{
    public SupplierEmployeeAndGroupAccountListUI()
    {
        //
