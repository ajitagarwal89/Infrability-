...
/// <summary>
/// Summary description for NonPOBasedInvoiceDistributionListUI
/// </summary>
public class NonPOBasedInvoiceDistributionListUI
{
    public NonPOBasedInvoiceDistributionListUI()
    {
        //
    ...
    public string Tbl_NonPOBasedInvoiceDistributionId { get; set; }
