...
/// <summary>
/// Summary description for EmployeeGeneralExpensesFormUI
/// </summary>
public class EmployeeGeneralExpensesFormUI
{
    public EmployeeGeneralExpensesFormUI()
    {
        //
    ...
    public string Tbl_EmployeeGeneralExpensesId { get; set; }
