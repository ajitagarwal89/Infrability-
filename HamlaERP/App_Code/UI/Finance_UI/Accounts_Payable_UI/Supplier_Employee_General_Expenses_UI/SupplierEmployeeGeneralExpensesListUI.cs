...
/// <summary>
/// Summary description for SupplierEmployeeGeneralExpensesListUI
/// </summary>
public class SupplierEmployeeGeneralExpensesListUI
{
    public SupplierEmployeeGeneralExpensesListUI()
    {
        //
