...
/// <summary>
/// Summary description for GLAccountConfigurationSettingsFormUI
/// </summary>
public class GLAccountConfigurationSettingsFormUI
{
    public GLAccountConfigurationSettingsFormUI()
    {
        //
