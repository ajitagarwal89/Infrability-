...
/// <summary>
/// Summary description for PaymentFromCustomerDistributionFormUI
/// </summary>
public class PaymentFromCustomerDistributionFormUI
{
    public PaymentFromCustomerDistributionFormUI()
    {
        //
    ...
    public string Tbl_PaymentFromCustomerDistributionId { get; set; }
