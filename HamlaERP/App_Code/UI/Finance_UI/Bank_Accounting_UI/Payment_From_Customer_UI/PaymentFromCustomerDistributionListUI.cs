...
/// <summary>
/// Summary description for PaymentFromCustomerDistributionListUI
/// </summary>
public class PaymentFromCustomerDistributionListUI
{
    public PaymentFromCustomerDistributionListUI()
    {
        //
