...
/// <summary>
/// Summary description for PaymentToSupplierEmployeeApplyListUI
/// </summary>
public class PaymentToSupplierEmployeeApplyListUI
{
    public PaymentToSupplierEmployeeApplyListUI()
    {
        //
