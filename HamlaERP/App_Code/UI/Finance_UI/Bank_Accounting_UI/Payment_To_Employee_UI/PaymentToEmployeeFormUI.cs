...
/// <summary>
/// Summary description for PaymentToEmployeeFormUI
/// </summary>
public class PaymentToEmployeeFormUI
{
    public PaymentToEmployeeFormUI()
    {
        //
    ...
    public Int32 Opt_PayablesType { get; set; }
