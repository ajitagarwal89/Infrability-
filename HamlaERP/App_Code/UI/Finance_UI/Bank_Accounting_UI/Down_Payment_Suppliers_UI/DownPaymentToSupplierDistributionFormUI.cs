...
/// <summary>
/// Summary description for DownPaymentToSupplierDistributionFormUI
/// </summary>
public class DownPaymentToSupplierDistributionFormUI
{
    public DownPaymentToSupplierDistributionFormUI()
    {
        //
