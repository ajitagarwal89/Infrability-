...
/// <summary>
/// Summary description for DownPaymentFromCustomerDistributionList_UI
/// </summary>
public class DownPaymentFromCustomerDistributionListUI
{
    public DownPaymentFromCustomerDistributionListUI()
    {
        //
