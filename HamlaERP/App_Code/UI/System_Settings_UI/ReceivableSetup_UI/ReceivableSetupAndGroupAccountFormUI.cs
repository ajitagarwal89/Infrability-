...
/// <summary>
/// Summary description for ReceivableSetupAndGroupAccountFormUI
/// </summary>
public class ReceivableSetupAndGroupAccountFormUI
{
    public ReceivableSetupAndGroupAccountFormUI()
    {
        //
