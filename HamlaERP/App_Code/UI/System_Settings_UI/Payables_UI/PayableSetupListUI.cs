...
/// <summary>
/// Summary description for PayableSetupListUI
/// </summary>
public class PayableSetupListUI
{
    public PayableSetupListUI()
    {
        //
    ...
    public int AgingPeriods { get; set; }
    ...
    public int AllowDuplicateInvoicesPerVendor { get; set; }
