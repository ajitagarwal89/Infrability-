...
public class EmployeeGeneralExpensesFormBAL
{
    ...
    {
        int resutl = 0;
        resutl = employeeGeneralExpensesFormDAL.UpdatePostingEmployeeGeneralExpenses(employeeGeneralExpensesFormUI);
        return resutl;
    }
    public DataTable GetSerialNumber(EmployeeGeneralExpensesFormUI employeeGeneralExpensesFormUI)
    {
        DataTable dtb = new DataTable();
        dtb = employeeGeneralExpensesFormDAL.GetSerialNumber(employeeGeneralExpensesFormUI);
        return dtb;
    }
}