...
public class CustomerInvoiceProcessFormBAL
{
    ...
    {
        int resutl = 0;
        resutl = customerInvoiceProcessFormDAL.UpdatePostingCustomerInvoiceProcess(customerInvoiceProcessFormUI);
        return resutl;
    }
    public DataTable GetSerialNumber(CustomerInvoiceProcessFormUI customerInvoiceProcessFormUI)
    {
        DataTable dtb = new DataTable();
        dtb = customerInvoiceProcessFormDAL.GetSerialNumber(customerInvoiceProcessFormUI);
        return dtb;
    }
}